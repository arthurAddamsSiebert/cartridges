...
public final class OrderStatistics_jsp extends com.intershop.beehive.core.internal.template.AbstractTemplate
...
new TagParameter("text",localizeText(context.getFormattedValue("OrderStatistics.Orders.text",null)))}, 21); 
 processOpenTag(response, pageContext, "breadcrumbtrail", new TagParameter[] {
new TagParameter("listview","true"),
new TagParameter("link",url(true,(new URLPipelineAction(context.getFormattedValue("ViewOrderStatistics-Start",null))))),
new TagParameter("text",localizeText(context.getFormattedValue("OrderStatistics.OrderOverview.text",null)))}, 22); 
      out.write("<!-- end page navigator -->\n<table border=\"0\" cellspacing=\"0\" cellpadding=\"0\" width=\"100%\">\n<tr>\n<td colspan=\"5\" class=\"table_title aldi\">");
 {out.write(localizeISText("OrderStatistics.OrderOverview.table_title",null,null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("</td>\n</tr>");
 _boolean_result=false;try {_boolean_result=((Boolean)((disableErrorMessages().isDefined(getObject("ObjectStatisticsGroup"))))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",31,e);}if (_boolean_result) { 
 _boolean_result=false;try {_boolean_result=((Boolean)((disableErrorMessages().isDefined(getObject("Refresh"))))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",34,e);}if (_boolean_result) { 
      out.write("<script language=\"JavaScript\" type=\"text/javascript\">\nwindow.setTimeout(\"self.location='");
      out.print(context.getFormattedValue(url(true,(new URLPipelineAction(context.getFormattedValue("ViewOrderStatistics-Start",null)))),null));
 ...
 {String value = null;try{value=context.getFormattedValue(getObject("ChannelID"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {66}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
      ...
      out.print(context.getFormattedValue(localizeText(context.getFormattedValue("OrderStatistics.Apply.button",null)),null));
...
new TagParameter("attribute",getObject("ObjectStatisticsGroup:getInteger(\"OrderCount_Pending\",Currency:Mnemonic)"))}, 124); 
 ...
 {out.write(localizeISText("OrderStatistics.TheInformationOnThisPageWasLastUpdatedOn.table_title_description",null,null,context.getFormattedValue(getObject("ObjectStatisticsGroup:LastModified"),new Integer(DATE_TIME_INPUT)),null,null,null,null,null,null,null,null,null));} 
      out.write("</td>\n</tr> \n");
 } 
 } else { 
