...
public final class ReplicationButtonInc_jsp extends com.intershop.beehive.core.internal.template.AbstractTemplate
...
setEncodingType("text/html"); 
 ...
 _boolean_result=false;try {_boolean_result=((Boolean)((disableErrorMessages().isDefined(getObject("buttonNameTextKey"))))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",10,e);}if (_boolean_result) { 
 {out.write(localizeISText(context.getFormattedValue(getObject("buttonNameTextKey"),null),"",null,null,null,null,null,null,null,null,null,null,null));} 
 } else { 
      out.write("&nbsp;");
 {out.write(localizeISText("ReplicationButtonInc.PublishToLiveSystem",null,null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("&nbsp;");
 } 
      out.write("\" class=\"button\" ");
 {String value = null;try{value=context.getFormattedValue(getObject("disableButtonAttribute"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {10}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
      out.write("/>\n\t\t\n\t</td>\n");
 } 
      out.write('\n');
      out.write(' ');
