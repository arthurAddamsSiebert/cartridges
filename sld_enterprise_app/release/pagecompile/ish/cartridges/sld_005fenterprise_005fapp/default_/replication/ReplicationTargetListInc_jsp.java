...
public final class ReplicationTargetListInc_jsp extends com.intershop.beehive.core.internal.template.AbstractTemplate
...
setEncodingType("text/html"); 
 ...
 {out.write(localizeISText("ReplicationTargetListInc.TargetCluster.table_header",null,null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("</td>\n\t\t\t<td class=\"table_header e s\" nowrap=\"nowrap\">");
 {out.write(localizeISText("ReplicationTargetListInc.WebServerURL.table_header",null,null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("</td>\n\t\t\t<td class=\"table_header s\" nowrap=\"nowrap\">");
 {out.write(localizeISText("ReplicationTargetListInc.ServerGroup.table_header",null,null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("</td>\n\t\t</tr>\n\t\t");
 ...
 _boolean_result=false;try {_boolean_result=((Boolean)((((context.getFormattedValue(getObject("IsFirstTargetCluster"),null).equals(context.getFormattedValue("true",null)))) ? Boolean.TRUE : Boolean.FALSE))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",16,e);}if (_boolean_result) { 
      ...
      out.write(" name=\"TargetClusterID\" value=\"");
 {String value = null;try{value=context.getFormattedValue(getObject("target:ClusterID"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {16}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
      out.write("\"/>\n\t\t\t\t</td>\n\t\t\t\t<td class=\"table_detail e s\" nowrap=\"nowrap\">\n\t\t\t\t\t");
 while (loop("target:TargetSystems","TargetSystem",null)) { 
 {String value = null;try{value=context.getFormattedValue(getObject("TargetSystem:Name"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {19}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
 _boolean_result=false;try {_boolean_result=((Boolean)((hasNext("TargetSystem") ? Boolean.TRUE : Boolean.FALSE))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",19,e);}if (_boolean_result) { 
      ...
      out.write("&nbsp;\n\t\t\t\t</td>\n\t\t\t\t<td class=\"table_detail e s\" nowrap=\"nowrap\">\n\t\t\t\t\t");
 while (loop("target:TargetSystems","TargetSystem",null)) { 
 {String value = null;try{value=context.getFormattedValue(getObject("TargetSystem:WebServerURL"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {22}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
 _boolean_result=false;try {_boolean_result=((Boolean)((hasNext("TargetSystem") ? Boolean.TRUE : Boolean.FALSE))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",22,e);}if (_boolean_result) { 
      out.write("<br/>");
 } 
 } 
      out.write("&nbsp;\n\t\t\t\t</td>\n\t\t\t\t<td class=\"table_detail s\" nowrap=\"nowrap\">\n\t\t\t\t\t");
 while (loop("target:TargetSystems","TargetSystem",null)) { 
 {String value = null;try{value=context.getFormattedValue(getObject("TargetSystem:TargetServerGroup"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {25}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
 _boolean_result=false;try {_boolean_result=((Boolean)((hasNext("TargetSystem") ? Boolean.TRUE : Boolean.FALSE))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",25,e);}if (_boolean_result) { 
      out.write("<br/>");
 } 
 } 
      out.write("&nbsp;\n\t\t\t\t</td>\n\t\t\t</tr>\n\t\t\t");
 ...
 {out.write(localizeISText("ReplicationTargetListInc.UserLockingConflictResolution.table_title2",null,null,null,null,null,null,null,null,null,null,null,null));} 
...
new TagParameter("params",getObject("params"))}, 108); 
      out.write("\n\t\t\t\t\t\n\t\t<input type=\"hidden\"  name=\"AffectedItemsPageableID\" value=\"");
 {String value = null;try{value=context.getFormattedValue(getObject("AffectedItems:ID"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {118}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
      out.write("\">\n\t");
 } 
      out.write('\n');
 } else { 
      out.write("\n\t<table cellpadding=\"0\" cellspacing=\"0\" border=\"0\" width=\"100%\" class=\"w e\">\n\t\t<tr>\n\t\t\t<td class=\"table_detail s\">");
 {out.write(localizeISText("ReplicationTargetListInc.NoTargetClusterAvailable.table_detail",null,null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("</td>\n\t\t</tr>\n\t</table>\n");
 } 
      out.write('\n');
 printFooter(out); 
