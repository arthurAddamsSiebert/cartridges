...
public final class TimeZoneSelect_jsp extends com.intershop.beehive.core.internal.template.AbstractTemplate
...
new TagParameter("scripttemplate","statusbar/TimeZoneDropDownScript.isml"),
new TagParameter("uitemplate","statusbar/TimeZoneDropDown.isml"),
new TagParameter("classes","statusbar-select-timezones"),
new TagParameter("noneselectedtext",localizeText(context.getFormattedValue("ApplicationFrame.SelectTimeZone.noneselectedtext",null))),
new TagParameter("id","statusbar-select-timezones"),
new TagParameter("position","below"),
new TagParameter("params",((new ParameterMap().addParameter(new ParameterEntry("StatusbarForm",getObject("StatusbarForm")))).addParameter(new ParameterEntry("TimeZoneBOs",getObject("TimeZoneBOs"))).addParameter(new ParameterEntry("SelectedTimeZoneBO",getObject("SelectedTimeZoneBO"))))),
new TagParameter("selectedlist","1")}, 4); 
 printFooter(out); 
