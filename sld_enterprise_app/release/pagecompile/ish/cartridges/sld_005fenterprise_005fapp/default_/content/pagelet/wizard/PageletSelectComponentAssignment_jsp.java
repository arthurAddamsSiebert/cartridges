...
public final class PageletSelectComponentAssignment_jsp extends com.intershop.beehive.core.internal.template.AbstractTemplate
...
new TagParameter("text",localizeText(context.getFormattedValue("PageletSelectComponentAssignment.Step2SelectAComponent.text",null)))}, 5); 
      out.write("<!-- EO Page Navigator -->");
 processOpenTag(response, pageContext, "createmap", new TagParameter[] {
new TagParameter("key0","ContentRepositoryUUID"),
new TagParameter("value0",getObject("ContentRepositoryUUID")),
new TagParameter("mapname","TargetPipelineParameters")}, 8); 
...
new TagParameter("uniqueid","PageVariantAssignToComponent")}, 12); 
 printFooter(out); 
