...
new TagParameter("text",localizeText(context.getFormattedValue("Pages.MasterContent.text",null)))}, 6); 
 processOpenTag(response, pageContext, "breadcrumbtrail", new TagParameter[] {
...
new TagParameter("text",localizeText(context.getFormattedValue("Pages.MasterPageVariants.text",null)))}, 7); 
...
new TagParameter("uniqueid","Pages")}, 10); 
