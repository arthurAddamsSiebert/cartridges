...
public final class ComponentFilter_jsp extends com.intershop.beehive.core.internal.template.AbstractTemplate
...
printHeader(out);
      ...
      out.write("<!-- TEMPLATENAME: ComponentFilter.isml -->\n");
...
new TagParameter("text",localizeText(context.getFormattedValue("ComponentFilter.ComponentFilter.text",null)))}, 6); 
...
new TagParameter("performsearch",getObject("PerformPageletSearch"))}, 9); 
 printFooter(out); 
