...
public final class Editable_jsp extends com.intershop.beehive.core.internal.template.AbstractTemplate
...
new TagParameter("RepositoryDomain",getObject("ContentRepository:RepositoryDomain"))}, 3); 
 {Object temp_obj = ((( ((Number) getObject("SharingHelper:SharingTargetDomains:Size")).doubleValue() !=((Number)(new Double(0))).doubleValue()) ? Boolean.TRUE : Boolean.FALSE)); getPipelineDictionary().put("hasChildren", temp_obj);} 
 {Object temp_obj = (getObject("PageletEntryPoint:Dynamic")); getPipelineDictionary().put("isDynamic", temp_obj);} 
 _boolean_result=false;try {_boolean_result=((Boolean)(((((Boolean) getObject("hasChildren")).booleanValue() && !((Boolean) (getObject("isDynamic"))).booleanValue()) ? Boolean.TRUE : Boolean.FALSE))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",6,e);}if (_boolean_result) { 
 {Object temp_obj = (getObject("false")); getPipelineDictionary().put("eval", temp_obj);} 
getPipelineDictionary().put("Result",false);
 } else { 
...
new TagParameter("mapname","ProcessPageletLockParams")}, 7); 
 {try{executePipeline("ViewPageletEntryPoint-LookupPEPLock",((java.util.Map)(getObject("ProcessPageletLockParams"))),"PEPLockInfoDictionary");}catch(Exception e){Logger.error(this,"ISPIPELINE failed. Line: 12.",e);}} 
 {Object temp_obj = ((disableErrorMessages().isDefined(getObject("PEPLockInfoDictionary:PageletEntryPointLockedForOther")))); getPipelineDictionary().put("PageletEntryPointLockedForOther", temp_obj);} 
 {Object temp_obj = (((((Boolean) ((((context.getFormattedValue(getObject("PageletEntryPoint:Domain:UUID"),null).equals(context.getFormattedValue(getObject("ContentRepository:RepositoryDomain:UUID"),null)))) ? Boolean.TRUE : Boolean.FALSE))).booleanValue() && ((Boolean) ((((Boolean) (getObject("PageletEntryPointLockedForOther"))).booleanValue() ? Boolean.FALSE : Boolean.TRUE) )).booleanValue()) ? Boolean.TRUE : Boolean.FALSE)); getPipelineDictionary().put("eval", temp_obj);} 
