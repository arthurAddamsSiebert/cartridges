...
public final class PageletEditable_jsp extends com.intershop.beehive.core.internal.template.AbstractTemplate
...
new TagParameter("mapname","ProcessPageletLockParams")}, 2); 
 {try{executePipeline("ProcessPageletLock-Lookup",((java.util.Map)(getObject("ProcessPageletLockParams"))),"PageletLockInfoDictionary");}catch(Exception e){Logger.error(this,"ISPIPELINE failed. Line: 7.",e);}} 
 {Object temp_obj = (getObject("PageletLockInfoDictionary:PageletLockedForOther")); getPipelineDictionary().put("PageletLockedForOther", temp_obj);} 
 {Object temp_obj = (((((Boolean) ((((context.getFormattedValue(getObject("Pagelet:Domain:UUID"),null).equals(context.getFormattedValue(getObject("ContentRepository:RepositoryDomain:UUID"),null)))) ? Boolean.TRUE : Boolean.FALSE))).booleanValue() && ((Boolean) ((((Boolean) ((disableErrorMessages().isDefined(getObject("PageletLockInfoDictionary:PageletLockedForOther"))))).booleanValue() ? Boolean.FALSE : Boolean.TRUE) )).booleanValue()) ? Boolean.TRUE : Boolean.FALSE)); getPipelineDictionary().put("eval", temp_obj);} 
