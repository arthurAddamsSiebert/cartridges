...
public final class PageletSearchModule_jsp extends com.intershop.beehive.core.internal.template.AbstractTemplate
...
printHeader(out);
      ...
      out.write("<!-- TEMPLATENAME: PageletSearchModule.isml -->\n");
 
setEncodingType("text/html"); 
 {out.flush();processLocalIncludeByServer((com.intershop.beehive.core.capi.request.ServletResponse)response,"content/search/PageletSearchModuleInternal", null, "3");} 
 processOpenTag(response, pageContext, "pageletsearchinternal", new TagParameter[] {
...
new TagParameter("selectedpageletuuid",getObject("SelectedPageletUUID"))}, 4); 
 printFooter(out); 
