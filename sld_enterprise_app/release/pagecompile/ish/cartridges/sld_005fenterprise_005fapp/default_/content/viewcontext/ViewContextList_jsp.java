...
public final class ViewContextList_jsp extends com.intershop.beehive.core.internal.template.AbstractTemplate
...
new TagParameter("text",localizeText(context.getFormattedValue("ViewContextList.MasterContent.text",null)))}, 5); 
 processOpenTag(response, pageContext, "breadcrumbtrail", new TagParameter[] {
...
new TagParameter("text",localizeText(context.getFormattedValue("ViewContextList.MasterViewContexts.text",null)))}, 6); 
 } else { 
 processOpenTag(response, pageContext, "breadcrumbtrail", new TagParameter[] {
new TagParameter("hide","true"),
...
new TagParameter("start","true"),
new TagParameter("text",localizeText(context.getFormattedValue("ViewContextList.Content.text",null)))}, 8); 
 processOpenTag(response, pageContext, "breadcrumbtrail", new TagParameter[] {
new TagParameter("listview","true"),
new TagParameter("link",url(true,(new URLPipelineAction(context.getFormattedValue("ViewViewContexts-BackToList",null))),(new URLParameterSet().addURLParameter(context.getFormattedValue("ContentRepositoryUUID",null),context.getFormattedValue(getObject("ContentRepository:UUID"),null))))),
new TagParameter("id","ViewContexts"),
new TagParameter("text",localizeText(context.getFormattedValue("ViewContextList.ViewContexts.text",null)))}, 9); 
 } 
 processOpenTag(response, pageContext, "sticky", new TagParameter[] {
}, 11); 
 processOpenTag(response, pageContext, "viewcontextsearch", new TagParameter[] {
...
new TagParameter("StartFlag",getObject("StartFlag"))}, 12); 
 printFooter(out); 
