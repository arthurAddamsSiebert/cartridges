...
public final class PageletEntryPointSharingInfo_jsp extends com.intershop.beehive.core.internal.template.AbstractTemplate
...
new TagParameter("contentDomain",getObject("PageletEntryPoint:Domain"))}, 9); 
 ...
 _boolean_result=false;try {_boolean_result=((Boolean)(getObject("ModelRepositoryHelper:isPageEntryPointDefinitionOverridden(PageletEntryPoint:ContentEntryPointDefinition)"))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",13,e);}if (_boolean_result) { 
      ...
      out.print(context.getFormattedValue(localizeTextEx(context.getFormattedValue("PageletEntryPointSharingInfo.SharedFrom0.alt",null),new ParameterList().addParameter(encodeString(context.getFormattedValue(getObject("contentRepositoryDisplayName"),null)))),null));
      out.write("\" title=\"");
      out.print(context.getFormattedValue(localizeTextEx(context.getFormattedValue("PageletEntryPointSharingInfo.SharedFrom0.title",null),new ParameterList().addParameter(encodeString(context.getFormattedValue(getObject("contentRepositoryDisplayName"),null)))),null));
      out.write("\" border=\"0\"/></div>\n</td>\n</tr>\n</table>\n</td>\n<td class=\"infobox_title\" width=\"100%\">");
 {out.write(localizeISText("PageletEntryPointSharingInfo.SharedFrom0AndOverriddenInThisApplication.infobox_title",null,null,encodeString(context.getFormattedValue(getObject("contentRepositoryDisplayName"),null)),null,null,null,null,null,null,null,null,null));} 
      out.write("</td>");
 } else { 
      ...
      out.print(context.getFormattedValue(localizeTextEx(context.getFormattedValue("PageletEntryPointSharingInfo.SharedFrom0.title",null),new ParameterList().addParameter(encodeString(context.getFormattedValue(getObject("contentRepositoryDisplayName"),null)))),null));
      out.write("\" border=\"0\"/></div>\n</td>\n</tr>\n</table>\n</td>\n<td class=\"infobox_title\" width=\"100%\">");
 {out.write(localizeISText("PageletEntryPointSharingInfo.SharedFrom0.infobox_title",null,null,encodeString(context.getFormattedValue(getObject("contentRepositoryDisplayName"),null)),null,null,null,null,null,null,null,null,null));} 
      out.write("</td>");
 } 
      out.write("</tr>\n</table>");
 } 
