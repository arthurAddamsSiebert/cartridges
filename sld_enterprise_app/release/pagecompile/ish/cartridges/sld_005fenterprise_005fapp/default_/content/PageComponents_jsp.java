...
public final class PageComponents_jsp extends com.intershop.beehive.core.internal.template.AbstractTemplate
...
new TagParameter("text",localizeText(context.getFormattedValue("PageComponents.MasterContent.text",null)))}, 7); 
 processOpenTag(response, pageContext, "breadcrumbtrail", new TagParameter[] {
...
new TagParameter("text",localizeText(context.getFormattedValue("PageComponents.MasterComponents.text",null)))}, 8); 
...
new TagParameter("uniqueid","PageComponents")}, 11); 
 printFooter(out); 
