...
public final class LockedForOthers_jsp extends com.intershop.beehive.core.internal.template.AbstractTemplate
...
new TagParameter("Result","PageletEditable")}, 14); 
 ...
 {Object temp_obj = (((((Boolean) (disableErrorMessages().isDefined(getObject("PageletLockedForOther")))).booleanValue() || ((Boolean) (((((Boolean) (disableErrorMessages().isDefined(getObject("PEPLockedForOther")))).booleanValue() && ((Boolean) getObject("PEPLockedForOther")).booleanValue()) ? Boolean.TRUE : Boolean.FALSE))).booleanValue()) ? Boolean.TRUE : Boolean.FALSE)); getPipelineDictionary().put("Result", temp_obj);} 
 printFooter(out); 
