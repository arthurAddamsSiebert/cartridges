...
public final class ViewContextExport_jsp extends com.intershop.beehive.core.internal.template.AbstractTemplate
...
new TagParameter("text",localizeText(context.getFormattedValue("ViewContextExport.ExportViewContexts.text",null)))}, 4); 
...
new TagParameter("InsertIntoExport",getObject("InsertIntoExport"))}, 10); 
 printFooter(out); 
