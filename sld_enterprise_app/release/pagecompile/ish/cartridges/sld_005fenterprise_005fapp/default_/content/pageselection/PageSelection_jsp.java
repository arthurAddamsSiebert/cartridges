...
public final class PageSelection_jsp extends com.intershop.beehive.core.internal.template.AbstractTemplate
...
new TagParameter("params",((new ParameterMap().addParameter(new ParameterEntry("PageTree",getObject("PageTree")))).addParameter(new ParameterEntry("ContentRepository",getObject("ContentRepository"))).addParameter(new ParameterEntry("PageletModelRepository",getObject("PageletModelRepository")))))}, 38); 
      out.write("</div>\n<div class=\"dialog-buttons\">\n<input type=\"button\" class=\"button\" id=\"pageSelectionDialog-ok\" value=\"");
