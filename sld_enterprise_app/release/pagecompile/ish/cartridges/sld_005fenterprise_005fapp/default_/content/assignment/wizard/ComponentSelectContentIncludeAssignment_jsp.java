...
public final class ComponentSelectContentIncludeAssignment_jsp extends com.intershop.beehive.core.internal.template.AbstractTemplate
...
new TagParameter("text",localizeTextEx(context.getFormattedValue("ComponentSelectContentIncludeAssignment.Step0",null),new ParameterList().addParameter(context.getFormattedValue(getObject("StepCounter"),null))))}, 4); 
...
new TagParameter("PageletModelUtils","ModelUtils")}, 11); 
 _boolean_result=false;try {_boolean_result=((Boolean)(((((Boolean) ((( ((Number) getObject("ComponentPageable:ElementCount")).doubleValue() >((Number)(new Double(1))).doubleValue()) ? Boolean.TRUE : Boolean.FALSE))).booleanValue() || ((Boolean) ((( ((Number) getObject("ModelUtils:ExtendingComponentEntryPointDefinitions(SystemManaged,Pagelet:PageletDefinition,PageletModelRepo):Size")).doubleValue() ==((Number)(new Double(0))).doubleValue()) ? Boolean.TRUE : Boolean.FALSE))).booleanValue()) ? Boolean.TRUE : Boolean.FALSE))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",12,e);}if (_boolean_result) { 
...
new TagParameter("uniqueid","ComponentAssignContentInclude")}, 13); 
 } else { 
 processOpenTag(response, pageContext, "pageletentrypointsearch", new TagParameter[] {
new TagParameter("disablesharedpagelets","false"),
new TagParameter("targetpageletviewpipelineparams",getObject("TargetPipelineParameters")),
...
new TagParameter("targetpageletviewpipeline","ViewComponentContentIncludeAssignmentCreationWizard-Dispatch"),
new TagParameter("notfoundtemplate","content/search/inc/EmptyPageletEntryPointSearchResult"),
new TagParameter("uniqueid","ComponentAssignContentInclude")}, 29); 
 } 
 printFooter(out); 
