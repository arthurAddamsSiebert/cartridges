...
public final class PlaceholderInheritancePath_jsp extends com.intershop.beehive.core.internal.template.AbstractTemplate
...
new TagParameter("PageletPlaceholderUtils","PlaceholderUtils")}, 3); 
 ...
 _boolean_result=false;try {_boolean_result=((Boolean)((hasLoopElements("Templates") ? Boolean.TRUE : Boolean.FALSE))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",5,e);}if (_boolean_result) { 
 while (loop("Templates","Template",null)) { 
 processOpenTag(response, pageContext, "pageletdisplayname", new TagParameter[] {
new TagParameter("Locale",getObject("Locale")),
new TagParameter("Pagelet",getObject("Template"))}, 7); 
      out.write("&nbsp;/&nbsp;\n");
 } 
 } 
 processOpenTag(response, pageContext, "pageletplaceholderdisplayname", new TagParameter[] {
new TagParameter("Locale",getObject("Locale")),
new TagParameter("PageletPlaceholder",getObject("PageletPlaceholder"))}, 10); 
 printFooter(out); 
