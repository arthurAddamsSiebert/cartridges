...
public final class PageSelectionTreeData_jsp extends com.intershop.beehive.core.internal.template.AbstractTemplate
...
new TagParameter("Page",getObject("Page"))}, 5); 
 _boolean_result=false;try {_boolean_result=((Boolean)((hasNext("Page") ? Boolean.TRUE : Boolean.FALSE))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",9,e);}if (_boolean_result) { 
      out.write(',');
 } 
 } 
      out.write('\n');
