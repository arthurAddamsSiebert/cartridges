...
public final class SelectCategory_jsp extends com.intershop.beehive.core.internal.template.AbstractTemplate
...
printHeader(out);
      ...
      out.write("<!-- TEMPLATENAME: SelectCategory.isml -->\n");
...
new TagParameter("text",localizeText(context.getFormattedValue("SelectCategory.Step1SelectCatalog.text",null)))}, 4); 
 processOpenTag(response, pageContext, "breadcrumbtrail", new TagParameter[] {
...
new TagParameter("text",localizeText(context.getFormattedValue("SelectCategory.Step2SelectCategory.text",null)))}, 5); 
      out.write("<table border=\"0\" cellpadding=\"0\" cellspacing=\"0\" width=\"100%\">\n<tr>\n<td width=\"100%\" class=\"table_title w e s\">");
 {out.write(localizeISText("SelectCategory.PageSearchStep2SelectCategory.table_title",null,null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("</td>\n</tr>");
 ...
 {out.write(localizeISText("SelectCategory.EClSsCode.table_detail3",null,null,null,null,null,null,null,null,null,null,null,null));} 
      out.write(':');
      out.write('\n');
 } else { 
 {out.write(localizeISText("SelectCategory.UNSPSCCode.table_detail3",null,null,null,null,null,null,null,null,null,null,null,null));} 
      out.write(':');
      out.write('\n');
 } 
      out.write("</td>\n<td class=\"table_detail3\">\n<input type=\"text\" value=\"");
 {String value = null;try{value=context.getFormattedValue(getObject("Level1"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {38}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
      out.write("\" name=\"Level1Value\" maxlength=\"2\" size=\"2\" class=\"inputfield_en\"/>\n</td>\n<td class=\"table_detail3\">-</td>\n<td class=\"table_detail3\">\n<input type=\"text\" value=\"");
 {String value = null;try{value=context.getFormattedValue(getObject("Level2"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {42}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
      out.write("\" name=\"Level2Value\" maxlength=\"2\" size=\"2\" class=\"inputfield_en\"/>\n</td>\n<td class=\"table_detail3\">-</td>\n<td class=\"table_detail3\">\n<input type=\"text\" value=\"");
 {String value = null;try{value=context.getFormattedValue(getObject("Level3"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {46}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
      out.write("\" name=\"Level3Value\" maxlength=\"2\" size=\"2\" class=\"inputfield_en\"/>\n</td>\n<td class=\"table_detail3\">-</td>\n<td class=\"table_detail3\">\n<input type=\"text\" value=\"");
 {String value = null;try{value=context.getFormattedValue(getObject("Level4"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {50}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
      out.write("\" name=\"Level4Value\" maxlength=\"2\" size=\"2\" class=\"inputfield_en\"/>\n</td>\n<td>&nbsp;</td>\n<td width=\"100%\" align=\"left\">\n<table border=\"0\" cellspacing=\"4\" cellpadding=\"0\">\n<tr>\n<td class=\"button\">\n<input type=\"hidden\" name=\"CatalogUUID\" value=\"");
 {String value = null;try{value=context.getFormattedValue(getObject("Catalog:UUID"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {57}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
      out.write("\"/>\n<input type=\"hidden\" name=\"CategoryDomainName\" value=\"");
 {String value = null;try{value=context.getFormattedValue(getObject("Catalog:Root:Domain:DomainName"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {58}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
...
new TagParameter("category",getObject("Catalog:Root"))}, 78); 
 } else { 
 processOpenTag(response, pageContext, "catalogcategory", new TagParameter[] {
new TagParameter("parametervalue",getObject("Catalog:UUID")),
...
new TagParameter("enabledetailslink","false"),
new TagParameter("parametername","CatalogUUID"),
new TagParameter("category",getObject("Catalog:Root"))}, 88); 
 } 
      out.write("</td>\n</tr>\n<tr>\n<td colspan=\"2\"><img src=\"");
      out.print(context.getFormattedValue(context.webRoot(),null));
      out.write("/images/space.gif\" width=\"1\" height=\"6\" alt=\"\" border=\"0\"/></td>\n</tr>\n</table>\n<table class=\"w e s\" width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\">\n<tr>\n<td align=\"left\">\n<table border=\"0\" cellspacing=\"4\" cellpadding=\"0\">\n<tr>\n<td class=\"button\">\n<input type=\"submit\" name=\"SelectCatalog\" value=\"&lt;&lt;&nbsp;");
      out.print(context.getFormattedValue(localizeText(context.getFormattedValue("SelectCategory.Previous.button",null)),null));
      out.write("\" class=\"button\"/>\n</td>\n</tr>\n</table>\n</td>\n<td align=\"right\">\n<table border=\"0\" cellspacing=\"4\" cellpadding=\"0\">\n<tr>\n<td class=\"button\">\n<input name=\"CatalogUUID\" type=\"hidden\" value=\"");
 {String value = null;try{value=context.getFormattedValue(getObject("Catalog:UUID"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {120}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
 ...
 {String value = null;try{value=context.getFormattedValue(getObject("ChannelID"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {124}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
      ...
      out.print(context.getFormattedValue(localizeText(context.getFormattedValue("SelectCategory.Cancel.button",null)),null));
      out.write("\" class=\"button\"/>\n</td>\n</tr>\n</table>\n</td>\n</tr>\n</table>\n</td>\n</tr>\n</table> \n");
 out.print("</form>"); 
 printFooter(out); 
