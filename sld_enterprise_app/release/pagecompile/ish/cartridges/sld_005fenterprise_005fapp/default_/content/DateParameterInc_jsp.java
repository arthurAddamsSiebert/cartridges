...
public final class DateParameterInc_jsp extends com.intershop.beehive.core.internal.template.AbstractTemplate
...
new TagParameter("Invalid",getObject("ConfigurationParameterWebForm:getParameter(ConfigurationParameterDefinition:Name):isInvalid"))}, 7); 
...
new TagParameter("DateObject",getObject("ConfigurationParameterWebForm:getParameter(ConfigurationParameterDefinition:Name):Value")),
new TagParameter("Invalid",getObject("ConfigurationParameterWebForm:getParameter(ConfigurationParameterDefinition:Name):isInvalid"))}, 13); 
      out.write("</tr>\n</table>");
 printFooter(out); 
