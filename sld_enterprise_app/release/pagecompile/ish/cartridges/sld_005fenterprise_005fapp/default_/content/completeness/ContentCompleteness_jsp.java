...
public final class ContentCompleteness_jsp extends com.intershop.beehive.core.internal.template.AbstractTemplate
...
new TagParameter("text",localizeText(context.getFormattedValue("ContentCompleteness.MasterContent.text",null)))}, 5); 
 processOpenTag(response, pageContext, "breadcrumbtrail", new TagParameter[] {
...
new TagParameter("text",localizeText(context.getFormattedValue("ContentCompleteness.MasterContentOverview.text",null)))}, 6); 
 processOpenTag(response, pageContext, "createmap", new TagParameter[] {
new TagParameter("key0","ContentRepositoryUUID"),
new TagParameter("value0",getObject("ContentRepository:UUID")),
new TagParameter("mapname","ContextPipelineMap")}, 8); 
