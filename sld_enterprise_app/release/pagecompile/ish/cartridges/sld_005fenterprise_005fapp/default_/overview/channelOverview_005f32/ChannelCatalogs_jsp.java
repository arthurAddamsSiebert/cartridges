...
public final class ChannelCatalogs_jsp extends com.intershop.beehive.core.internal.template.AbstractTemplate
...
new TagParameter("displayname","ChannelOverviewPlugin_32.ChannelCatalogs.link"),
new TagParameter("description","ChannelOverviewPlugin_32.ManageTheCatalogsAndProductsOfThisChannel.overview_title_description"),
new TagParameter("linkurl",url(true,(new URLPipelineAction(context.getFormattedValue("ViewOverview-ChannelCatalog",null))),(new URLParameterSet().addURLParameter(context.getFormattedValue("ChannelID",null),context.getFormattedValue(getObject("ApplicationState:ChannelID"),null)))))}, 7); 
      out.write('\n');
 } 
      out.write('\n');
 printFooter(out); 
