...
public final class Marketing_jsp extends com.intershop.beehive.core.internal.template.AbstractTemplate
...
new TagParameter("displayname","overview.marketing.title"),
new TagParameter("description","overview.marketing.description"),
new TagParameter("linkurl",url(true,(new URLPipelineAction(context.getFormattedValue("ViewOnlineMarketing-Overview",null))),(new URLParameterSet().addURLParameter(context.getFormattedValue("ChannelID",null),context.getFormattedValue(getObject("CurrentChannel:UUID"),null)))))}, 5); 
      out.write('\n');
 } 
      out.write('\n');
 printFooter(out); 
