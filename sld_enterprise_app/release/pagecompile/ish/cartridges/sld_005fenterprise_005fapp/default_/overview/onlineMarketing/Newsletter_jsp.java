...
public final class Newsletter_jsp extends com.intershop.beehive.core.internal.template.AbstractTemplate
...
new TagParameter("mapname","Parameters")}, 3); 
 {try{executePipeline("ViewEmailMarketing_52-GetProviderLink",((java.util.Map)(getObject("Parameters"))),"ResultDict");}catch(Exception e){Logger.error(this,"ISPIPELINE failed. Line: 4.",e);}} 
...
finally
{
    getTemplateExecutionConfig().setURLRewriteHandler(handler);
      ...
      out.write("</td>\n</tr>\n<tr>\n<td colspan=\"2\" class=\"overview_title_description\" valign=\"top\"> <div class=\"overview_description_container\">");
 processOpenTag(response, pageContext, "apptext", new TagParameter[] {
new TagParameter("key","marketing.newsletter.description")}, 12); 
