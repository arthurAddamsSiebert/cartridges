...
public final class ProductRetailSetSelection_jsp extends com.intershop.beehive.core.internal.template.AbstractTemplate
...
new TagParameter("text",localizeText(context.getFormattedValue("sld_enterprise_app.NewRetailSet.text",null)))}, 4); 
      out.write("<!-- Main Content -->\n<table cellpadding=\"0\" cellspacing=\"0\" border=\"0\" width=\"100%\">\n<tr>\n<td class=\"table_title aldi\" nowrap=\"nowrap\">");
 {out.write(localizeISText("sld_enterprise_app.NewRetailSetProducts.table_title",null,null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("</td>\n</tr>\n</table>");
 ...
 {out.write(localizeISText("sld_enterprise_app.YouHaveNotSelectedAnyProductsToAddToTheRetailSetUs.error",null,null,null,null,null,null,null,null,null,null,null,null));} 
      out.write(" \n</td>\n</tr>\n</table>");
 } 
      out.write("<!-- Main Content -->\n<table border=\"0\" cellpadding=\"0\" cellspacing=\"0\" width=\"100%\" class=\"w e s\">\n<tr>\n<td class=\"table_title_description\">");
 {out.write(localizeISText("sld_enterprise_app.TheListShowsAllProductsThatAreNotYetAPartOfTheCurr.table_title_description",null,null,null,null,null,null,null,null,null,null,null,null));} 
...
new TagParameter("searchtype",getObject("SearchType"))}, 29); 
      out.write("<!-- Main Content -->");
 URLPipelineAction action67 = new URLPipelineAction(context.getFormattedValue(url(true,(new URLPipelineAction(context.getFormattedValue("ViewProductRetailSet-Dispatch",null)))),null));String site67 = null;String serverGroup67 = null;String actionValue67 = context.getFormattedValue(url(true,(new URLPipelineAction(context.getFormattedValue("ViewProductRetailSet-Dispatch",null)))),null);if (site67 == null){  site67 = action67.getDomain();  if (site67 == null)  {      site67 = com.intershop.beehive.core.capi.request.Request.getCurrent().getRequestSite().getDomainName();  }}if (serverGroup67 == null){  serverGroup67 = action67.getServerGroup();  if (serverGroup67 == null)  {      serverGroup67 = com.intershop.beehive.core.capi.request.Request.getCurrent().getRequestSite().getServerGroup();  }}out.print("<form");out.print(" method=\"");out.print("post");out.print("\"");out.print(" action=\"");out.print(context.getFormattedValue(url(true,(new URLPipelineAction(context.getFormattedValue("ViewProductRetailSet-Dispatch",null)))),null));out.print("\"");out.print(" name=\"");out.print("detailForm");out.print("\"");out.print(">");out.print(context.prepareWACSRFTag(actionValue67, site67, serverGroup67,true)); 
 ...
 _boolean_result=false;try {_boolean_result=((Boolean)((((context.getFormattedValue(getObject("isLinked"),null).equals(context.getFormattedValue("true",null)))) ? Boolean.TRUE : Boolean.FALSE))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",75,e);}if (_boolean_result) { 
      ...
      out.write('"');
      out.write(' ');
 _boolean_result=false;try {_boolean_result=((Boolean)(getObject("Clipboard:contains(ProductBO:ID)"))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",78,e);}if (_boolean_result) { 
...
new TagParameter("parametername","ProductID")}, 107); 
      out.write("</tr>\n</table>\n<!-- End Page Cursor -->");
 } else { 
...
new TagParameter("EmptyRepositoryDesc",localizeText(context.getFormattedValue("ProductSearch.ThereAreNoProductsInList",null)))}, 116); 
