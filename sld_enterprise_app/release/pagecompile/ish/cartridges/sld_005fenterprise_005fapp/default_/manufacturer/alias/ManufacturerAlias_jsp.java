...
public final class ManufacturerAlias_jsp extends com.intershop.beehive.core.internal.template.AbstractTemplate
...
new TagParameter("text",localizeText(context.getFormattedValue("ManufacturerAlias.ManufacturerAliases.text",null)))}, 6); 
 processOpenTag(response, pageContext, "breadcrumbtrail", new TagParameter[] {
new TagParameter("text1",context.getFormattedValue(" - ",null) + context.getFormattedValue(localizeText(context.getFormattedValue("ManufacturerAlias.General.text1",null)),null)),
new TagParameter("listview","true"),
...
new TagParameter("type","sdc")}, 23); 
 ...
 {out.write(localizeISText("ManufacturerAlias.ManufacturerAliasUpdateFailed.error",null,null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("<br/>");
 _boolean_result=false;try {_boolean_result=((Boolean)((disableErrorMessages().isDefined(((((Boolean) getObject("ManufacturerNameAliasForm:ManufacturerNameAliasName:isMissing")).booleanValue() || ((Boolean) getObject("ManufacturerNameAliasForm:ManufacturerNameAliasName:isInvalid")).booleanValue()) ? Boolean.TRUE : Boolean.FALSE))))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",33,e);}if (_boolean_result) { 
 {out.write(localizeISText("ManufacturerAlias.PleaseProvideAValidNameForTheManufacturerAlias.error",null,null,null,null,null,null,null,null,null,null,null,null));} 
 } 
 ...
 {out.write(localizeISText("ManufacturerAlias.SpecifiedAliasNameIsAlreadyInUse.error",null,null,null,null,null,null,null,null,null,null,null,null));} 
 } 
 ...
 {out.write(localizeISText("ManufacturerAlias.SpecifiedAliasNameIsAlreadyAssignedToAlias.error",null,null,encodeString(context.getFormattedValue(getObject("OldAlias:NameAlias"),null)),null,null,null,null,null,null,null,null,null));} 
 } 
      out.write("</td>\n</tr>\n</table>\n</td>\n</tr>");
 } 
...
new TagParameter("message",localizeText(context.getFormattedValue("ManufacturerAlias.ClickOKToReassignNameToTheNewAliasOrCancelToCreateDifferentName.message",null))),
new TagParameter("type","sdc")}, 49); 
 } 
      out.write("<!-- end error handling -->\n<tr>\n<td class=\"table_title_description w e s\" nowrap=\"nowrap\">");
 {out.write(localizeISText("ManufacturerAlias.PleaseProvideTheNameToBeUsedAsAliasForAssignedManufacturers.table_title_description",null,null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("</td>\n</tr>");
 } else { 
      out.write("<tr>\n<td class=\"table_title_description w e s\" nowrap=\"nowrap\">");
 {out.write(localizeISText("ManufacturerAlias.NameWillBeUsedAsAliasForTheAssignedManufacturers.table_title_description",null,null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("</td>\n</tr>");
 } 
 ...
 _boolean_result=false;try {_boolean_result=((Boolean)((disableErrorMessages().isDefined(getObject("CurrentUserPermissionMap:SLD_MANAGE_PRODUCTS"))))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",71,e);}if (_boolean_result) { 
      out.write("<td nowrap=\"nowrap\" class=\"label\"><label class=\"label\" for=\"ManufacturerNameAliasForm_ManufacturerNameAliasName\">");
 {out.write(localizeISText("ManufacturerAlias.Name.label",null,null,null,null,null,null,null,null,null,null,null,null));} 
 ...
 _boolean_result=false;try {_boolean_result=((Boolean)((disableErrorMessages().isDefined(getObject("CurrentUserPermissionMap:SLD_MANAGE_PRODUCTS"))))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",81,e);}if (_boolean_result) { 
      out.write("<input type=\"text\" name=\"ManufacturerNameAliasForm_ManufacturerNameAliasName\" id=\"ManufacturerNameAliasForm_ManufacturerNameAliasName\" class=\"inputfield_en\" maxlength=\"2048\" size=\"70\" value=\"");
 ...
 _boolean_result=false;try {_boolean_result=((Boolean)((disableErrorMessages().isDefined(getObject("CurrentUserPermissionMap:SLD_MANAGE_PRODUCTS"))))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",105,e);}if (_boolean_result) { 
      ...
      out.print(context.getFormattedValue(localizeText(context.getFormattedValue("ManufacturerAlias.Apply.button",null)),null));
      out.write("\"/>\n</td>\n<td class=\"button\">\n<input class=\"button\" type=\"reset\" name=\"reset\" value=\"");
      out.print(context.getFormattedValue(localizeText(context.getFormattedValue("ManufacturerAlias.Reset.button",null)),null));
      out.write("\"/>\n</td>\n<td class=\"button\">\n<input class=\"button\" type=\"submit\" name=\"ConfirmSingleDelete\" value=\"");
      out.print(context.getFormattedValue(localizeText(context.getFormattedValue("ManufacturerAlias.Delete.button",null)),null));
      out.write("\"/>\n</td>\n</tr>\n</table>\n</td>\n</tr>\n</table>");
 } 
 out.print("</form>"); 
