...
public final class ViewContextFallbacksColumns_jsp extends com.intershop.beehive.core.internal.template.AbstractTemplate
...
setEncodingType("text/javascript"); 
 ...
 {Object temp_obj = (""); getPipelineDictionary().put("columns", temp_obj);} 
      ...
      out.write("\n(function () {\nvar allColumns = {\nnamelink: {\ntype: 'link',\ndataKey: 'name',\ntitle: '");
      out.print(context.getFormattedValue(localizeText(context.getFormattedValue("ViewContextTabDetails.Name.table_header",null)),null));
      out.write("',\nurl: '");
 {String value = null;try{value=context.getFormattedValue(context.getFormattedValue(url(true,(new URLPipelineAction(context.getFormattedValue("ViewPageletEntryPoint-View",null)))),null) + context.getFormattedValue("?ContentRepositoryUUID=",null) + context.getFormattedValue(getObject("params:ContentRepositoryUUID"),null) + context.getFormattedValue("&LocaleId=",null) + context.getFormattedValue(getObject("params:Locale:LocaleID"),null) + context.getFormattedValue("&PageletEntryPointUUID={pageletentrypointid}&Page={page}",null) + context.getFormattedValue("&StartFlag=true",null),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {16}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
      out.write("',\nwidth: 265,\nmaxWidth: 265,\nsortable: false\n},\ndescription: {\ntype: 'text',\ndataKey: 'description',\ntitle: '");
      out.print(context.getFormattedValue(localizeText(context.getFormattedValue("ViewContextTabDetails.Description.table_header",null)),null));
      out.write("',\nsortable: false\n},\ntype: {\ntype: 'text',\ndataKey: 'type',\ntitle: '");
      out.print(context.getFormattedValue(localizeText(context.getFormattedValue("ViewContextTabDetails.Type.table_header",null)),null));
      out.write("',\nwidth: 265,\nmaxWidth: 265,\nsortable: false\n}\n},\nnames = [");
 {String value = null;try{value=context.getFormattedValue(getObject("columns"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {36}",e);}if (value==null) value="";out.write(value);} 
