...
public final class ProductScript_jsp extends com.intershop.beehive.core.internal.template.AbstractTemplate
...
setEncodingType("text/javascript"); 
 ...
 out.print("</waplacement>"); 
      ...
      out.write("productSelection').addClass('small');\n$('");
      out.print(context.getFormattedValue("#",null));
      out.write("productSelection').removeClass('big');\n$('");
      out.print(context.getFormattedValue("#",null));
      out.write("productSelection').removeClass('medium');\n}\nelse if($dialog.children('iframe').parent().hasClass('medium'))\n{\n$('");
      out.print(context.getFormattedValue("#",null));
      out.write("productSelection').addClass('medium');\n$('");
      out.print(context.getFormattedValue("#",null));
      out.write("productSelection').removeClass('big');\n$('");
      out.print(context.getFormattedValue("#",null));
      out.write("productSelection').removeClass('small');\n}\nelse\n{\n$('");
      out.print(context.getFormattedValue("#",null));
      out.write("productSelection').addClass('big');\n$('");
      out.print(context.getFormattedValue("#",null));
      out.write("productSelection').removeClass('small');\n$('");
      out.print(context.getFormattedValue("#",null));
