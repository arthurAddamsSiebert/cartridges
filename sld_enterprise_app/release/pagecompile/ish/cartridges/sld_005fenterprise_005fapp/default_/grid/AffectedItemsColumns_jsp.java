...
public final class AffectedItemsColumns_jsp extends com.intershop.beehive.core.internal.template.AbstractTemplate
...
setEncodingType("text/javascript"); 
 ...
 {Object temp_obj = (""); getPipelineDictionary().put("columns", temp_obj);} 
      ...
      out.write("',\nsortable: false,\nwidth: 150,\nmaxWidth: 150\n},\n},\nnames = [");
 {String value = null;try{value=context.getFormattedValue(getObject("columns"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {41}",e);}if (value==null) value="";out.write(value);} 
