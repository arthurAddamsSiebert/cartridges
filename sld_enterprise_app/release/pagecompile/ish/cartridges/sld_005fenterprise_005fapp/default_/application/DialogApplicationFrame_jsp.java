...
public final class DialogApplicationFrame_jsp extends com.intershop.beehive.core.internal.template.AbstractTemplate
...
setEncodingType("text/html"); 
 ...
 {String value = null;try{value=context.getFormattedValue(getObject("WorkingTemplate"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {2}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
      out.write(" -->\n<!-- Template Location: ");
 {String value = null;try{value=context.getFormattedValue(getTemplateSourceLocation(context.getFormattedValue(getObject("WorkingTemplate"),null)),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {3}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
      out.write(" -->");
 ...
 {out.flush();processLocalIncludeByServer((com.intershop.beehive.core.capi.request.ServletResponse)response,"webcontrols/Placeholder", null, "7");} 
...
finally
{
 ...
 out.print("</waplacement>"); 
      ...
      out.write("dialog ");
      out.print(context.getFormattedValue("#",null));
      out.write("breadcrumb {display: none;}\n.sfe-dialog-hidden {display:none}\n</style>");
 {out.flush();processLocalIncludeByServer((com.intershop.beehive.core.capi.request.ServletResponse)response,"inc/GlobalJavaScript", null, "22");} 
 {out.flush();processLocalIncludeByServer((com.intershop.beehive.core.capi.request.ServletResponse)response,"inc/JSEnhancements.isml", null, "23");} 
      out.write("</head>\n<body id=\"dialog\" class=\"backoffice\">\n<!-- Working Area -->");
