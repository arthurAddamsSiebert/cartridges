...
new TagParameter("text",context.getFormattedValue(getObject("Profile:FirstName"),null) + context.getFormattedValue(" ",null) + context.getFormattedValue(getObject("Profile:LastName"),null))}, 11); 
 ...
 {out.write(localizeISText("sld_enterprise_app.01Addresses.table_title",null,null,encodeString(context.getFormattedValue(getObject("Profile:FirstName"),null)),encodeString(context.getFormattedValue(getObject("Profile:LastName"),null)),null,null,null,null,null,null,null,null));} 
...
new TagParameter("message",localizeText(context.getFormattedValue("sld_enterprise_app.AreYouSureThatYouWantToDeleteTheseAddresses.message",null)))}, 23); 
 } 
...
new TagParameter("message",localizeText(context.getFormattedValue("UserAddressList.YouHaveNotSelectedAnyAddressToBeDeletedU003cbrU003.message",null)))}, 27); 
 } 
 ...
 _boolean_result=false;try {_boolean_result=((Boolean)(getObject("aAddress:isDefaultAddress"))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",66,e);}if (_boolean_result) { 
      ...
      out.write('"');
      out.write(' ');
 _boolean_result=false;try {_boolean_result=((Boolean)((disableErrorMessages().isDefined(getObject("PrefixIterator"))))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",69,e);}if (_boolean_result) { 
 ...
 {String value = null;try{value=context.getFormattedValue(getObject("aAddress:AddressName"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {76}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
      out.write("</a>\n</td>\n</tr>");
 } 
      out.write("</table>");
 ...
 {String value = null;try{value=context.getFormattedValue(getObject("Profile:UUID"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {89}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
