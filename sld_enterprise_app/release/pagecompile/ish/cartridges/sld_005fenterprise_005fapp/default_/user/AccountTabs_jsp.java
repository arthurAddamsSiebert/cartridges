...
public final class AccountTabs_jsp extends com.intershop.beehive.core.internal.template.AbstractTemplate
...
setEncodingType("text/html"); 
 ...
 {out.write(localizeISText("sld_enterprise_app.General.table_tabs_en_background",null,null,null,null,null,null,null,null,null,null,null,null));} 
      ...
      out.print(context.getFormattedValue(url(true,(new URLPipelineAction(context.getFormattedValue("ViewAccountAddressList-List",null))),(new URLParameterSet().addURLParameter(context.getFormattedValue("USER_UUID",null),context.getFormattedValue(getObject("Profile:UUID"),null)))),null));
 ...
 {out.write(localizeISText("sld_enterprise_app.Addresses.link",null,null,null,null,null,null,null,null,null,null,null,null));} 
      ...
      out.print(context.getFormattedValue(url(true,(new URLPipelineAction(context.getFormattedValue("ViewAccount-Show",null))),(new URLParameterSet().addURLParameter(context.getFormattedValue("USER_UUID",null),context.getFormattedValue(getObject("USER_UUID"),null)))),null));
      out.write('"');
      out.write('>');
