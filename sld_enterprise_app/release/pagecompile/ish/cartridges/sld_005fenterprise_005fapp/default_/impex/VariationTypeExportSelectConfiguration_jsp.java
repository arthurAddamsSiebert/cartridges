...
public final class VariationTypeExportSelectConfiguration_jsp extends com.intershop.beehive.core.internal.template.AbstractTemplate
...
new TagParameter("text",localizeText(context.getFormattedValue("VariationTypeExportSelectConfiguration.VariationTypeExportStep2ConfigureExport.text",null)))}, 3); 
 ...
 {out.write(localizeISText("VariationTypeExportSelectConfiguration.VariationTypeExportStep2ConfigureExport.table_title",null,null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("</td>\n</tr>\n</table>");
 ...
 {out.write(localizeISText("VariationTypeExportSelectConfiguration.ExportCouldNotBeExecuted.error",null,null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("</td>\n</tr>\n</table>");
 } 
 ...
 {out.write(localizeISText("ProductExportSelectConfiguration.Step2Of2.table_title_description",null,null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("</td>\n</tr>\n<tr>\n<td class=\"table_title_description\">");
 {out.write(localizeISText("VariationTypeExportSelectConfiguration.FieldsWithARedAsterisk.table_title_description",null,null,"star",null,null,null,null,null,null,null,null,null));} 
 ...
 {out.write(localizeISText("VariationTypeExportSelectConfiguration.ExportAllVariationTypes.label",null,null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("</label></td>\n</tr>\n<tr>\n<td class=\"input_radio s\" width=\"1%\">\n<input type=\"radio\" name=\"ExportSearchResult\" id=\"ExportSelectedVariationTypes\" value=\"false\" ");
 _boolean_result=false;try {_boolean_result=((Boolean)((((Boolean) ((hasLoopElements("UUIDIterator") ? Boolean.TRUE : Boolean.FALSE))).booleanValue() ? Boolean.FALSE : Boolean.TRUE) )).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",52,e);}if (_boolean_result) { 
      out.write("disabled=\"disabled\"");
 } else { 
      out.write("checked=\"checked\"");
 } 
      out.write("/>\n</td>\n<td class=\"label_radio_text w s\" nowrap=\"nowrap\"><label class=\"label label_radio_text label_light\" for=\"ExportSelectedVariationTypes\">&nbsp;");
 {out.write(localizeISText("VariationTypeExportSelectConfiguration.ExportSelectedVariationTypes.label",null,null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("</label></td>\n</tr>\n</table>\n</td>\n</tr>\n<tr>\n<td colspan=\"2\"><img src=\"");
      out.print(context.getFormattedValue(context.webRoot(),null));
      out.write("/images/space.gif\" width=\"1\" height=\"6\" alt=\"\" border=\"0\"/></td>\n</tr>\n<tr>");
 _boolean_result=false;try {_boolean_result=((Boolean)(getObject("VariationTypeExportForm:isSubmitted"))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",63,e);}if (_boolean_result) { 
 _boolean_result=false;try {_boolean_result=((Boolean)((((((Boolean) getObject("VariationTypeExportForm:ExportFile:isMissing")).booleanValue() || ((Boolean) getObject("VariationTypeExportForm:ExportFile:isInvalid")).booleanValue()) ? Boolean.TRUE : Boolean.FALSE)))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",64,e);}if (_boolean_result) { 
      out.write("<td nowrap=\"nowrap\" class=\"label s\"><label class=\"label label_error\" for=\"VariationTypeExportForm_ExportFile\">");
 {out.write(localizeISText("ViewContextExportHeader.ExportFile.fielditem2",null,null,null,null,null,null,null,null,null,null,null,null));} 
      ...
      out.write("<td nowrap=\"nowrap\" class=\"label s\"><label class=\"label\" for=\"VariationTypeExportForm_ExportFile\">");
 {out.write(localizeISText("ViewContextExportHeader.ExportFile.fielditem2",null,null,null,null,null,null,null,null,null,null,null,null));} 
      out.write(":<span class=\"star\">*</span></label></td>");
 } 
      out.write("<td class=\"fielditem2 s\" width=\"100%\">\n<input type=\"text\" name=\"VariationTypeExportForm_ExportFile\" id=\"VariationTypeExportForm_ExportFile\" size=\"40\" class=\"inputfield_en\" value=\"");
 {String value = null;try{value=context.getFormattedValue(getObject("VariationTypeExportForm:ExportFile:Value"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {70}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
      out.write("\"/>\n</td>");
 } else { 
      out.write("<td nowrap=\"nowrap\" class=\"label s\"><label class=\"label\" for=\"VariationTypeExportForm_ExportFile\">");
 {out.write(localizeISText("ViewContextExportHeader.ExportFile.fielditem2",null,null,null,null,null,null,null,null,null,null,null,null));} 
