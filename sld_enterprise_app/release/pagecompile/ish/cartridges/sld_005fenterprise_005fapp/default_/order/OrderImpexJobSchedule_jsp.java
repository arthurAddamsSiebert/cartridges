...
public final class OrderImpexJobSchedule_jsp extends com.intershop.beehive.core.internal.template.AbstractTemplate
...
setEncodingType("text/html"); 
 ...
 {out.write(localizeISText("OrderImpexJobSchedule.Manually.label",null,null,null,null,null,null,null,null,null,null,null,null));} 
 ...
 _boolean_result=false;try {_boolean_result=((Boolean)((disableErrorMessages().isDefined(getObject("errormap:RunOnceDateError"))))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",34,e);}if (_boolean_result) { 
      ...
      out.write('"');
      out.write('>');
 {out.write(localizeISText("OrderImpexJobSchedule.RunOnce.label",null,null,null,null,null,null,null,null,null,null,null,null));} 
...
new TagParameter("InputFieldLabel","at")}, 48); 
 } else { 
 processOpenTag(response, pageContext, "dateinput", new TagParameter[] {
new TagParameter("InputFieldName","RunOnce_Date"),
...
new TagParameter("InputFieldLabel","at")}, 51); 
 ...
 {out.write(localizeISText("OrderImpexJobSchedule.RecurringInterval.label",null,null,null,null,null,null,null,null,null,null,null,null));} 
 ...
 {out.write(localizeISText("OrderImpexJobSchedule.Active.label",null,null,null,null,null,null,null,null,null,null,null,null));} 
      out.write(":</label>");
 } else { 
...
new TagParameter("DateString","")}, 89); 
 ...
 {out.write(localizeISText("OrderImpexJobSchedule.RunTime.label",null,null,null,null,null,null,null,null,null,null,null,null));} 
      out.write(":</label>");
 } else { 
...
new TagParameter("TimeString","")}, 115); 
 ...
 {out.write(localizeISText("OrderImpexJobSchedule.Every.label",null,null,null,null,null,null,null,null,null,null,null,null));} 
      out.write(":</label>");
 } else { 
 ...
 _boolean_result=false;try {_boolean_result=((Boolean)((( ((Number) getObject("jobcondition:Unit")).doubleValue() ==((Number)(new Double(0))).doubleValue()) ? Boolean.TRUE : Boolean.FALSE))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",170,e);}if (_boolean_result) { 
      ...
      out.write('>');
 {out.write(localizeISText("OrderImpexJobSchedule.Minutes.option",null,null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("</option>\n<option value=\"Hours\" ");
 _boolean_result=false;try {_boolean_result=((Boolean)((( ((Number) getObject("jobcondition:Unit")).doubleValue() ==((Number)(new Double(1))).doubleValue()) ? Boolean.TRUE : Boolean.FALSE))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",171,e);}if (_boolean_result) { 
      ...
      out.write('>');
 {out.write(localizeISText("OrderImpexJobSchedule.Hours.option",null,null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("</option>\n<option value=\"Days\" ");
 _boolean_result=false;try {_boolean_result=((Boolean)((( ((Number) getObject("jobcondition:Unit")).doubleValue() ==((Number)(new Double(2))).doubleValue()) ? Boolean.TRUE : Boolean.FALSE))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",172,e);}if (_boolean_result) { 
      ...
      out.write('>');
 {out.write(localizeISText("OrderImpexJobSchedule.Days.option",null,null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("</option>\n<option value=\"Weeks\" ");
 _boolean_result=false;try {_boolean_result=((Boolean)((( ((Number) getObject("jobcondition:Unit")).doubleValue() ==((Number)(new Double(4))).doubleValue()) ? Boolean.TRUE : Boolean.FALSE))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",173,e);}if (_boolean_result) { 
      ...
      out.write('>');
 {out.write(localizeISText("OrderImpexJobSchedule.Weeks.option",null,null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("</option>\n<option value=\"Months\" ");
 _boolean_result=false;try {_boolean_result=((Boolean)((( ((Number) getObject("jobcondition:Unit")).doubleValue() ==((Number)(new Double(5))).doubleValue()) ? Boolean.TRUE : Boolean.FALSE))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",174,e);}if (_boolean_result) { 
      ...
      out.write('>');
 {out.write(localizeISText("OrderImpexJobSchedule.Months.option",null,null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("</option>\n<option value=\"Years\" ");
 _boolean_result=false;try {_boolean_result=((Boolean)((( ((Number) getObject("jobcondition:Unit")).doubleValue() ==((Number)(new Double(6))).doubleValue()) ? Boolean.TRUE : Boolean.FALSE))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",175,e);}if (_boolean_result) { 
      out.write("selected=\"selected\"");
 } 
      out.write('>');
 {out.write(localizeISText("OrderImpexJobSchedule.Years.option",null,null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("</option>\n</select>\n</td>\n</tr>\n</table>\n</td>\n</tr>\n<tr>\n<td colspan=\"4\"><img src=\"");
      out.print(context.getFormattedValue(context.webRoot(),null));
      out.write("/images/space.gif\" width=\"1\" height=\"6\" alt=\"\" border=\"0\"/></td>\n</tr>");
 _boolean_result=false;try {_boolean_result=((Boolean)((disableErrorMessages().isDefined(getObject("errormap:RecurringInterval"))))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",190,e);}if (_boolean_result) { 
 ...
 {out.write(localizeISText("OrderImpexJobSchedule.OnTheseDays.label",null,null,null,null,null,null,null,null,null,null,null,null));} 
      out.write(":</label>\n</td>");
 } else { 
      out.write("<td class=\"input_radio label_fix1\" nowrap=\"nowrap\" width=\"1%\">");
 ...
 _boolean_result=false;try {_boolean_result=((Boolean)((((context.getFormattedValue(getObject("Day"),null).equals(context.getFormattedValue("Monday",null)))) ? Boolean.TRUE : Boolean.FALSE))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",266,e);}if (_boolean_result) { 
      out.write("checked=\"checked\"");
 if (getLoopStack().isEmpty()) {Logger.error(this,"ISBREAK occured outside ISLOOP. Line: {}",266);}else{getLoopStack().pop();break;} 
 } 
 } 
 } 
      out.write("/></td>\n<td class=\"label_checkbox_text\"><label for=\"RecurringInterval_Days_Mo\" class=\"label label_checkbox_text\">");
 {out.write(localizeISText("OrderImpexJobSchedule.Monday.label",null,null,null,null,null,null,null,null,null,null,null,null));} 
 ...
 {out.write(localizeISText("OrderImpexJobSchedule.Tuesday.label",null,null,null,null,null,null,null,null,null,null,null,null));} 
 ...
 _boolean_result=false;try {_boolean_result=((Boolean)((((context.getFormattedValue(getObject("Day"),null).equals(context.getFormattedValue("Wednesday",null)))) ? Boolean.TRUE : Boolean.FALSE))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",270,e);}if (_boolean_result) { 
      out.write("checked=\"checked\"");
 if (getLoopStack().isEmpty()) {Logger.error(this,"ISBREAK occured outside ISLOOP. Line: {}",270);}else{getLoopStack().pop();break;} 
 } 
 } 
 } 
      out.write("/></td>\n<td class=\"label_checkbox_text\"><label for=\"RecurringInterval_Days_We\" class=\"label label_checkbox_text\">");
 {out.write(localizeISText("OrderImpexJobSchedule.Wednesday.label",null,null,null,null,null,null,null,null,null,null,null,null));} 
 ...
 _boolean_result=false;try {_boolean_result=((Boolean)((((context.getFormattedValue(getObject("Day"),null).equals(context.getFormattedValue("Thursday",null)))) ? Boolean.TRUE : Boolean.FALSE))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",272,e);}if (_boolean_result) { 
      out.write("checked=\"checked\"");
 if (getLoopStack().isEmpty()) {Logger.error(this,"ISBREAK occured outside ISLOOP. Line: {}",272);}else{getLoopStack().pop();break;} 
 } 
 } 
 } 
      out.write("/></td>\n<td class=\"label_checkbox_text\"><label for=\"RecurringInterval_Days_Th\" class=\"label label_checkbox_text\">");
 {out.write(localizeISText("OrderImpexJobSchedule.Thursday.label",null,null,null,null,null,null,null,null,null,null,null,null));} 
 ...
 _boolean_result=false;try {_boolean_result=((Boolean)((((context.getFormattedValue(getObject("Day"),null).equals(context.getFormattedValue("Friday",null)))) ? Boolean.TRUE : Boolean.FALSE))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",276,e);}if (_boolean_result) { 
      out.write("checked=\"checked\"");
 if (getLoopStack().isEmpty()) {Logger.error(this,"ISBREAK occured outside ISLOOP. Line: {}",276);}else{getLoopStack().pop();break;} 
 } 
 } 
 } 
      out.write("/></td>\n<td class=\"label_checkbox_text\"><label for=\"RecurringInterval_Days_Fr\" class=\"label label_checkbox_text\">");
 {out.write(localizeISText("OrderImpexJobSchedule.Friday.label",null,null,null,null,null,null,null,null,null,null,null,null));} 
 ...
 _boolean_result=false;try {_boolean_result=((Boolean)((((context.getFormattedValue(getObject("Day"),null).equals(context.getFormattedValue("Saturday",null)))) ? Boolean.TRUE : Boolean.FALSE))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",278,e);}if (_boolean_result) { 
      out.write("checked=\"checked\"");
 if (getLoopStack().isEmpty()) {Logger.error(this,"ISBREAK occured outside ISLOOP. Line: {}",278);}else{getLoopStack().pop();break;} 
 } 
 } 
 } 
      out.write("/></td>\n<td class=\"label_checkbox_text\"><label for=\"RecurringInterval_Days_Sa\" class=\"label label_checkbox_text\">");
 {out.write(localizeISText("OrderImpexJobSchedule.Saturday.label",null,null,null,null,null,null,null,null,null,null,null,null));} 
 ...
 _boolean_result=false;try {_boolean_result=((Boolean)((((context.getFormattedValue(getObject("Day"),null).equals(context.getFormattedValue("Sunday",null)))) ? Boolean.TRUE : Boolean.FALSE))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",280,e);}if (_boolean_result) { 
      out.write("checked=\"checked\"");
 if (getLoopStack().isEmpty()) {Logger.error(this,"ISBREAK occured outside ISLOOP. Line: {}",280);}else{getLoopStack().pop();break;} 
 } 
 } 
 } 
      out.write("/></td>\n<td class=\"label_checkbox_text\"><label for=\"RecurringInterval_Days_So\" class=\"label label_checkbox_text\">");
 {out.write(localizeISText("OrderImpexJobSchedule.Sunday.label",null,null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("</label></td>\n</tr>");
 } else { 
      out.write("<tr>\n<td class=\"input_checkbox\"><input type=\"checkbox\" name=\"RecurringInterval_Days\" id=\"RecurringInterval_Days_Mo\" value=\"Monday\" ");
 ...
 _boolean_result=false;try {_boolean_result=((Boolean)((((context.getFormattedValue(getObject("Day"),null).equals(context.getFormattedValue("Monday",null)))) ? Boolean.TRUE : Boolean.FALSE))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",285,e);}if (_boolean_result) { 
      out.write("checked=\"checked\"");
 if (getLoopStack().isEmpty()) {Logger.error(this,"ISBREAK occured outside ISLOOP. Line: {}",285);}else{getLoopStack().pop();break;} 
 } 
 } 
 } 
 ...
 _boolean_result=false;try {_boolean_result=((Boolean)((((context.getFormattedValue(getObject("Day"),null).equals(context.getFormattedValue("Tuesday",null)))) ? Boolean.TRUE : Boolean.FALSE))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",287,e);}if (_boolean_result) { 
      out.write("checked=\"checked\"");
 if (getLoopStack().isEmpty()) {Logger.error(this,"ISBREAK occured outside ISLOOP. Line: {}",287);}else{getLoopStack().pop();break;} 
 } 
 } 
 } 
      out.write(" disabled=\"disabled\"/></td>\n<td class=\"label_checkbox_text\"><label for=\"RecurringInterval_Days_Tu\" class=\"label label_checkbox_text\">");
 ...
 _boolean_result=false;try {_boolean_result=((Boolean)((((context.getFormattedValue(getObject("Day"),null).equals(context.getFormattedValue("Wednesday",null)))) ? Boolean.TRUE : Boolean.FALSE))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",289,e);}if (_boolean_result) { 
      out.write("checked=\"checked\"");
 if (getLoopStack().isEmpty()) {Logger.error(this,"ISBREAK occured outside ISLOOP. Line: {}",289);}else{getLoopStack().pop();break;} 
 } 
 } 
 } 
      out.write(" disabled=\"disabled\"/></td>\n<td class=\"label_checkbox_text\"><label for=\"RecurringInterval_Days_We\" class=\"label label_checkbox_text\">");
 ...
 _boolean_result=false;try {_boolean_result=((Boolean)((((context.getFormattedValue(getObject("Day"),null).equals(context.getFormattedValue("Thursday",null)))) ? Boolean.TRUE : Boolean.FALSE))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",291,e);}if (_boolean_result) { 
      out.write("checked=\"checked\"");
 if (getLoopStack().isEmpty()) {Logger.error(this,"ISBREAK occured outside ISLOOP. Line: {}",291);}else{getLoopStack().pop();break;} 
 } 
 } 
 } 
      out.write(" disabled=\"disabled\"/></td>\n<td class=\"label_checkbox_text\"><label for=\"RecurringInterval_Days_Th\" class=\"label label_checkbox_text\">");
 ...
 _boolean_result=false;try {_boolean_result=((Boolean)((((context.getFormattedValue(getObject("Day"),null).equals(context.getFormattedValue("Friday",null)))) ? Boolean.TRUE : Boolean.FALSE))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",295,e);}if (_boolean_result) { 
      out.write("checked=\"checked\"");
 if (getLoopStack().isEmpty()) {Logger.error(this,"ISBREAK occured outside ISLOOP. Line: {}",295);}else{getLoopStack().pop();break;} 
 } 
 } 
 } 
      out.write(" disabled=\"disabled\"/></td>\n<td class=\"label_checkbox_text\"><label for=\"RecurringInterval_Days_Fr\" class=\"label label_checkbox_text\">");
 ...
 _boolean_result=false;try {_boolean_result=((Boolean)((((context.getFormattedValue(getObject("Day"),null).equals(context.getFormattedValue("Saturday",null)))) ? Boolean.TRUE : Boolean.FALSE))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",297,e);}if (_boolean_result) { 
      out.write("checked=\"checked\"");
 if (getLoopStack().isEmpty()) {Logger.error(this,"ISBREAK occured outside ISLOOP. Line: {}",297);}else{getLoopStack().pop();break;} 
 } 
 } 
 } 
      out.write(" disabled=\"disabled\"/></td>\n<td class=\"label_checkbox_text\"><label for=\"RecurringInterval_Days_Sa\" class=\"label label_checkbox_text\">");
 ...
 _boolean_result=false;try {_boolean_result=((Boolean)((((context.getFormattedValue(getObject("Day"),null).equals(context.getFormattedValue("Sunday",null)))) ? Boolean.TRUE : Boolean.FALSE))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",299,e);}if (_boolean_result) { 
      out.write("checked=\"checked\"");
 if (getLoopStack().isEmpty()) {Logger.error(this,"ISBREAK occured outside ISLOOP. Line: {}",299);}else{getLoopStack().pop();break;} 
 } 
 } 
 } 
      out.write(" disabled=\"disabled\"/></td>\n<td class=\"label_checkbox_text\"><label for=\"RecurringInterval_Days_So\" class=\"label label_checkbox_text\">");
 ...
 {String value = null;try{value=context.getFormattedValue(getObject("CurrentRequest:Locale:DefaultRegionalSettings:inputTimePattern"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {316}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
      out.write("\"/>\n<input type=\"submit\" name=\"update\" value=\"");
      out.print(context.getFormattedValue(localizeText(context.getFormattedValue("OrderImpexJobSchedule.Apply.button",null)),null));
      out.write("\" class=\"button\"/>\n</td>\n<td class=\"button\">\n<input type=\"submit\" name=\"reset\" value=\"");
      out.print(context.getFormattedValue(localizeText(context.getFormattedValue("OrderImpexJobSchedule.Reset.button",null)),null));
      out.write("\" class=\"button\"/>\n</td>\n</tr>\n</table>\n</td>\n</tr>");
 } 
      out.write("</table>\n</td>\n</tr>\n</table>");
 printFooter(out); 
