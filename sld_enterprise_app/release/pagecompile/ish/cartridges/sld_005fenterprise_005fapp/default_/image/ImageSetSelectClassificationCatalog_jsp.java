...
public final class ImageSetSelectClassificationCatalog_jsp extends com.intershop.beehive.core.internal.template.AbstractTemplate
...
printHeader(out);
      ...
      out.write("<!-- TEMPLATENAME: image/ImageSetSelectClassificationCatalog.isml -->\n");
...
new TagParameter("text",localizeText(context.getFormattedValue("ImageSetSelectClassificationCatalog.AddClassificationCategory.text",null)))}, 5); 
 ...
 {String value = null;try{value=context.getFormattedValue(getObject("ImageSet:Name"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {14}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
      ...
      out.write('-');
      out.write(' ');
 {out.write(localizeISText("ImageSetSelectClassificationCatalog.AddClassificationCategory.table_title",null,null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("</td>\n</tr>");
 ...
 {out.write(localizeISText("ImageSetSelectClassificationCatalog.YouHaveNotSelectedAClassificationCatalog.error",null,null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("</td>\n</tr>\n</table>\n</td>\n</tr>");
 } 
      out.write("<tr>\n<td class=\"table_title_description w e s\">");
 {out.write(localizeISText("ImageSetSelectClassificationCatalog.Step1Of2SelectAClassificationCatalog.table_title_description",null,null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("</td>\n</tr>\n</table>\n<table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\">");
 ...
 {out.write(localizeISText("ChannelColumns.Name",null,null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("</td>\n<td class=\"table_header w s\" nowrap=\"nowrap\">");
 {out.write(localizeISText("ChannelColumns.Type",null,null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("</td>\n<td class=\"table_header w s\" nowrap=\"nowrap\">");
 ...
 _boolean_result=false;try {_boolean_result=((Boolean)((((context.getFormattedValue(getObject("CatalogUUID"),null).equals(context.getFormattedValue(getObject("Catalog:UUID"),null)))) ? Boolean.TRUE : Boolean.FALSE))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",52,e);}if (_boolean_result) { 
      ...
      out.print(context.getFormattedValue(url(true,(new URLPipelineAction(context.getFormattedValue("ViewProductCategoryAssignmentWizard-CatalogDetails",null))),(new URLParameterSet().addURLParameter(context.getFormattedValue("CatalogID",null),context.getFormattedValue(getObject("Catalog:Id"),null)))),null));
 ...
 {out.write(localizeISText("ImageSetSelectClassificationCatalog.Shared.table_detail",null,null,null,null,null,null,null,null,null,null,null,null));} 
 } else { 
 {out.write(localizeISText("ImageSetSelectClassificationCatalog.Local.table_detail",null,null,null,null,null,null,null,null,null,null,null,null));} 
 } 
 ...
 {out.write(localizeISText("ImageSetSelectClassificationCatalog.Online.table_detail",null,null,null,null,null,null,null,null,null,null,null,null));} 
 } else { 
 ...
 {out.write(localizeISText("ImageSetSelectClassificationCatalog.NoDescriptionAvailable.table_detail",null,null,null,null,null,null,null,null,null,null,null,null));} 
 } 
      out.write("</td>\n</tr>");
 } 
 } else { 
      out.write("<tr>\n<td class=\"table_detail w e s\" colspan=\"5\">");
 {out.write(localizeISText("ImageSetSelectClassificationCatalog.ThereAreCurrentlyNoClassificationCatalogs.table_detail",null,null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("</td>\n</tr> \n");
 } 
