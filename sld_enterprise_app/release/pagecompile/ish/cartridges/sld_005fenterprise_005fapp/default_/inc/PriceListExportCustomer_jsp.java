...
import com.intershop.component.product.pricing.capi.PriceListBOCustomerExtension;
import com.intershop.component.pricing.capi.pricelist.PriceListBORepository;
import com.intershop.component.pricing.capi.pricelist.PriceListBO;
...
public final class PriceListExportCustomer_jsp extends com.intershop.beehive.core.internal.template.AbstractTemplate
...
setEncodingType("text/xml"); 
 ...
 while (loop("CustomerExtension:CustomerBOs","CustomerBO",null)) { 
      out.write("\n\t\t<customer id=\"");
 {String value = null;try{value=context.getFormattedValue(getObject("CustomerBO:CustomerNo"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {20}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
      out.write("\"/>\n\t");
 } 
      out.write("\n\t</customers>\n");
 } 
