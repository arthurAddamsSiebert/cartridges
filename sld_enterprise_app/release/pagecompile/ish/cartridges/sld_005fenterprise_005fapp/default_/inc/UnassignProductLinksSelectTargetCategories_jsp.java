...
public final class UnassignProductLinksSelectTargetCategories_jsp extends com.intershop.beehive.core.internal.template.AbstractTemplate
...
new TagParameter("text",localizeText(context.getFormattedValue("UnassignProductLinksSelectTargetCategories.Step3UnassignProductCategoryLinks.text",null)))}, 11); 
 } else { 
 processOpenTag(response, pageContext, "breadcrumbtrail", new TagParameter[] {
new TagParameter("listview","true"),
...
new TagParameter("text",localizeText(context.getFormattedValue("UnassignProductLinksSelectTargetCategories.Step3UnassignProductCategoryLinks.text",null)))}, 19); 
 ...
 {out.write(localizeISText("UnassignProductLinksSelectTargetCategories.YouHaveNotSelectedAnyTargetCategories.error",null,null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("</td>\n</tr>\n</table>\n</td>\n</tr>");
 } 
 ...
 {out.write(localizeISText("UnassignProductLinksSelectTargetProducts.Step3Of4NextStepConfirmation.table_title_description",null,null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("</BR></BR>");
 {out.write(localizeISText("UnassignProductLinksSelectTargetCategories.ThisListShowsAllTargetCategoriesOfTheType.table_title_descriptionPart1",null,null,null,null,null,null,null,null,null,null,null,null));} 
 ...
 {out.write(localizeISText("UnassignProductLinksSelectTargetCategories.ThisListShowsAllTargetCategoriesOfTheType.table_title_descriptionPart2",null,null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("</BR>");
 _boolean_result=false;try {_boolean_result=((Boolean)((hasLoopElements("LinkedTargets") ? Boolean.TRUE : Boolean.FALSE))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",60,e);}if (_boolean_result) { 
      out.write("</BR>");
 {out.write(localizeISText("UnassignProductLinksSelectTargetCategories.UseTheCheckboxesAndClickNext.table_title_description",null,null,null,null,null,null,null,null,null,null,null,null));} 
 } 
 ...
 {out.write(localizeISText("UnassignProductLinksSelectTargetCategories.ThereAreNoCategoriesLinked.table_detail",null,null,null,null,null,null,null,null,null,null,null,null));} 
 while (loop("SelectedProductLinkTypeSummaryDisplayMap:Values:Iterator","SelectedProductLinkTypeSummary","count")) { 
 ...
 {out.write(localizeISText("UnassignProductLinksSelectTargetProducts.NumberOfLinks.table_header",null,null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("</td>\n</tr>");
 while (loop("LinkedTargets","Category",null)) { 
      out.write("<tr>\n<td class=\"e s center\">\n<input type=\"checkbox\" name=\"SelectedUniqueIdentifier\" value=\"");
 {String value = null;try{value=context.getFormattedValue(getObject("Category:UniqueIdentifier"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {122}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
      out.write('"');
      out.write(' ');
 ...
 {String value = null;try{value=context.getFormattedValue(getObject("Category:UniqueIdentifier"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {123}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
      out.write("\"/>\n</td>\n<td class=\"table_detail e s top\">\n<a href=\"");
      out.print(context.getFormattedValue(url(true,(new URLPipelineAction(context.getFormattedValue("ViewCategorySelectWizard-CategoryDetails",null))),(new URLParameterSet().addURLParameter(context.getFormattedValue("CategoryUUID",null),context.getFormattedValue(getObject("Category:Category:UUID"),null))).addURLParameter(context.getFormattedValue("backToList",null),context.getFormattedValue("backToList",null))),null));
      out.write("\" class=\"table_detail_link\">");
 {String value = null;try{value=context.getFormattedValue(getObject("Category:Category:DisplayName"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {127}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
      out.write("</a>\n</td>\n<td class=\"table_detail e s top\" nowrap=\"nowrap\">\n<a href=\"");
      out.print(context.getFormattedValue(url(true,(new URLPipelineAction(context.getFormattedValue("ViewCategorySelectWizard-CategoryDetails",null))),(new URLParameterSet().addURLParameter(context.getFormattedValue("CategoryUUID",null),context.getFormattedValue(getObject("Category:Category:UUID"),null))).addURLParameter(context.getFormattedValue("backToList",null),context.getFormattedValue("backToList",null))),null));
      out.write("\" class=\"table_detail_link\">");
 {String value = null;try{value=context.getFormattedValue(getObject("Category:Category:Name"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {132}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
      out.write("</a>\n</td>\n<td class=\"table_detail e s top left\" nowrap=\"nowrap\">");
 {String value = null;try{value=context.getFormattedValue(getObject("Category:Category:Description"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {136}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
      out.write("</td>\n<td class=\"table_detail e s top left\" nowrap=\"nowrap\">");
 ...
 {out.write(localizeISText(context.getFormattedValue(context.getFormattedValue("typeCodeDefinition.",null) + context.getFormattedValue(getObject("Category:TypeCodeGroup"),null) + context.getFormattedValue(".",null) + context.getFormattedValue(getObject("Category:TypeCodeName"),null) + context.getFormattedValue(".displayName",null),null),"",null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("</td>\n<td class=\"table_detail s left\">");
 {String value = null;try{value=context.getFormattedValue(getObject("Category:LinkCount"),new Integer(INTEGER),null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {147}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
      out.write("</td>\n</tr>");
 } 
 } 
...
new TagParameter("variablepagesize","true")}, 183); 
