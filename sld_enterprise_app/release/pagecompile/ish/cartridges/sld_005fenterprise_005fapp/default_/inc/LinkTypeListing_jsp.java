...
public final class LinkTypeListing_jsp extends com.intershop.beehive.core.internal.template.AbstractTemplate
...
setEncodingType("text/html"); 
 ...
 _boolean_result=false;try {_boolean_result=((Boolean)((disableErrorMessages().isDefined(getObject("TypeCodesToEdit"))))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",7,e);}if (_boolean_result) { 
      out.write("\n\t<tr>\n\t\t<td>\n\t\t\t<table class=\"w e s\" width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\">\n\t\t\t\t<tr>\n\t\t\t\t\t<td class=\"fielditem2\" width=\"10%\" nowrap=\"nowrap\">");
 {out.write(localizeISText("LinkTypeListing.LinkType.fielditem2",null,null,null,null,null,null,null,null,null,null,null,null));} 
 ...
 {Object temp_obj = ("True"); getPipelineDictionary().put("ItemChecked", temp_obj);} 
      ...
      out.write("\n\t\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\t\t<td>\n\t\t\t\t\t\t\t\t\t\t<input type=\"radio\" name=\"SelectedLinkType\" value=\"");
 ...
 {out.write(localizeISText(context.getFormattedValue(context.getFormattedValue("typeCodeDefinition.",null) + context.getFormattedValue(getObject("TypeCodeGroup"),null) + context.getFormattedValue(".",null) + context.getFormattedValue(getObject("TypeCode"),null) + context.getFormattedValue(".displayName",null),null),"",null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("</td>\n\t\t\t\t\t\t\t\t\t<td class=\"catalog_description\" width=\"100%\">");
 {out.write(localizeISText(context.getFormattedValue(context.getFormattedValue("typeCodeDefinition.",null) + context.getFormattedValue(getObject("TypeCodeGroup"),null) + context.getFormattedValue(".",null) + context.getFormattedValue(getObject("TypeCode"),null) + context.getFormattedValue(".description",null),null),"",null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("</td>\n\t\t\t\t\t\t\t\t</tr>\n\t\t\t\t\t\t\t\t");
