...
public final class CategoryTreeNode_jsp extends com.intershop.beehive.core.internal.template.AbstractTemplate
...
new TagParameter("SortedCategories","SortedSubCategories")}, 12); 
 ...
 _boolean_result=false;try {_boolean_result=((Boolean)(((((Boolean) (hasLoopElements("selectedcategories") ? Boolean.TRUE : Boolean.FALSE)).booleanValue() && ((Boolean) getObject("selectedcategories:Contains(subcategory:UUID)")).booleanValue()) ? Boolean.TRUE : Boolean.FALSE))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",15,e);}if (_boolean_result) { 
      ...
      out.write(' ');
 _boolean_result=false;try {_boolean_result=((Boolean)(((((Boolean) (hasLoopElements("lazycategories") ? Boolean.TRUE : Boolean.FALSE)).booleanValue() && ((Boolean) getObject("lazycategories:Contains(subcategory:UUID)")).booleanValue()) ? Boolean.TRUE : Boolean.FALSE))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",15,e);}if (_boolean_result) { 
      out.write("lazy");
 } 
      out.write("\" title=\"");
      ...
      out.write('"');
      out.write('>');
 _boolean_result=false;try {_boolean_result=((Boolean)((disableErrorMessages().isDefined(getObject("detailspagepipeline"))))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",17,e);}if (_boolean_result) { 
      out.write("<a href=\"");
      ...
      out.write('"');
      out.write('>');
 {String value = null;try{value=context.getFormattedValue(getObject("subcategory:DisplayName"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {25}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
      out.write("</a>");
 } else { 
 {String value = null;try{value=context.getFormattedValue(getObject("subcategory:DisplayName"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {27}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
 } 
 _boolean_result=false;try {_boolean_result=((Boolean)((((Boolean) getObject("lazycategories:Contains(subcategory:UUID)")).booleanValue() ? Boolean.FALSE : Boolean.TRUE) )).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",29,e);}if (_boolean_result) { 
 _boolean_result=false;try {_boolean_result=((Boolean)((hasLoopElements("subcategory:SubCategories") ? Boolean.TRUE : Boolean.FALSE))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",30,e);}if (_boolean_result) { 
 ...
 {Object temp_obj = (getObject("selectedcategories")); getPipelineDictionary().put("SelectedSubCategoriesList", temp_obj);} 
      out.write(' ');
      out.write('\n');
 } 
      out.write(" \n<ul> \n");
...
new TagParameter("autoselectsubcategories",getObject("autoselectsubcategories"))}, 61); 
      out.write("</ul>");
 } 
 } 
      out.write("</li> \n");
