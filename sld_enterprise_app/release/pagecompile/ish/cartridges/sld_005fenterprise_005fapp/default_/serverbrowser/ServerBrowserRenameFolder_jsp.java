...
public final class ServerBrowserRenameFolder_jsp extends com.intershop.beehive.core.internal.template.AbstractTemplate
...
setEncodingType("text/html"); 
 ...
 insertIntershopSignature(request,(com.intershop.beehive.core.capi.request.ServletResponse)response); 
      out.write("\n        <title>");
 {out.write(localizeISText("ServerBrowserRenameFolder.RenameFolder.title",null,null,null,null,null,null,null,null,null,null,null,null));} 
 ...
 {String value = null;try{value=context.getFormattedValue(getObject("ContextURI"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {23}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
      out.write("\">\n\t                <input type=\"hidden\" name=\"OldName\" value=\"");
 {String value = null;try{value=context.getFormattedValue(getObject("OldName"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {24}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
      out.write("\">\n\t                <label for=\"NewName\">");
 {out.write(localizeISText("ServerBrowserRenameFolder.Name.label",null,null,null,null,null,null,null,null,null,null,null,null));} 
      out.write(":</label>\n\t                <input type=\"text\" id=\"NewName\" name=\"NewName\" size=\"40\" value=\"");
 {String value = null;try{value=context.getFormattedValue(getObject("NewName"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {26}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
 ...
 {out.write(localizeISText("ServerBrowserRenameFolder.AttentionRenamingTheFolderMayResultInInvalidRefere",null,null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("\n\t            </div>\n            </div>\n            <div class=\"bottom_panel\">\n            \t<input type=\"submit\" class=\"button dialog-button\" id=\"submit\" value=\"");
      out.print(context.getFormattedValue(localizeText(context.getFormattedValue("ServerBrowserRenameFolder.Rename.button",null)),null));
      out.write("\"/>\n          \t\t<input type=\"reset\" class=\"button dialog-button secondary-button\" onclick=\"tinyMCEPopup.close();\" value=\"");
      out.print(context.getFormattedValue(localizeText(context.getFormattedValue("ServerBrowserRenameFolder.Cancel.button",null)),null));
      out.write("\">\n            </div>\n        ");
 out.print("</form>"); 
