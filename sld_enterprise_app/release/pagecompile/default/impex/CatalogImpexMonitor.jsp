...
window.setTimeout("self.location='<%=context.getFormattedValue(url(true,(new URLPipelineAction(context.getFormattedValue("ViewCatalogImpex-Monitor",null))),(new URLParameterSet().addURLParameter(context.getFormattedValue("JobConfigurationUUID",null),context.getFormattedValue(getObject("JobConfiguration:UUID"),null)))),null)%>'", 10000)
</script><% } %><!-- Page Navigator --><% processOpenTag(response, pageContext, "impexmessage", new TagParameter[] {
...
new TagParameter("text",getObject("ImpexType"))}, 9); %><!-- EO Page Navigator -->
<!-- Working Area -->
<table border="0" cellpadding="0" cellspacing="0" width="100%">
<tr>
<td><% processOpenTag(response, pageContext, "impexmonitor", new TagParameter[] {
new TagParameter("pipeline","ViewCatalogImpex"),
new TagParameter("jobconfiguration",getObject("JobConfiguration"))}, 15); %></td>
</tr>
</table>
<!-- EO Main Content -->
