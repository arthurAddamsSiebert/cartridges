...
new TagParameter("link",url(true,(new URLPipelineAction(context.getFormattedValue("ViewProductAttributeGroupExport-SelectConfiguration",null))),(new URLParameterSet().addURLParameter(context.getFormattedValue("SelectedObjectUUID",null),context.getFormattedValue(getObject("SelectedObjectUUID"),null))))),
new TagParameter("wizard","true"),
new TagParameter("id","prodAttrGrpExpSlcCfg"),
new TagParameter("text",localizeText(context.getFormattedValue("ProductAttributeGroupExportSelectConfiguration.ProductAttributeGroupExportStep2ConfigureExport.text",null)))}, 3); %><% URLPipelineAction action586 = new URLPipelineAction(context.getFormattedValue(url(true,(new URLPipelineAction(context.getFormattedValue("ViewProductAttributeGroupExport-Dispatch",null)))),null));String site586 = null;String serverGroup586 = null;String actionValue586 = context.getFormattedValue(url(true,(new URLPipelineAction(context.getFormattedValue("ViewProductAttributeGroupExport-Dispatch",null)))),null);if (site586 == null){  site586 = action586.getDomain();  if (site586 == null)  {      site586 = com.intershop.beehive.core.capi.request.Request.getCurrent().getRequestSite().getDomainName();  }}if (serverGroup586 == null){  serverGroup586 = action586.getServerGroup();  if (serverGroup586 == null)  {      serverGroup586 = com.intershop.beehive.core.capi.request.Request.getCurrent().getRequestSite().getServerGroup();  }}out.print("<form");out.print(" method=\"");out.print("post");out.print("\"");out.print(" action=\"");out.print(context.getFormattedValue(url(true,(new URLPipelineAction(context.getFormattedValue("ViewProductAttributeGroupExport-Dispatch",null)))),null));out.print("\"");out.print(" name=\"");out.print("ProductAttributeGroupExportForm");out.print("\"");out.print(">");out.print(context.prepareWACSRFTag(actionValue586, site586, serverGroup586,true)); %> 
...
<tr>
<td width="100%" class="table_title"><% {out.write(localizeISText("ProductAttributeGroupExportSelectConfiguration.ProductAttributeGroupExportStep2ConfigureExport.table_title",null,null,null,null,null,null,null,null,null,null,null,null));} %></td>
</tr>
...
<td class="error top" width="100%"><% {out.write(localizeISText("ProductAttributeGroupExportSelectConfiguration.ExportCouldNotBeExecuted.error",null,null,null,null,null,null,null,null,null,null,null,null));} %></td>
</tr>
...
<tr>
<td class="table_title_description"><% {out.write(localizeISText("ProductAttributeGroupExportSelectConfiguration.FieldsWithARedAsterisk.table_title_description",null,null,"star",null,null,null,null,null,null,null,null,null));} %></td>
</tr>
</table>
...
<td class="label_radio_text w s"><label class="label label_radio_text label_light" for="ExportSearchResult">&nbsp;<% {out.write(localizeISText("ProductAttributeGroupExportSelectConfiguration.ExportAllProductAttributeGroups.label",null,null,null,null,null,null,null,null,null,null,null,null));} %></label></td>
</tr>
<tr>
<td class="input_radio s" width="1%">
<input type="radio" name="ExportSearchResult" id="ExportSelectedProductAttributeGroups" value="false" <% _boolean_result=false;try {_boolean_result=((Boolean)((((Boolean) ((hasLoopElements("UUIDIterator") ? Boolean.TRUE : Boolean.FALSE))).booleanValue() ? Boolean.FALSE : Boolean.TRUE) )).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",52,e);}if (_boolean_result) { %>disabled="disabled"<% } else { %>checked="checked"<% } %>/>
</td>
<td class="label_radio_text w s" nowrap="nowrap"><label class="label label_radio_text label_light" for="ExportSelectedProductAttributeGroups">&nbsp;<% {out.write(localizeISText("ProductAttributeGroupExportSelectConfiguration.ExportSelectedProductAttributeGroups.label",null,null,null,null,null,null,null,null,null,null,null,null));} %></label></td>
</tr>
</table>
</td>
</tr>
...
<tr><% _boolean_result=false;try {_boolean_result=((Boolean)(getObject("ProductAttributeGroupExportForm:isSubmitted"))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",63,e);}if (_boolean_result) { %><% _boolean_result=false;try {_boolean_result=((Boolean)((((((Boolean) getObject("ProductAttributeGroupExportForm:ExportFile:isMissing")).booleanValue() || ((Boolean) getObject("ProductAttributeGroupExportForm:ExportFile:isInvalid")).booleanValue()) ? Boolean.TRUE : Boolean.FALSE)))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",64,e);}if (_boolean_result) { %><td nowrap="nowrap" class="label s"><label class="label label_error" for="ProductAttributeGroupExportForm_ExportFile"><% {out.write(localizeISText("ViewContextExportHeader.ExportFile.fielditem2",null,null,null,null,null,null,null,null,null,null,null,null));} %>:<span class="star">*</span></label></td><% } else { %><td nowrap="nowrap" class="label s"><label class="label" for="ProductAttributeGroupExportForm_ExportFile"><% {out.write(localizeISText("ViewContextExportHeader.ExportFile.fielditem2",null,null,null,null,null,null,null,null,null,null,null,null));} %>:<span class="star">*</span></label></td><% } %><td class="fielditem2 s" width="100%">
<input type="text" name="ProductAttributeGroupExportForm_ExportFile" id="ProductAttributeGroupExportForm_ExportFile" size="40" class="inputfield_en" value="<% {String value = null;try{value=context.getFormattedValue(getObject("ProductAttributeGroupExportForm:ExportFile:Value"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {70}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} %>"/>
</td><% } else { %><td nowrap="nowrap" class="label s"><label class="label" for="ProductAttributeGroupExportForm_ExportFile"><% {out.write(localizeISText("ViewContextExportHeader.ExportFile.fielditem2",null,null,null,null,null,null,null,null,null,null,null,null));} %>:<span class="star">*</span></label></td>
<td class="fielditem2 s" width="100%">
<input type="text" name="ProductAttributeGroupExportForm_ExportFile" id="ProductAttributeGroupExportForm_ExportFile" size="40" class="inputfield_en"/>
</td><% } %></tr>
<tr>
<td colspan="2"><img src="<%=context.getFormattedValue(context.webRoot(),null)%>/images/space.gif" width="1" height="6" alt="" border="0"/></td>
</tr>
