...
<tr>
<td><% {out.flush();processLocalIncludeByServer((com.intershop.beehive.core.capi.request.ServletResponse)response,"product/ProductLinkProductList", null, "25");} %></td>
</tr>
</table>
</td>
</tr> 
...
<td>
<table width="100%" border="0" cellspacing="0" cellpadding="0" id="<% {String value = null;try{value=context.getFormattedValue(getObject("ProductLinkTable_TypeCode"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {35}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} %>_incoming_product_links_table" class="product_links_<% {String value = null;try{value=context.getFormattedValue(getObject("ProductLinkTable_TypeCode"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {35}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} %>_list">
<tr>
<td class="table_title2 w e s"><% {out.write(localizeISText("sld_enterprise_app.IsOf.label1",null,null,encodeString(context.getFormattedValue(getObject("Product:Name"),null)),encodeString(context.getFormattedValue(getObject("ProductLinkTable_Name"),null)),null,null,null,null,null,null,null,null));} %></td>
</tr>
<tr>
<td class="table_title4 w e s"><% {out.write(localizeISText("sld_enterprise_app.0Products.table_title4",null,null,context.getFormattedValue(getObject("ProductIncomingLinksCount"),null),null,null,null,null,null,null,null,null,null));} %></td>
</tr>
<tr>
<td><% {out.flush();processLocalIncludeByServer((com.intershop.beehive.core.capi.request.ServletResponse)response,"product/IncomingProductLinkProductList", null, "46");} %></td>
</tr>
</table>
</td>
</tr><% } %></table>
