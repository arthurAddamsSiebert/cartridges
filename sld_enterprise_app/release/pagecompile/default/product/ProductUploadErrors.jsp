...
new TagParameter("message",localizeText(context.getFormattedValue("sld_enterprise_app.TheSizeOfTheSelectedFileExceedsTheAllowedFileUploa.message",null)))}, 2); %>
...
new TagParameter("subject","file"),
new TagParameter("type","nse"),
new TagParameter("message",localizeText(context.getFormattedValue("sld_enterprise_app.TheSelectedFileCouldNotBeUploadedThisMayBeCausedBy.message",null)))}, 4); %>
...
new TagParameter("subject","file"),
new TagParameter("type","nse"),
new TagParameter("message",localizeText(context.getFormattedValue("sld_enterprise_app.TheSelectedFileCouldNotBeUploadedBecauseTheFileLen.message",null)))}, 6); %>
...
new TagParameter("subject","file"),
new TagParameter("type","nse"),
new TagParameter("message",localizeText(context.getFormattedValue("sld_enterprise_app.YouHaveNotSelectedAFileToUploadU003cbrU003eSelectA.message",null)))}, 8); %>
<% }}}} %><% printFooter(out); %>