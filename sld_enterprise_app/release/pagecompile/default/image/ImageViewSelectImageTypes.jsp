...
new TagParameter("text",localizeText(context.getFormattedValue("ImageViewSelectImageTypes.AssignImageTypes.text",null)))}, 4); %><!-- Working Area --><% URLPipelineAction action153 = new URLPipelineAction(context.getFormattedValue(url(true,(new URLPipelineAction(context.getFormattedValue("ViewImageView-Dispatch",null)))),null));String site153 = null;String serverGroup153 = null;String actionValue153 = context.getFormattedValue(url(true,(new URLPipelineAction(context.getFormattedValue("ViewImageView-Dispatch",null)))),null);if (site153 == null){  site153 = action153.getDomain();  if (site153 == null)  {      site153 = com.intershop.beehive.core.capi.request.Request.getCurrent().getRequestSite().getDomainName();  }}if (serverGroup153 == null){  serverGroup153 = action153.getServerGroup();  if (serverGroup153 == null)  {      serverGroup153 = com.intershop.beehive.core.capi.request.Request.getCurrent().getRequestSite().getServerGroup();  }}out.print("<form");out.print(" method=\"");out.print("post");out.print("\"");out.print(" action=\"");out.print(context.getFormattedValue(url(true,(new URLPipelineAction(context.getFormattedValue("ViewImageView-Dispatch",null)))),null));out.print("\"");out.print(" name=\"");out.print("ImageTypeSelectListForm");out.print("\"");out.print(">");out.print(context.prepareWACSRFTag(actionValue153, site153, serverGroup153,true)); %><input type="hidden" name="ImageViewID" value="<%=context.getFormattedValue(stringToHtml(context.getFormattedValue(getObject("ImageView:ID"),null)),null)%>" />
<table border="0" cellpadding="0" cellspacing="0" width="100%" class="w e s">
<tr>
<td width="100%" class="table_title n s"><% {String value = null;try{value=context.getFormattedValue(getObject("ImageView:Name"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {11}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} %> - <% {out.write(localizeISText("ImageViewSelectImageTypes.AssignImageTypes.table_title",null,null,null,null,null,null,null,null,null,null,null,null));} %></td>
...
<td class="error top" width="100%"><% {out.write(localizeISText("ImageViewSelectImageTypes.YouHaveNotSelectedAnyImageTypes.error",null,null,null,null,null,null,null,null,null,null,null,null));} %></td>
</tr>
</table>
</td>
</tr><% } %><tr>
<td class="table_title_description"><% {out.write(localizeISText("ImageViewSelectImageTypes.TheListShowsAllImageTypes.table_title_description",null,null,null,null,null,null,null,null,null,null,null,null));} %></td>
</tr>
...
<tr>
<td nowrap="nowrap">
<a href="javascript:selectAll('ImageTypeSelectListForm','SelectedObjectUUID','A','B');" class="tableheader"><% {out.write(localizeISText("PageletLabels.SelectAll.link",null,null,null,null,null,null,null,null,null,null,null,null));} %></a>
</td>
</tr>
</table>
</div>
...
<tr>
<td nowrap="nowrap">
<a href="javascript:selectAll('ImageTypeSelectListForm','SelectedObjectUUID','A','B');" class="tableheader"><% {out.write(localizeISText("NewProductSetChannelAssignment.ClearAll.link",null,null,null,null,null,null,null,null,null,null,null,null));} %></a>
</td>
</tr>
</table>
</div>
</td>
<td class="table_header e s"><% {out.write(localizeISText("ChannelColumns.Name",null,null,null,null,null,null,null,null,null,null,null,null));} %></td>
<td class="table_header e s"><% {out.write(localizeISText("ChannelColumns.ID",null,null,null,null,null,null,null,null,null,null,null,null));} %></td>
<td class="table_header e s"><% {out.write(localizeISText("SynchronizationOverview.Source.table_header",null,null,null,null,null,null,null,null,null,null,null,null));} %></td>
<td class="table_header e s"><% {out.write(localizeISText("ImageViewDetails.Prefix.table_header",null,null,null,null,null,null,null,null,null,null,null,null));} %></td>
<td class="table_header e s"><% {out.write(localizeISText("ImageSetSelectImageTypes.Width.link",null,null,null,null,null,null,null,null,null,null,null,null));} %></td>
<td class="table_header s"><% {out.write(localizeISText("ImageSetSelectImageTypes.Height.link",null,null,null,null,null,null,null,null,null,null,null,null));} %></td>
...
<tr>
<td class="button"><input type="submit" name="assign" value="<%=context.getFormattedValue(localizeText(context.getFormattedValue("SelectCategory.OK.button",null)),null)%>" class="button"/></td>
<td class="button"><input type="submit" name="cancelAssign" value="<%=context.getFormattedValue(localizeText(context.getFormattedValue("PageletEntryPointSetParent.Cancel.button",null)),null)%>" class="button"/></td>
</tr>
</table>
</td>
</tr>
...
<tr><td class="table_detail" ><% {out.write(localizeISText("CustomParameterImageType.CurrentlyThereAreNoImageTypesDefined",null,null,null,null,null,null,null,null,null,null,null,null));} %></tr>
