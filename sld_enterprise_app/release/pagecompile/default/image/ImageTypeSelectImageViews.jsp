...
new TagParameter("link",url(true,(new URLPipelineAction(context.getFormattedValue("ViewImageType-SelectImageViews",null))),(new URLParameterSet().addURLParameter(context.getFormattedValue("ImageTypeUUID",null),context.getFormattedValue(getObject("ImageType:UUID"),null))))),
new TagParameter("text",localizeText(context.getFormattedValue("ImageTypeSelectImageViews.AssignImageViews.text",null)))}, 4); %><!-- Working Area --><% URLPipelineAction action167 = new URLPipelineAction(context.getFormattedValue(url(true,(new URLPipelineAction(context.getFormattedValue("ViewImageType-Dispatch",null)))),null));String site167 = null;String serverGroup167 = null;String actionValue167 = context.getFormattedValue(url(true,(new URLPipelineAction(context.getFormattedValue("ViewImageType-Dispatch",null)))),null);if (site167 == null){  site167 = action167.getDomain();  if (site167 == null)  {      site167 = com.intershop.beehive.core.capi.request.Request.getCurrent().getRequestSite().getDomainName();  }}if (serverGroup167 == null){  serverGroup167 = action167.getServerGroup();  if (serverGroup167 == null)  {      serverGroup167 = com.intershop.beehive.core.capi.request.Request.getCurrent().getRequestSite().getServerGroup();  }}out.print("<form");out.print(" method=\"");out.print("post");out.print("\"");out.print(" action=\"");out.print(context.getFormattedValue(url(true,(new URLPipelineAction(context.getFormattedValue("ViewImageType-Dispatch",null)))),null));out.print("\"");out.print(" name=\"");out.print("ImageViewSelectListForm");out.print("\"");out.print(">");out.print(context.prepareWACSRFTag(actionValue167, site167, serverGroup167,true)); %><input type="hidden" name="ImageTypeID" value="<%=context.getFormattedValue(stringToHtml(context.getFormattedValue(getObject("ImageType:ID"),null)),null)%>"/>
<table border="0" cellpadding="0" cellspacing="0" width="100%" class="n e s w">
<tr>
<td width="100%" class="table_title s"><% {String value = null;try{value=context.getFormattedValue(getObject("ImageType:Name"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {11}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} %> - <% {out.write(localizeISText("ImageTypeSelectImageViews.AssignImageViews.table_title",null,null,null,null,null,null,null,null,null,null,null,null));} %></td>
...
<td class="error top" width="100%"><% {out.write(localizeISText("ImageTypeSelectImageViews.YouHaveNotSelectedAnyImageViews.error",null,null,null,null,null,null,null,null,null,null,null,null));} %></td>
</tr>
</table>
</td>
</tr><% } %><tr>
<td class="table_title_description"><% {out.write(localizeISText("ImageTypeSelectImageViews.TheListShowsAllImageViewsOfThisOrganization.table_title_description",null,null,null,null,null,null,null,null,null,null,null,null));} %></td>
</tr>
...
<tr>
<td nowrap="nowrap">
<a href="javascript:selectAll('ImageViewSelectListForm','SelectedObjectUUID','A','B');" class="tableheader"><% {out.write(localizeISText("PageletLabels.SelectAll.link",null,null,null,null,null,null,null,null,null,null,null,null));} %></a>
</td>
</tr>
</table>
</div>
...
<tr>
<td nowrap="nowrap">
<a href="javascript:selectAll('ImageViewSelectListForm','SelectedObjectUUID','A','B');" class="tableheader"><% {out.write(localizeISText("NewProductSetChannelAssignment.ClearAll.link",null,null,null,null,null,null,null,null,null,null,null,null));} %></a>
</td>
</tr>
</table>
</div>
...
<td class="table_header s"><% {out.write(localizeISText("ChannelColumns.ID",null,null,null,null,null,null,null,null,null,null,null,null));} %></td>
...
<tr><td class="table_detail" ><% {out.write(localizeISText("CustomParameterImageView.CurrentlyThereAreNoImageViewsDefined",null,null,null,null,null,null,null,null,null,null,null,null));} %></tr>
</table><% } %> 
