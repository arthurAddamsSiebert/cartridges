...
new TagParameter("displayname","marketing.recommendationdatafeeds.title"),
new TagParameter("description","marketing.recommendationdatafeeds.description"),
new TagParameter("linkurl",url(true,(new URLPipelineAction(context.getFormattedValue("ViewProductRecommDataFeedList-Start",null)))))}, 3); %><% } %><% printFooter(out); %>