...
new TagParameter("displayname","massdatatasks.promotioncode.title"),
new TagParameter("description","massdatatasks.promotioncode.description.channel"),
new TagParameter("linkurl",url(true,(new URLPipelineAction(context.getFormattedValue("ViewPromotionCodeImpex-Status",null)))))}, 3); %><% } %> <% printFooter(out); %>