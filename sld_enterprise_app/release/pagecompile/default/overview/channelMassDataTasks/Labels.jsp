...
new TagParameter("displayname","massdatatasks.labels.title"),
new TagParameter("description","massdatatasks.labels.description"),
new TagParameter("linkurl",url(true,(new URLPipelineAction(context.getFormattedValue("ViewChannelLabel-List",null)))))}, 3); %><% } %> <% printFooter(out); %>