...
new TagParameter("displayname","content.components.title"),
new TagParameter("description","content.components.description"),
new TagParameter("linkurl",url(true,(new URLPipelineAction(context.getFormattedValue("ViewChannelPageComponents-View",null)))))}, 3); %><% } %> 
<% printFooter(out); %>