...
new TagParameter("displayname","content.pagevariants.title"),
new TagParameter("description","content.pagevariants.description"),
new TagParameter("linkurl",url(true,(new URLPipelineAction(context.getFormattedValue("ViewChannelPages-ViewSearch",null)))))}, 3); %><% } %> 
<% printFooter(out); %>