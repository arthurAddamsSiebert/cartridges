...
new TagParameter("displayname","content.contentupload.title"),
new TagParameter("description","content.contentupload.description"),
new TagParameter("linkurl",url(true,(new URLPipelineAction(context.getFormattedValue("ViewContentUpload-BrowseDirectory",null)))))}, 3); %><% } %> 
<% printFooter(out); %>