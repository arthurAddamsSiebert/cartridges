...
new TagParameter("displayname","content.contentsharing.title"),
new TagParameter("description","content.contentsharing.description"),
new TagParameter("linkurl",url(true,(new URLPipelineAction(context.getFormattedValue("ViewContentSharingList_52-ListSources",null)))))}, 3); %><% } %> 
<% printFooter(out); %>