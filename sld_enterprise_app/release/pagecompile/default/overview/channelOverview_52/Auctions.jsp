...
new TagParameter("displayname","overview.auctions.title"),
new TagParameter("description","overview.auctions.description"),
new TagParameter("linkurl",url(true,(new URLPipelineAction(context.getFormattedValue("ViewAuctions_52-DispatchList",null))),(new URLParameterSet().addURLParameter(context.getFormattedValue("ChannelID",null),context.getFormattedValue(getObject("CurrentChannel:UUID"),null)))))}, 2); %>
<% } %>
<% printFooter(out); %>