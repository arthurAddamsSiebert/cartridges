...
new TagParameter("displayname","overview.localization.title"),
new TagParameter("description","overview.localization.description"),
new TagParameter("linkurl",url(true,(new URLPipelineAction(context.getFormattedValue("ViewLocalizations_52-Start",null))),(new URLParameterSet().addURLParameter(context.getFormattedValue("ChannelID",null),context.getFormattedValue(getObject("CurrentChannel:UUID"),null)))))}, 3); %>
<% } %>
<% printFooter(out); %>