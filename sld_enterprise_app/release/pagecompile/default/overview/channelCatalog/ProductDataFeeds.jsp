...
new TagParameter("displayname","catalogs.productdatafeeds.title"),
new TagParameter("description","catalogs.productdatafeeds.description"),
new TagParameter("linkurl",url(true,(new URLPipelineAction(context.getFormattedValue("ViewChannelOutboundSyndicationList-Start",null)))))}, 3); %><% } %> 
<% printFooter(out); %>