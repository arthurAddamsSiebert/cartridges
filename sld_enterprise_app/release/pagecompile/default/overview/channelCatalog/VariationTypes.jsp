...
new TagParameter("displayname","catalogs.variationtypes.title"),
new TagParameter("description","catalogs.variationtypes.description"),
new TagParameter("linkurl",url(true,(new URLPipelineAction(context.getFormattedValue("ViewVariationTypeList_52-ListAll",null))),(new URLParameterSet().addURLParameter(context.getFormattedValue("ChannelID",null),context.getFormattedValue(getObject("CurrentChannel:UUID"),null)))))}, 3); %><% } %> 
<% printFooter(out); %>