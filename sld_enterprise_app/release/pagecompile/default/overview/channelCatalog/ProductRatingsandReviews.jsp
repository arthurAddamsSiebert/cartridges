...
new TagParameter("displayname","catalogs.productratings.title"),
new TagParameter("description","catalogs.productratings.description"),
new TagParameter("linkurl",url(true,(new URLPipelineAction(context.getFormattedValue("ViewChannelReviewList-ShowAll",null))),(new URLParameterSet().addURLParameter(context.getFormattedValue("ChannelID",null),context.getFormattedValue(getObject("CurrentChannel:UUID"),null)))))}, 3); %><% } %> 
<% printFooter(out); %>