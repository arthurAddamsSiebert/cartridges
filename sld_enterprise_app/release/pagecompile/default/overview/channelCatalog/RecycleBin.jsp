...
new TagParameter("displayname","catalogs.recyclebin.title"),
new TagParameter("description","catalogs.recyclebin.description"),
new TagParameter("linkurl",url(true,(new URLPipelineAction(context.getFormattedValue("ViewProductRecycleBin_52-Search",null))),(new URLParameterSet().addURLParameter(context.getFormattedValue("ChannelID",null),context.getFormattedValue(getObject("CurrentChannel:UUID"),null)))))}, 3); %><% } %> 
<% printFooter(out); %>