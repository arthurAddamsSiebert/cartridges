...
printHeader(out);
 %><% %><%@ page contentType="text/html;charset=utf-8" %><%setEncodingType("text/html"); %><%@page import="com.intershop.beehive.xcs.capi.price.PriceTypeRegistry,
...
getPipelineDictionary().put("PriceTypeRegistry", ptr);%><% printFooter(out); %>