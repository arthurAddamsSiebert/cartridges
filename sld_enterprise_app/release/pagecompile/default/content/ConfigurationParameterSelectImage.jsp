...
new TagParameter("text",localizeText(context.getFormattedValue("ConfigurationParameterSelectImage.SelectImage.text",null)))}, 6); %><!-- EO Page Navigator -->
<table width="100%" border="0" cellspacing="0" cellpadding="0">
<tr>
<td class="table_title aldi" width="100%" nowrap="nowrap"><% {out.write(localizeISText("ConfigurationParameterSelectImage.SelectImage.table_title",null,null,null,null,null,null,null,null,null,null,null,null));} %></td>
...
<td class="table_title_description w e s" width="100%"><% {out.write(localizeISText("ConfigurationParameterSelectImage.ClickTheDirectoryNameToBrowseTheSubDirectories.table_title_description",null,null,null,null,null,null,null,null,null,null,null,null));} %></td>
</tr>
</table>
...
<input type="submit" name="SetImage" value="<%=context.getFormattedValue(localizeText(context.getFormattedValue("ConfigurationParameterSelectImage.OK.button",null)),null)%>" class="button"/>
</td><% } %><td class="button">
<input type="submit" name="BackFromImageSelection" value="<%=context.getFormattedValue(localizeText(context.getFormattedValue("ConfigurationParameterSelectImage.Cancel.button",null)),null)%>" class="button"/>
</td>
</tr>
</table>
</td>
...
<tr><td class="table_detail s"><% {out.write(localizeISText("ConfigurationParameterSelectImage.ThereAreNoImagesToShowHere.table_detail",null,null,null,null,null,null,null,null,null,null,null,null));} %></td></tr>
<tr>
<td align="right" colspan="3" class="s">
<table border="0" cellspacing="4" cellpadding="0">
<tr>
...
new TagParameter("parametername","DirectoryPath")}, 106); %></tr>
</table><% } %> 
<% printFooter(out); %>