...
<tr>
<td class="button">
<input type="submit" name="previous" value="&lt;&lt;&nbsp;<%=context.getFormattedValue(localizeText(context.getFormattedValue("ContentIncludeSelectComponentAssignmentButtons.Previous.button",null)),null)%>" class="button"/>
</td>
</tr>
</table>
</td>
...
<input type="submit" name="SelectVisibility" value="<%=context.getFormattedValue(localizeText(context.getFormattedValue("ContentIncludeSelectComponentAssignmentButtons.Next.button",null)),null)%>&nbsp;&gt;&gt;" class="button"/>
</td><% } %><td class="button">
<input type="submit" name="Cancel" value="<%=context.getFormattedValue(localizeText(context.getFormattedValue("ContentIncludeSelectComponentAssignmentButtons.Cancel.button",null)),null)%>" class="button"/>
</td>
</tr>
</table>
</td>
