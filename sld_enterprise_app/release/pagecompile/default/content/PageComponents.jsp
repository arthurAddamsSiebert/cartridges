...
new TagParameter("text",localizeText(context.getFormattedValue("PageComponents.MasterContent.text",null)))}, 7); %><% processOpenTag(response, pageContext, "breadcrumbtrail", new TagParameter[] {
new TagParameter("listview","true"),
new TagParameter("link",url(true,(new URLPipelineAction(context.getFormattedValue("ViewPageletSearch-BackToList",null))),(new URLParameterSet().addURLParameter(context.getFormattedValue("UniquePageletSearchID",null),context.getFormattedValue("PageComponents",null))).addURLParameter(context.getFormattedValue("SearchType",null),context.getFormattedValue(getObject("SearchType"),null)).addURLParameter(context.getFormattedValue("SelectedMenuItem",null),context.getFormattedValue(getObject("SelectedMenuItem"),null)))),
new TagParameter("id","CompSearchContainer"),
new TagParameter("text",localizeText(context.getFormattedValue("PageComponents.MasterComponents.text",null)))}, 8); %><!-- EO Page Navigator --><% processOpenTag(response, pageContext, "pageletsearch", new TagParameter[] {
...
new TagParameter("targetpageletviewpipeline","ViewPageComponents-Dispatch"),
new TagParameter("notfoundtemplate","content/search/inc/EmptyPageletSearchResult"),
new TagParameter("uniqueid","PageComponents")}, 11); %><% printFooter(out); %>