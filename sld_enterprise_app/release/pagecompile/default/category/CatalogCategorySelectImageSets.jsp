...
new TagParameter("text",localizeText(context.getFormattedValue("CatalogCategorySelectImageSets.AddImageSets.text",null)))}, 4); %><!-- Working Area --><% URLPipelineAction action277 = new URLPipelineAction(context.getFormattedValue(url(true,(new URLPipelineAction(context.getFormattedValue("ViewCategoryImageSetDefinitions-Dispatch",null)))),null));String site277 = null;String serverGroup277 = null;String actionValue277 = context.getFormattedValue(url(true,(new URLPipelineAction(context.getFormattedValue("ViewCategoryImageSetDefinitions-Dispatch",null)))),null);if (site277 == null){  site277 = action277.getDomain();  if (site277 == null)  {      site277 = com.intershop.beehive.core.capi.request.Request.getCurrent().getRequestSite().getDomainName();  }}if (serverGroup277 == null){  serverGroup277 = action277.getServerGroup();  if (serverGroup277 == null)  {      serverGroup277 = com.intershop.beehive.core.capi.request.Request.getCurrent().getRequestSite().getServerGroup();  }}out.print("<form");out.print(" method=\"");out.print("post");out.print("\"");out.print(" action=\"");out.print(context.getFormattedValue(url(true,(new URLPipelineAction(context.getFormattedValue("ViewCategoryImageSetDefinitions-Dispatch",null)))),null));out.print("\"");out.print(" name=\"");out.print("ImageSetListForm");out.print("\"");out.print(">");out.print(context.prepareWACSRFTag(actionValue277, site277, serverGroup277,true)); %><input type="hidden" name="CatalogCategoryID" value="<% {String value = null;try{value=context.getFormattedValue(getObject("Category:UUID"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {10}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} %>" />
...
<tr>
<td width="100%" class="table_title s"><% {String value = null;try{value=context.getFormattedValue(getObject("Category:DisplayName"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {14}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} %> - <% {out.write(localizeISText("CatalogCategorySelectImageSets.AssignImageSets.table_title",null,null,null,null,null,null,null,null,null,null,null,null));} %></td>
...
border="0" /></td>
<td class="error top" width="100%"><% {out.write(localizeISText("CatalogCategorySelectImageSets.YouHaveNotSelectedAnyImageSetsSelectAtLeastOneImag.error",null,null,null,null,null,null,null,null,null,null,null,null));} %></td>
</tr>
</table>
</td>
</tr><% } %><tr>
<td class="table_title_description"><% {out.write(localizeISText("CatalogCategorySelectImageSets.TheListShowsAllImageSetsOfThisOrganizationUseTheCh.table_title_description",null,null,null,null,null,null,null,null,null,null,null,null));} %></td>
</tr>
...
class="tableheader"><% {out.write(localizeISText("CatalogCategorySelectImageSets.SelectAll.link",null,null,null,null,null,null,null,null,null,null,null,null));} %></a></td>
</tr>
</table>
</div>
...
<td nowrap="nowrap"><a
href="javascript:selectAll('ImageSetListForm','SelectedImageSetID','A','B');"
class="tableheader"><% {out.write(localizeISText("CatalogCategorySelectImageSets.ClearAll.link",null,null,null,null,null,null,null,null,null,null,null,null));} %></a></td>
</tr>
</table>
</div>
</td>
...
class="tableheader"><% {out.write(localizeISText("CatalogCategorySelectImageSets.Name.link1",null,null,null,null,null,null,null,null,null,null,null,null));} %></a><% } %></td>
...
class="tableheader"><% {out.write(localizeISText("CatalogCategorySelectImageSets.ID.link",null,null,null,null,null,null,null,null,null,null,null,null));} %></a><% } else { %><a
...
class="tableheader"><% {out.write(localizeISText("CatalogCategorySelectImageSets.ID.link1",null,null,null,null,null,null,null,null,null,null,null,null));} %></a><% } %></td>
...
class="w e s">
<tr>
<td class="table_detail"><% {out.write(localizeISText("CatalogCategorySelectImageSets.CurrentlyThereAreNoImageSetsDefined.table_detail",null,null,null,null,null,null,null,null,null,null,null,null));} %></tr>
...
<tr>
<td class="button">
<input type="submit" name="assignImageSets" value="<%=context.getFormattedValue(localizeText(context.getFormattedValue("CatalogCategorySelectImageSets.OK.button",null)),null)%>" class="button"
...
<td class="button">
<input type="submit" name="cancel" value="<%=context.getFormattedValue(localizeText(context.getFormattedValue("CatalogCategorySelectImageSets.Cancel.button",null)),null)%>" class="button" />
</td>
</tr>
</table>
</td>
