...
public final class StateProvinceSearch_005f52_jsp extends com.intershop.beehive.core.internal.template.AbstractTemplate
...
new TagParameter("mapname","CountriesParams")}, 27); 
 ...
 {out.write(localizeISText("StateProvinceSearch_52.State.fielditem2_error",null,null,null,null,null,null,null,null,null,null,null,null));} 
      out.write(":&nbsp;</td>\n\t\t\t\t\t");
 } else { 
      out.write("\n\t\t\t\t\t\t<td class=\"infobox_item\" nowrap=\"nowrap\">");
 {out.write(localizeISText("StateProvinceSearch_52.State.infobox_item",null,null,null,null,null,null,null,null,null,null,null,null));} 
      out.write(":&nbsp;</td>\n\t\t\t\t\t");
 } 
 ...
 _boolean_result=false;try {_boolean_result=((Boolean)(getObject("StateProvinceSearchForm:CountryID:Invalid"))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",58,e);}if (_boolean_result) { 
      out.write("\n\t\t\t\t\t\t<td class=\"fielditem2_error\" nowrap=\"nowrap\">");
 {out.write(localizeISText("StateProvinceSearch_52.Country.fielditem2_error",null,null,null,null,null,null,null,null,null,null,null,null));} 
      out.write(":<span class=\"star\">*</span>&nbsp;</td>\n\t\t\t\t\t");
 } else { 
      out.write("\n\t\t\t\t\t\t<td class=\"infobox_item\" nowrap=\"nowrap\">");
 {out.write(localizeISText("StateProvinceSearch_52.Country.infobox_item",null,null,null,null,null,null,null,null,null,null,null,null));} 
      out.write(":<span class=\"star\">*</span>&nbsp;</td>\n\t\t\t\t\t");
 } 
      out.write("\n\t\t\t\t\t<td>\n\t\t\t\t\t\t<select name=\"StateProvinceSearchForm_CountryID\" class=\"dropdown inputfield_en\" >\n\t\t\t\t\t\t\t<option value=\"\" >---");
 {out.write(localizeISText("StateProvinceSearch_52.SelectCountry.option",null,null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("---</option>\n\t\t\t\t\t\t\t");
 ...
 while (loop("CountriesDic:AllCountries","Country",null)) { 
      out.write("\n\t\t\t\t\t\t\t\t\t<option value=\"");
 {String value = null;try{value=context.getFormattedValue(getObject("Country:Id"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {68}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
      out.write('"');
 _boolean_result=false;try {_boolean_result=((Boolean)(((((Boolean) (((((Boolean) (disableErrorMessages().isDefined(getObject("StateProvinceSearchForm:CountryID:Value")))).booleanValue() && ((Boolean) ((((context.getFormattedValue(getObject("StateProvinceSearchForm:CountryID:Value"),null).equals(context.getFormattedValue(getObject("Country:Id"),null)))) ? Boolean.TRUE : Boolean.FALSE))).booleanValue()) ? Boolean.TRUE : Boolean.FALSE))).booleanValue() || ((Boolean) (((((Boolean) (disableErrorMessages().isDefined(getObject("StateProvinceSearchForm_CountryID")))).booleanValue() && ((Boolean) ((((context.getFormattedValue(getObject("StateProvinceSearchForm_CountryID"),null).equals(context.getFormattedValue(getObject("Country:Id"),null)))) ? Boolean.TRUE : Boolean.FALSE))).booleanValue()) ? Boolean.TRUE : Boolean.FALSE))).booleanValue()) ? Boolean.TRUE : Boolean.FALSE))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",68,e);}if (_boolean_result) { 
      out.write(" selected=\"selected\" ");
 } 
      out.write(' ');
      out.write('>');
 {String value = null;try{value=context.getFormattedValue(getObject("Country:DisplayName"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {68}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
      out.write(' ');
      out.write('(');
 {String value = null;try{value=context.getFormattedValue(getObject("Country:Id"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {68}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
      out.write(")</option>\n\t\t\t\t\t\t\t\t");
      ...
      out.print(context.getFormattedValue(localizeText(context.getFormattedValue("StateProvinceSearch_52.Find.button",null)),null));
 ...
 {out.write(localizeISText("StateProvinceSearch_52.ExpandField.link",null,null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("</a>\n\t\t\t\t\t</td>\n\t\t\t\t</tr>\n\t\t\t</table>\n\t\t</td>\n\t</tr>\n</table>");
 printFooter(out); 
