...
public final class PriceListCustomerSegmentsSelectionColumns_jsp extends com.intershop.beehive.core.internal.template.AbstractTemplate
...
setEncodingType("text/javascript"); 
 ...
 _boolean_result=false;try {_boolean_result=((Boolean)((disableErrorMessages().isDefined(getObject("params:UserPermissionForEdit"))))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",4,e);}if (_boolean_result) { 
      ...
      out.write("\n{\nid: 'name',\ntype: 'text',\ndataKey: 'name',\ntitle: '");
 {out.write(localizeISText("PriceListCustomerSegmentsSelectionColumns.Name",null,null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("',\nwidth: 250,\nmaxWidth: 250,\nsortable: false\n");
 _boolean_result=false;try {_boolean_result=((Boolean)((disableErrorMessages().isDefined(getObject("params:RenderLink"))))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",21,e);}if (_boolean_result) { 
      ...
      out.write("\n}, {\nid: 'id',\ntype: 'text',\ndataKey: 'ID',\ntitle: '");
 {out.write(localizeISText("PriceListCustomerSegmentsSelectionColumns.ID",null,null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("',\nwidth: 150,\nmaxWidth: 150,\nsortable: false\n}, {\nid: 'description',\ntype: 'text',\ndataKey: 'description',\ntitle: '");
 {out.write(localizeISText("PriceListCustomerSegmentsSelectionColumns.Description",null,null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("',\nwidth: 1100,\nmaxWidth: 1100,\nsortable: false\n}]\n");
 printFooter(out); 
