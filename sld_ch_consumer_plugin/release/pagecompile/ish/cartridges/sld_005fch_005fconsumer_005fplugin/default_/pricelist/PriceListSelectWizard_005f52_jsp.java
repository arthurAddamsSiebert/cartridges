...
public final class PriceListSelectWizard_005f52_jsp extends com.intershop.beehive.core.internal.template.AbstractTemplate
...
setEncodingType("text/html"); 
 ...
 {Object temp_obj = ("Price List"); getPipelineDictionary().put("SelectedTab", temp_obj);} 
...
new TagParameter("text",localizeText(context.getFormattedValue("PriceListSelectWizard_52.SelectPriceLists.text",null)))}, 13); 
 URLPipelineAction action377 = new URLPipelineAction(context.getFormattedValue(url(true,(new URLPipelineAction(context.getFormattedValue("ViewPriceListSelectWizard-Dispatch",null)))),null));String site377 = null;String serverGroup377 = null;String actionValue377 = context.getFormattedValue(url(true,(new URLPipelineAction(context.getFormattedValue("ViewPriceListSelectWizard-Dispatch",null)))),null);if (site377 == null){  site377 = action377.getDomain();  if (site377 == null)  {      site377 = com.intershop.beehive.core.capi.request.Request.getCurrent().getRequestSite().getDomainName();  }}if (serverGroup377 == null){  serverGroup377 = action377.getServerGroup();  if (serverGroup377 == null)  {      serverGroup377 = com.intershop.beehive.core.capi.request.Request.getCurrent().getRequestSite().getServerGroup();  }}out.print("<form");out.print(" method=\"");out.print("post");out.print("\"");out.print(" action=\"");out.print(context.getFormattedValue(url(true,(new URLPipelineAction(context.getFormattedValue("ViewPriceListSelectWizard-Dispatch",null)))),null));out.print("\"");out.print(" name=\"");out.print("PriceListsList");out.print("\"");out.print(">");out.print(context.prepareWACSRFTag(actionValue377, site377, serverGroup377,true)); 
 ...
 {out.write(localizeISText("PriceListSelectWizard_52.SelectPriceLists.table_title",null,null,null,null,null,null,null,null,null,null,null,null));} 
 ...
 {out.write(localizeISText("PriceListSelectWizard_52.YouHaveNotSelectedAnyItemsUseTheCheckbox.error",null,null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("</td>\n</tr>\n</table>\n</td>\n</tr>");
 } 
      out.write(" \n<tr>\n<td class=\"table_title_description w e s\">");
 {out.write(localizeISText("PriceListSelectWizard_52.TheListShowsAllPriceListsInThisChannel.table_title_description",null,null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("</td>\n</tr>\n</table>\n<table border=\"0\" cellpadding=\"0\" cellspacing=\"0\" width=\"100%\" class=\"w\">");
 _boolean_result=false;try {_boolean_result=((Boolean)((hasLoopElements("PriceLists") ? Boolean.TRUE : Boolean.FALSE))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",46,e);}if (_boolean_result) { 
...
new TagParameter("mapname","params")}, 47); 
...
new TagParameter("params",getObject("params"))}, 58); 
      ...
      out.print(context.getFormattedValue(localizeText(context.getFormattedValue("PriceListSelectWizard_52.OK.button",null)),null));
      out.write("\" class=\"button\" /></td>\n<td class=\"button\"><input type=\"submit\" name=\"cancelAssign\" value=\"");
      out.print(context.getFormattedValue(localizeText(context.getFormattedValue("PriceListSelectWizard_52.Cancel.button",null)),null));
      out.write("\" class=\"button\" /></td>\n</tr>\n</table>\n</td>\n</tr> \n");
 } else { 
      out.write("<tr>\n<td class=\"table_detail e s\">");
 {out.write(localizeISText("PriceListSelectWizard_52.ThereAreCurrentlyNoPriceListsToShowHere.table_detail",null,null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("</td>\n</tr>");
 } 
      out.write("</table>");
 out.print("</form>"); 
 {out.flush();processLocalIncludeByServer((com.intershop.beehive.core.capi.request.ServletResponse)response,"inc/BackToList", null, "83");} 
 printFooter(out); 
