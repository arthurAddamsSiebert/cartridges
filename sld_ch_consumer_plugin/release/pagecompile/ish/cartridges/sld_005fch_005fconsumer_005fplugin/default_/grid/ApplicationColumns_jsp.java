...
public final class ApplicationColumns_jsp extends com.intershop.beehive.core.internal.template.AbstractTemplate
...
setEncodingType("text/javascript"); 
 ...
 {String value = null;try{value=context.getFormattedValue(getObject("params:AvailableItemsName"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {19}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
      ...
      out.write("\nname: {\ntype: 'text',\ndataKey: 'name',\ntitle: '");
 {out.write(localizeISText("ApplicationColumns.Name",null,null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("',\nsortable: true\n},\ntypecode: {\ntype: 'text',\ndataKey: 'typeCode',\ntitle: '");
 {out.write(localizeISText("ApplicationColumns.Type",null,null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("',\nsortable: true\n},\nurlidentifier: {\ntype: 'text',\ndataKey: 'urlIdentifier',\ntitle: '");
 {out.write(localizeISText("ApplicationColumns.URLIdentifier",null,null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("',\nsortable: false\n},\ndescription: {\ntype: 'text',\ndataKey: 'description',\ntitle: '");
 {out.write(localizeISText("ApplicationColumns.Description",null,null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("',\nsortable: false\n},\nenabled: {\ntype: 'status',\ndataKey: 'enabled',\ntitle: '");
 {out.write(localizeISText("Enabled",null,null,null,null,null,null,null,null,null,null,null,null));} 
 ...
 {out.write(localizeISText("Enabled",null,null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("\" border=\"0\" />&nbsp;');\n}\nreturn result.join('');\n}\n}\n},\nnames = [");
 {String value = null;try{value=context.getFormattedValue(getObject("columns"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {64}",e);}if (value==null) value="";out.write(value);} 
