...
public final class ChannelMassDataOverview_005f52_jsp extends com.intershop.beehive.core.internal.template.AbstractTemplate
...
new TagParameter("text",localizeText(context.getFormattedValue("massdatatasks.title",null)))}, 8); 
      out.write("<div class=\"overviewWrapper\">\n<div class=\"overview_title\">");
 processOpenTag(response, pageContext, "apptext", new TagParameter[] {
new TagParameter("key","massdatatasks.title")}, 10); 
...
new TagParameter("key","massdatatasks.description")}, 11); 
      out.write("<br/>&nbsp;</div>");
 {out.flush();processExtensionPoint((com.intershop.beehive.core.capi.request.ServletResponse)response,"ChannelOrdersOverviewEntries", null, "12");} 
      out.write("</div>");
 printFooter(out); 
