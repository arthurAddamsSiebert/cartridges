...
public final class OrderNotificationPreferences_005f52_jsp extends com.intershop.beehive.core.internal.template.AbstractTemplate
...
new TagParameter("text",localizeText(context.getFormattedValue("sld_ch_consumer_plugin.OrderNotification.text",null)))}, 4); 
 ...
 _boolean_result=false;try {_boolean_result=((Boolean)(((((Boolean) getObject("OrderNotificationSettingsForm:EmailSubject:isError(\"error.required\")")).booleanValue() || ((Boolean) getObject("OrderNotificationSettingsForm:CancelEmailSubject:isError(\"error.required\")")).booleanValue()) ? Boolean.TRUE : Boolean.FALSE))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",24,e);}if (_boolean_result) { 
      out.write("<br/>");
 {out.write(localizeISText("sld_ch_consumer_plugin.PleaseProvideASubjectForTheNotificationMail.error",null,null,null,null,null,null,null,null,null,null,null,null));} 
 } 
 _boolean_result=false;try {_boolean_result=((Boolean)(((((Boolean) getObject("OrderNotificationSettingsForm:EmailTemplate:isError(\"error.required\")")).booleanValue() || ((Boolean) getObject("OrderNotificationSettingsForm:CancelEmailTemplate:isError(\"error.required\")")).booleanValue()) ? Boolean.TRUE : Boolean.FALSE))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",27,e);}if (_boolean_result) { 
      out.write("<br/>");
 ...
 {out.write(localizeISText("OrderNotificationPreferences_52.PleaseSpecifyTheAttributesForOrderNotificationEmai.table_title_description",null,null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("<br/><br/>");
 ...
 _boolean_result=false;try {_boolean_result=((Boolean)((((Boolean) (disableErrorMessages().isDefined(getObject("CurrentChannelPermissionMap:SLD_MANAGE_ORDERS_PREFERENCES")))).booleanValue() ? Boolean.FALSE : Boolean.TRUE) )).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",47,e);}if (_boolean_result) { 
      ...
      out.print(context.getFormattedValue(context.webRoot(),null));
      out.write("/images/space.gif\" width=\"1\" height=\"4\" alt=\"\" border=\"0\"/></td></tr>\n<tr>\n<td class=\"label\" nowrap=\"nowrap\" width=\"20%\"><label class=\"label\">");
 {out.write(localizeISText("sld_ch_consumer_plugin.EmailFromAddress.label",null,null,null,null,null,null,null,null,null,null,null,null));} 
      out.write(":<span class=\"star\">*</span></label></td>\n<td class=\"table_detail\">\n<input type=\"text\" name=\"OrderNotificationSettingsForm_EmailFrom\" class=\"inputfield_en\" size=\"70\" value=\"");
 ...
 {out.write(localizeISText("OrderNotificationPreferences_52.SendOrderNotificationEmail.label",null,null,null,null,null,null,null,null,null,null,null,null));} 
      out.write(":</label></td>\n<td class=\"input_checkbox\" colspan=\"2\">\n<input type=\"checkbox\" name=\"OrderNotificationSettingsForm_SendNotification\" value=\"yes\" ");
 ...
 {out.write(localizeISText("sld_ch_consumer_plugin.OrderCancelNotification.table_title",null,null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("</td>\n</tr>\n<tr>\n<td class=\"w e s\">\n<table border=\"0\" cellspacing=\"0\" cellpadding=\"0\"\n");
 _boolean_result=false;try {_boolean_result=((Boolean)((((Boolean) (disableErrorMessages().isDefined(getObject("CurrentChannelPermissionMap:SLD_MANAGE_ORDERS_PREFERENCES")))).booleanValue() ? Boolean.FALSE : Boolean.TRUE) )).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",73,e);}if (_boolean_result) { 
      ...
      out.write("/images/space.gif\" width=\"1\" height=\"4\" alt=\"\" border=\"0\"/></td></tr>\n<tr>\n<td class=\"label\" nowrap=\"nowrap\" width=\"20%\"><label class=\"label\">");
 {out.write(localizeISText("sld_ch_consumer_plugin.EmailFromAddress.label",null,null,null,null,null,null,null,null,null,null,null,null));} 
      out.write(":<span class=\"star\">*</span></label></td>\n<td class=\"table_detail\">\n<input type=\"text\" name=\"OrderNotificationSettingsForm_CancelEmailFrom\" class=\"inputfield_en\" size=\"70\" value=\"");
 {String value = null;try{value=context.getFormattedValue(getObject("OrderNotificationSettingsForm:CancelEmailFrom:FormattedValue"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {79}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
      out.write("\"/>\n</td>\n<td class=\"table_detail\" width=\"30%\"></td>\n</tr>\n<tr>\n<td class=\"label_checkbox\" nowrap=\"nowrap\"><label class=\"label label_checkbox\">");
 {out.write(localizeISText("OrderNotificationPreferences_52.SendOrderNotificationEmail.label",null,null,null,null,null,null,null,null,null,null,null,null));} 
      out.write(":</label></td>\n<td class=\"input_checkbox\" colspan=\"2\">\n<input type=\"checkbox\" name=\"OrderNotificationSettingsForm_CancelSendNotification\" value=\"yes\" ");
 ...
 _boolean_result=false;try {_boolean_result=((Boolean)((disableErrorMessages().isDefined(getObject("CurrentChannelPermissionMap:SLD_MANAGE_ORDERS_PREFERENCES"))))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",94,e);}if (_boolean_result) { 
      ...
      out.write("</table>");
 out.print("</form>"); 
 {out.flush();processLocalIncludeByServer((com.intershop.beehive.core.capi.request.ServletResponse)response,"inc/Back", null, "108");} 
 printFooter(out); 
