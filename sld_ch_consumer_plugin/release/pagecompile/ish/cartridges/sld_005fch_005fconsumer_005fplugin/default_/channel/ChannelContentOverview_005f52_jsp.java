...
public final class ChannelContentOverview_005f52_jsp extends com.intershop.beehive.core.internal.template.AbstractTemplate
...
new TagParameter("text",localizeText(context.getFormattedValue("ChannelContentOverview_52.Content.text",null)))}, 7); 
...
new TagParameter("key","content.title")}, 11); 
...
new TagParameter("key","content.description")}, 12); 
      out.write("<br/>&nbsp;</div>");
 {out.flush();processExtensionPoint((com.intershop.beehive.core.capi.request.ServletResponse)response,"ChannelContentOverviewEntries", null, "13");} 
      out.write("</div>");
 printFooter(out); 
