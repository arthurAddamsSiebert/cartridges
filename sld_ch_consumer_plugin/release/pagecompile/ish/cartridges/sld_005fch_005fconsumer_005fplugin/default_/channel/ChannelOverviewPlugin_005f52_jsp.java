...
public final class ChannelOverviewPlugin_005f52_jsp extends com.intershop.beehive.core.internal.template.AbstractTemplate
...
new TagParameter("modulo","2")}, 5); 
      out.write("<div class=\"overviewWrapper\" data-testing-id=\"bo-channel-overview\">\n<div class=\"overview_title\">");
 processOpenTag(response, pageContext, "apptext", new TagParameter[] {
new TagParameter("key","overview.headline.title")}, 7); 
      out.write("</div>\n<div class=\"table_title_description\">");
 processOpenTag(response, pageContext, "apptext", new TagParameter[] {
new TagParameter("key","overview.headline.description")}, 8); 
      out.write("<br/>&nbsp;</div>");
 {out.flush();processExtensionPoint((com.intershop.beehive.core.capi.request.ServletResponse)response,"ChannelOverviewOverviewEntries", null, "9");} 
      out.write("</div>");
 printFooter(out); 
