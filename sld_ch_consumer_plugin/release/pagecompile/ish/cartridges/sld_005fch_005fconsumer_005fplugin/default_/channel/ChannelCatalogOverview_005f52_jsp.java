...
public final class ChannelCatalogOverview_005f52_jsp extends com.intershop.beehive.core.internal.template.AbstractTemplate
...
new TagParameter("text",localizeText(context.getFormattedValue("catalogs.title",null)))}, 7); 
...
new TagParameter("key","catalogs.title")}, 10); 
      out.write("</div>\n<div class=\"table_title_description\">");
 processOpenTag(response, pageContext, "apptext", new TagParameter[] {
new TagParameter("key","catalogs.description")}, 11); 
      out.write("<br/>&nbsp;</div>");
 {out.flush();processExtensionPoint((com.intershop.beehive.core.capi.request.ServletResponse)response,"ChannelCatalogsOverviewEntries", null, "12");} 
      out.write("</div>");
 printFooter(out); 
