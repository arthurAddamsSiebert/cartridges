...
public final class OrderCompletedHistoryStatus_005f52_jsp extends com.intershop.beehive.core.internal.template.AbstractTemplate
...
setEncodingType("text/html"); 
 ...
 {out.write(localizeISText("OrderCompletedHistoryStatus_52.SelectOrderStatusToDisplay.infobox_title",null,null,null,null,null,null,null,null,null,null,null,null));} 
      out.write(":&nbsp;</td>\n\t\t\t\t<td align=\"left\">\n\t\t\t\t\t<select name=\"status\" size=\"1\" class=\"inputfield_en\">\n\t\t\t\t\t\t<option value=\"allcompleted\" selected=\"selected\">");
 {out.write(localizeISText("OrderCompletedHistoryStatus_52.All.option",null,null,null,null,null,null,null,null,null,null,null,null));} 
 ...
 _boolean_result=false;try {_boolean_result=((Boolean)(((((Boolean) ((disableErrorMessages().isDefined(getObject("status"))))).booleanValue() && ((Boolean) ((((context.getFormattedValue(getObject("status"),null).equals(context.getFormattedValue("completed",null)))) ? Boolean.TRUE : Boolean.FALSE))).booleanValue()) ? Boolean.TRUE : Boolean.FALSE))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",12,e);}if (_boolean_result) { 
      ...
      out.write('>');
 {out.write(localizeISText("OrderCompletedHistoryStatus_52.Completed.option",null,null,null,null,null,null,null,null,null,null,null,null));} 
 ...
 _boolean_result=false;try {_boolean_result=((Boolean)(((((Boolean) ((disableErrorMessages().isDefined(getObject("status"))))).booleanValue() && ((Boolean) ((((context.getFormattedValue(getObject("status"),null).equals(context.getFormattedValue("cancelled",null)))) ? Boolean.TRUE : Boolean.FALSE))).booleanValue()) ? Boolean.TRUE : Boolean.FALSE))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",13,e);}if (_boolean_result) { 
      ...
      out.write('>');
 {out.write(localizeISText("OrderCompletedHistoryStatus_52.Cancelled.option",null,null,null,null,null,null,null,null,null,null,null,null));} 
 ...
 _boolean_result=false;try {_boolean_result=((Boolean)(((((Boolean) ((disableErrorMessages().isDefined(getObject("status"))))).booleanValue() && ((Boolean) ((((context.getFormattedValue(getObject("status"),null).equals(context.getFormattedValue("rejected",null)))) ? Boolean.TRUE : Boolean.FALSE))).booleanValue()) ? Boolean.TRUE : Boolean.FALSE))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",14,e);}if (_boolean_result) { 
      ...
      out.write('>');
 {out.write(localizeISText("OrderCompletedHistoryStatus_52.Rejected.option",null,null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("</option>\n\t\t\t\t\t</select>\n\t\t\t\t</td>\n\t\t\t\t<td>&nbsp;</td>\n\t\t\t\t<td>\n\t\t\t\t\t<table border=\"0\" cellspacing=\"4\" cellpadding=\"0\">\n\t\t\t\t\t\t<tr>\n\t\t\t\t\t\t\t<td class=\"button\">\n\t\t\t\t\t\t\t\t<input type=\"submit\" name=\"find\" value=\"");
      out.print(context.getFormattedValue(localizeText(context.getFormattedValue("OrderCompletedHistoryStatus_52.Apply.button",null)),null));
