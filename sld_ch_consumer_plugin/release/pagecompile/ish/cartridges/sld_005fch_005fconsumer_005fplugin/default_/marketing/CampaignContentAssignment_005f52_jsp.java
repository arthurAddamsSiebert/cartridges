...
public final class CampaignContentAssignment_005f52_jsp extends com.intershop.beehive.core.internal.template.AbstractTemplate
...
new TagParameter("text",localizeText(context.getFormattedValue("CampaignContentAssignment_52.AssignContent.text",null)))}, 5); 
...
new TagParameter("value0",getObject("UserGroup:ID"))}, 7); 
...
new TagParameter("uniqueid","CampaignContentPageletAssignment_52")}, 16); 
 printFooter(out); 
