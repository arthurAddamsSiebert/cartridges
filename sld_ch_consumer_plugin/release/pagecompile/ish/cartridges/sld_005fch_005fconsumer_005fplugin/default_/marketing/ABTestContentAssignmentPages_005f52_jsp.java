...
public final class ABTestContentAssignmentPages_005f52_jsp extends com.intershop.beehive.core.internal.template.AbstractTemplate
...
new TagParameter("text",localizeText(context.getFormattedValue("ABTestContentAssignmentPages_52.AssignTestContentStep2Of2.text",null)))}, 5); 
...
new TagParameter("mapname","TargetPipelineParams")}, 7); 
 ...
 {out.write(localizeISText("ABTestContentAssignmentPages_52.AssignTestContentChooseAnObject.table_title",null,null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("</td>\n</tr>");
...
new TagParameter("uniqueid","ABTestContentPageletAssignment_52")}, 23); 
 printFooter(out); 
