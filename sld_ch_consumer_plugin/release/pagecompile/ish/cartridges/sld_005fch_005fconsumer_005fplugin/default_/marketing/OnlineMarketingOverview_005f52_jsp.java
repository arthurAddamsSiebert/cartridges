...
public final class OnlineMarketingOverview_005f52_jsp extends com.intershop.beehive.core.internal.template.AbstractTemplate
...
new TagParameter("key","marketing.title")}, 10); 
      out.write("</div>\n<div class=\"table_title_description\">");
 processOpenTag(response, pageContext, "apptext", new TagParameter[] {
new TagParameter("key","marketing.description.viewmarketingrights")}, 11); 
      out.write("<br/>&nbsp;</div>");
 {out.flush();processExtensionPoint((com.intershop.beehive.core.capi.request.ServletResponse)response,"OnlineMarketingOverviewEntries", null, "12");} 
      out.write("</div>");
 printFooter(out); 
