...
public final class GiftCardTransactions_005f52_jsp extends com.intershop.beehive.core.internal.template.AbstractTemplate
...
new TagParameter("text",context.getFormattedValue(getObject("GiftCardCode"),null) + context.getFormattedValue(" ",null) + context.getFormattedValue(getObject("Transactions"),null))}, 5); 
      out.write("<table border=\"0\" cellspacing=\"0\" cellpadding=\"0\" width=\"100%\"> \n<!-- Begin tabs row -->\n<tr> \n<td> \n");

				getPipelineDictionary().put("SelectedTab", "Transactions");
				
 {out.flush();processLocalIncludeByServer((com.intershop.beehive.core.capi.request.ServletResponse)response,"inc/GiftCardTabs_52", null, "14");} 
      out.write("</td>\n</tr>\n<!-- End tabs row -->");
 {out.flush();processLocalIncludeByServer((com.intershop.beehive.core.capi.request.ServletResponse)response,context.getFormattedValue(getObject("GiftCardService:Capabilities:BOGiftCardTransactionsTemplate"),null), null, "18");} 
      out.write("</table>");
 {out.flush();processLocalIncludeByServer((com.intershop.beehive.core.capi.request.ServletResponse)response,"inc/BackToList", null, "22");} 
 printFooter(out); 
