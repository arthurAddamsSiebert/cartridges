...
public final class NewProductBonusPointsPricesMappingRule_005f52_jsp extends com.intershop.beehive.core.internal.template.AbstractTemplate
...
new TagParameter("text1",context.getFormattedValue(" - ",null) + context.getFormattedValue(localizeText(context.getFormattedValue("NewProductBonusPointsPricesMappingRule_52.MappingRules.text1",null)),null)),
...
new TagParameter("text",localizeText(context.getFormattedValue("NewProductBonusPointsPricesMappingRule_52.BonusPointsPrice.text",null)))}, 6); 
      out.write("<table border=\"0\" cellspacing=\"0\" cellpadding=\"0\" width=\"100%\">\n<tr>\n<td>");
 URLPipelineAction action430 = new URLPipelineAction(context.getFormattedValue(url(true,(new URLPipelineAction(context.getFormattedValue("ViewProductPriceMapping_52-Dispatch",null)))),null));String site430 = null;String serverGroup430 = null;String actionValue430 = context.getFormattedValue(url(true,(new URLPipelineAction(context.getFormattedValue("ViewProductPriceMapping_52-Dispatch",null)))),null);if (site430 == null){  site430 = action430.getDomain();  if (site430 == null)  {      site430 = com.intershop.beehive.core.capi.request.Request.getCurrent().getRequestSite().getDomainName();  }}if (serverGroup430 == null){  serverGroup430 = action430.getServerGroup();  if (serverGroup430 == null)  {      serverGroup430 = com.intershop.beehive.core.capi.request.Request.getCurrent().getRequestSite().getServerGroup();  }}out.print("<form");out.print(" method=\"");out.print("post");out.print("\"");out.print(" action=\"");out.print(context.getFormattedValue(url(true,(new URLPipelineAction(context.getFormattedValue("ViewProductPriceMapping_52-Dispatch",null)))),null));out.print("\"");out.print(" name=\"");out.print("detailForm");out.print("\"");out.print(">");out.print(context.prepareWACSRFTag(actionValue430, site430, serverGroup430,true)); 
 {out.flush();processLocalIncludeByServer((com.intershop.beehive.core.capi.request.ServletResponse)response,"syndication/NewProductBonusPointsPricesMappingRuleHeaderInc", null, "12");} 
 {out.flush();processLocalIncludeByServer((com.intershop.beehive.core.capi.request.ServletResponse)response,"syndication/NewProductBonusPointsMappingRuleFooterInc", null, "13");} 
      out.write("<input type=\"hidden\" name=\"TargetRuleCurrency\" value=\"BonusPointsPrice\"/>");
 out.print("</form>"); 
      out.write("</td>\n</tr>\n<tr>\n<td>");
 URLPipelineAction action431 = new URLPipelineAction(context.getFormattedValue(url(true,(new URLPipelineAction(context.getFormattedValue("ViewProductPriceMapping_52-Start",null)))),null));String site431 = null;String serverGroup431 = null;String actionValue431 = context.getFormattedValue(url(true,(new URLPipelineAction(context.getFormattedValue("ViewProductPriceMapping_52-Start",null)))),null);if (site431 == null){  site431 = action431.getDomain();  if (site431 == null)  {      site431 = com.intershop.beehive.core.capi.request.Request.getCurrent().getRequestSite().getDomainName();  }}if (serverGroup431 == null){  serverGroup431 = action431.getServerGroup();  if (serverGroup431 == null)  {      serverGroup431 = com.intershop.beehive.core.capi.request.Request.getCurrent().getRequestSite().getServerGroup();  }}out.print("<form");out.print(" method=\"");out.print("post");out.print("\"");out.print(" action=\"");out.print(context.getFormattedValue(url(true,(new URLPipelineAction(context.getFormattedValue("ViewProductPriceMapping_52-Start",null)))),null));out.print("\"");out.print(" name=\"");out.print("detail_Form");out.print("\"");out.print(">");out.print(context.prepareWACSRFTag(actionValue431, site431, serverGroup431,true)); 
