...
public final class CustomersSearch_005f52_jsp extends com.intershop.beehive.core.internal.template.AbstractTemplate
...
setEncodingType("text/html"); 
 ...
 {out.write(localizeISText("customers.list.search.simple.caption","",null,null,null,null,null,null,null,null,null,null,null));} 
...
new TagParameter("LabelClass","label label_light")}, 34); 
 ...
 {out.write(localizeISText("customers.list.search.parametric.caption","",null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("</td>\n</tr>\n<tr>\n<td class=\"infobox_subtitle\" colspan=\"2\">");
 {out.write(localizeISText("customer.search.tabs.customer","",null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("</td>\n<td>&nbsp;</td>\n<td class=\"infobox_subtitle\" colspan=\"2\">");
 {out.write(localizeISText("customer.search.tabs.user","",null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("</td>\n</tr>\n<tr>");
 processOpenTag(response, pageContext, "customerfieldstring", new TagParameter[] {
new TagParameter("Field",getObject("CustomerSearch:CustomerNo")),
new TagParameter("LabelClass","label label_indent label_light")}, 70); 
...
new TagParameter("LabelClass","label label_indent label_light")}, 72); 
      out.write("</tr>\n<tr>");
 processOpenTag(response, pageContext, "customerfieldstring", new TagParameter[] {
new TagParameter("Field",getObject("CustomerSearch:CompanyName")),
new TagParameter("LabelClass","label label_indent label_light")}, 75); 
      out.write("<td><img src=\"");
      out.print(context.getFormattedValue(context.webRoot(),null));
      out.write("/images/space.gif\" width=\"12\" height=\"1\" alt=\"\" border=\"0\"/></td>");
 processOpenTag(response, pageContext, "customerfieldstring", new TagParameter[] {
new TagParameter("Field",getObject("CustomerSearch:Login")),
new TagParameter("LabelClass","label label_indent label_light")}, 77); 
      out.write("</tr>\n<tr>\n<td class=\"label_select\" width=\"1%\">\n<label class=\"label label_select label_indent label_light");
 _boolean_result=false;try {_boolean_result=((Boolean)(getObject("CustomerSearch:CustomerType:Invalid"))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",81,e);}if (_boolean_result) { 
      out.write(" label_error");
 } 
      out.write("\" for=\"");
 {String value = null;try{value=context.getFormattedValue(getObject("CustomerSearch:CustomerType:QualifiedName"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {81}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
      out.write('"');
      out.write('>');
 ...
 {String value = null;try{value=context.getFormattedValue(getObject("CustomerSearch:CustomerType:QualifiedName"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {88}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
      out.write("\" id=\"");
 {String value = null;try{value=context.getFormattedValue(getObject("CustomerSearch:CustomerType:QualifiedName"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {88}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
      out.write("\">\n<option value=\"\">");
 ...
 {String value = null;try{value=context.getFormattedValue(getObject("CustomerType:CustomerTypeID"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {91}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
      out.write('"');
      out.write(' ');
...
new TagParameter("LabelClass","label label_indent label_light")}, 101); 
      out.write("</tr>\n<tr>\n<td colspan=\"2\">\n&nbsp;\n</td>\n<td><img src=\"");
      out.print(context.getFormattedValue(context.webRoot(),null));
      out.write("/images/space.gif\" width=\"12\" height=\"1\" alt=\"\" border=\"0\"/></td>");
 processOpenTag(response, pageContext, "customerfieldstring", new TagParameter[] {
new TagParameter("Field",getObject("CustomerSearch:LastName")),
new TagParameter("LabelClass","label label_indent label_light")}, 108); 
      out.write("</tr>\n<tr>");
...
new TagParameter("Date",getObject("CustomerSearch:CustomerCreationDateFrom:Day"))}, 111); 
      out.write("<td><img src=\"");
      out.print(context.getFormattedValue(context.webRoot(),null));
      out.write("/images/space.gif\" width=\"12\" height=\"1\" alt=\"\" border=\"0\"/></td>");
 processOpenTag(response, pageContext, "customerfielddatetime", new TagParameter[] {
...
new TagParameter("Date",getObject("CustomerSearch:UserCreationDateFrom:Day"))}, 117); 
      out.write("</tr>\n<tr>");
 processOpenTag(response, pageContext, "customerfielddatetime", new TagParameter[] {
...
new TagParameter("Date",getObject("CustomerSearch:CustomerCreationDateTo:Day"))}, 124); 
      out.write("<td><img src=\"");
      out.print(context.getFormattedValue(context.webRoot(),null));
      out.write("/images/space.gif\" width=\"12\" height=\"1\" alt=\"\" border=\"0\"/></td>");
 processOpenTag(response, pageContext, "customerfielddatetime", new TagParameter[] {
...
new TagParameter("Date",getObject("CustomerSearch:UserCreationDateTo:Day"))}, 130); 
      out.write("</tr>\n<tr>\n<td class=\"label_select nowrap\" width=\"1%\">\n<label class=\"label label_select label_light label_indent");
 _boolean_result=false;try {_boolean_result=((Boolean)(getObject("CustomerSearch:CustomerStatus:Invalid"))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",138,e);}if (_boolean_result) { 
      out.write(" label_error");
 } 
      out.write("\" for=\"");
 {String value = null;try{value=context.getFormattedValue(getObject("CustomerSearch:CustomerStatus:QualifiedName"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {138}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
      out.write('"');
      out.write('>');
 ...
 {String value = null;try{value=context.getFormattedValue(getObject("CustomerSearch:CustomerStatus:QualifiedName"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {143}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
      out.write("\" id=\"");
 {String value = null;try{value=context.getFormattedValue(getObject("CustomerSearch:CustomerStatus:QualifiedName"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {143}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
      out.write("\">\n<option value=\"\">");
 ...
 {out.write(localizeISText("customers.list.status.enabled","",null,null,null,null,null,null,null,null,null,null,null));} 
      ...
      out.print(context.getFormattedValue(context.webRoot(),null));
      out.write("/images/space.gif\" width=\"12\" height=\"1\" alt=\"\" border=\"0\"/></td>\n<td class=\"label_select nowrap\" width=\"1%\">\n<label class=\"label label_select label_light label_indent");
 _boolean_result=false;try {_boolean_result=((Boolean)(getObject("CustomerSearch:UserStatus:Invalid"))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",151,e);}if (_boolean_result) { 
      out.write(" label_error");
 } 
      out.write("\" for=\"");
 {String value = null;try{value=context.getFormattedValue(getObject("CustomerSearch:UserStatus:QualifiedName"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {151}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
      out.write('"');
      out.write('>');
 {out.write(localizeISText(context.getFormattedValue(context.getFormattedValue("customer.form.fields.labels.",null) + context.getFormattedValue(getObject("CustomerSearch:UserStatus:ID"),null),null),"",null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("</label>\n</td>\n<td class=\"table_detail left\">\n<select class=\"select inputfield_en\" name=\"");
 {String value = null;try{value=context.getFormattedValue(getObject("CustomerSearch:UserStatus:QualifiedName"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {156}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
      out.write("\" id=\"");
 {String value = null;try{value=context.getFormattedValue(getObject("CustomerSearch:UserStatus:QualifiedName"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {156}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
      out.write("\">\n<option value=\"\">");
 {out.write(localizeISText("customers.list.status.any","",null,null,null,null,null,null,null,null,null,null,null));} 
 ...
 {out.write(localizeISText("customers.list.status.enabled","",null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("</option>\n</select>\n</td>\n</tr>");
 _boolean_result=false;try {_boolean_result=((Boolean)(getObject("ApplicationBO:Extension(\"CustomerApproval\"):EnabledForAnyCustomerType"))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",163,e);}if (_boolean_result) { 
      out.write("<tr>\n<td class=\"label_select nowrap\" width=\"1%\">\n<label class=\"label label_select label_light label_indent");
 _boolean_result=false;try {_boolean_result=((Boolean)(getObject("CustomerSearch:CustomerApprovalStatus:Invalid"))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",166,e);}if (_boolean_result) { 
      out.write(" label_error");
 } 
      out.write("\" for=\"");
 {String value = null;try{value=context.getFormattedValue(getObject("CustomerSearch:CustomerApprovalStatus:QualifiedName"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {166}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
      out.write('"');
      out.write('>');
 {out.write(localizeISText(context.getFormattedValue(context.getFormattedValue("customer.form.fields.labels.",null) + context.getFormattedValue(getObject("CustomerSearch:CustomerApprovalStatus:ID"),null),null),"",null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("</label>\n</td>\n<td class=\"table_detail left\">\n<select class=\"select inputfield_en\" name=\"");
 ...
 _boolean_result=false;try {_boolean_result=((Boolean)(((((Boolean) (disableErrorMessages().isDefined(getObject("OnlyB2C")))).booleanValue() && ((Boolean) ((((context.getFormattedValue(getObject("OnlyB2C"),null).equals(context.getFormattedValue("true",null)))) ? Boolean.TRUE : Boolean.FALSE))).booleanValue()) ? Boolean.TRUE : Boolean.FALSE))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",223,e);}if (_boolean_result) { 
      out.write("\n$('");
      out.print(context.getFormattedValue("#",null));
 {String value = null;try{value=context.getFormattedValue(getObject("CustomerSearch:CustomerType:QualifiedName"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {224}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
      out.write("').prop('disabled', 'disabled');\n");
 } 
      out.write("\n$('.js-searchbox-simpleSearch').hide();\n");
 } else { 
      out.write("\n$('.js-searchbox-advancedSearch :input').not(':button, :submit, :reset, :hidden').prop('disabled', 'disabled');\n$('.js-searchbox-advancedSearch').hide();\n");
