...
public final class CustomerUserListColumns_005f52_jsp extends com.intershop.beehive.core.internal.template.AbstractTemplate
...
setEncodingType("text/javascript"); 
 ...
 _boolean_result=false;try {_boolean_result=((Boolean)((disableErrorMessages().isDefined(getObject("params:UserPermissionForEdit"))))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",13,e);}if (_boolean_result) { 
      ...
      out.write("\ntype: {\ntype: 'text',\ndataKey: 'type',\nsortable: false,\nwidth: 40,\ntitle: '");
 {out.write(localizeISText("CustomerUserListColumns_52.Type",null,null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("'\n},\nname: {\ntype: 'text',\ndataKey: 'displayName',\ntitle: '");
 {out.write(localizeISText("customer.User",null,null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("',\nsortable: true\n},\nbusinessPartnerNo: {\ntype: 'text',\ndataKey: 'businessPartnerNumber',\ntitle: '");
 {out.write(localizeISText("customer.ID",null,null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("',\nsortable: true\n},\ndisabledflag: {\ntype: 'status',\ndataKey: 'isActive',\nsortable: true,\ntitle: '");
 {out.write(localizeISText("customer.Status",null,null,null,null,null,null,null,null,null,null,null,null));} 
 ...
 {out.write(localizeISText("customer.CreationDate",null,null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("',\nsortable: true\n}\n},\nnames = [");
 {String value = null;try{value=context.getFormattedValue(getObject("columns"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {97}",e);}if (value==null) value="";out.write(value);} 
