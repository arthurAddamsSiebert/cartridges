...
public final class CustomerManagementOverview_005f52_jsp extends com.intershop.beehive.core.internal.template.AbstractTemplate
...
new TagParameter("text",localizeText(context.getFormattedValue("customers.title",null)))}, 7); 
      out.write("<!-- EO Page Navigator -->\n<div class=\"overviewWrapper\">\n<div class=\"overview_title\">");
 processOpenTag(response, pageContext, "apptext", new TagParameter[] {
new TagParameter("key","customers.title")}, 10); 
      out.write("</div>\n<div class=\"table_title_description\">");
 processOpenTag(response, pageContext, "apptext", new TagParameter[] {
new TagParameter("parameter0",getObject("CurrentChannel:DisplayName")),
new TagParameter("key","customers.description")}, 11); 
      out.write("<br/>&nbsp;</div>");
 {out.flush();processExtensionPoint((com.intershop.beehive.core.capi.request.ServletResponse)response,"CustomerManagementOverviewEntries", null, "12");} 
      out.write("</div>");
 printFooter(out); 
