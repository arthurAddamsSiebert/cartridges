...
public final class CustomerPriceListsColumns_005f52_jsp extends com.intershop.beehive.core.internal.template.AbstractTemplate
...
setEncodingType("text/javascript"); 
 ...
 _boolean_result=false;try {_boolean_result=((Boolean)((disableErrorMessages().isDefined(getObject("params:UserPermissionForEdit"))))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",13,e);}if (_boolean_result) { 
      ...
      out.write("\nname: {\ntype: 'text',\ndataKey: 'name',\nsortable: false,\ntitle: '");
 {out.write(localizeISText("PriceListsColumns_52.Name",null,null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("'\n},\ndescription: {\ntype: 'text',\ndataKey: 'description',\ntitle: '");
 {out.write(localizeISText("PriceListsColumns_52.Description",null,null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("',\nsortable: false\n},\nvalidFrom: {\ntype: 'text',\ndataKey: 'validFrom',\nsortable: false,\ntitle: '");
 {out.write(localizeISText("PriceListsColumns_52.ValidFrom",null,null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("' \n},\nvalidTo: {\ntype: 'text',\ndataKey: 'validTo',\nsortable: false,\ntitle: '");
 {out.write(localizeISText("PriceListsColumns_52.ValidTo",null,null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("' \n}\n},\nnames = [");
 {String value = null;try{value=context.getFormattedValue(getObject("columns"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {46}",e);}if (value==null) value="";out.write(value);} 
