...
new TagParameter("text",localizeText(context.getFormattedValue("LineItemBundledItem_52.BundledItem.text",null)))}, 25); %><table border="0" cellpadding="0" cellspacing="0" width="100%" class="w e s">
<tr>
<td class="table_title n s" nowrap="nowrap"><% {out.write(localizeISText("LineItemBundledItem_52.BundledItem.table_title",null,null,null,null,null,null,null,null,null,null,null,null));} %> - <% {String value = null;try{value=context.getFormattedValue(getObject("LineItem:ProductName"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {28}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} %></td>
</tr>
<tr>
...
<tr>
<td class="table_header s" nowrap="nowrap" colspan="2"><% {out.write(localizeISText("LineItemBundledItem_52.ProductInformation.table_header",null,null,null,null,null,null,null,null,null,null,null,null));} %></td>
</tr>
<tr>
<td class="fielditem2 s e" nowrap="nowrap"><% {out.write(localizeISText("LineItemBundledItem_52.Seller.fielditem2",null,null,null,null,null,null,null,null,null,null,null,null));} %>:</td>
...
<tr>
<td class="fielditem2 s e" nowrap="nowrap"><% {out.write(localizeISText("LineItemBundledItem_52.SellerProductID.fielditem2",null,null,null,null,null,null,null,null,null,null,null,null));} %>:</td>
...
<tr>
<td class="fielditem2 s e" nowrap="nowrap"><% {out.write(localizeISText("LineItemBundledItem_52.Supplier.fielditem2",null,null,null,null,null,null,null,null,null,null,null,null));} %>:</td>
...
<tr>
<td class="fielditem2 s e" nowrap="nowrap"><% {out.write(localizeISText("LineItemBundledItem_52.SupplierProductID.fielditem2",null,null,null,null,null,null,null,null,null,null,null,null));} %>:</td>
...
<tr>
<td class="fielditem2 s e" nowrap="nowrap"><% {out.write(localizeISText("LineItemBundledItem_52.Manufacturer.fielditem2",null,null,null,null,null,null,null,null,null,null,null,null));} %>:</td>
...
<tr>
<td class="fielditem2 s e" nowrap="nowrap"><% {out.write(localizeISText("LineItemBundledItem_52.ManufacturerProductID.fielditem2",null,null,null,null,null,null,null,null,null,null,null,null));} %>:</td>
...
<td class="table_header s" nowrap="nowrap" colspan="2"><% {out.write(localizeISText("LineItemBundledItem_52.OrderInformation.table_header",null,null,null,null,null,null,null,null,null,null,null,null));} %></td>
...
<td class="table_header s" nowrap="nowrap" colspan="2"><% {out.write(localizeISText("LineItemBundledItem_52.Packaging.table_header",null,null,null,null,null,null,null,null,null,null,null,null));} %></td>
</tr>
<tr>
<td class="fielditem2 e s" nowrap="nowrap"><% {out.write(localizeISText("LineItemBundledItem_52.PackingUnit.fielditem2",null,null,null,null,null,null,null,null,null,null,null,null));} %>:</td>
...
<tr>
<td class="fielditem2 e s" nowrap="nowrap"><% {out.write(localizeISText("LineItemBundledItem_52.PurchaseQuantity.fielditem2",null,null,null,null,null,null,null,null,null,null,null,null));} %>:</td>
...
</table><% {out.flush();processLocalIncludeByServer((com.intershop.beehive.core.capi.request.ServletResponse)response,"order/LineItemBundledItems_52", null, "90");} %></td>
</tr>
