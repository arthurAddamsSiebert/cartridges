...
type: 'text',
dataKey: 'name',
title: '<% {out.write(localizeISText("filter.Name",null,null,null,null,null,null,null,null,null,null,null,null));} %>',
cssClass: 'wordwrap',
sortable: false
<% _boolean_result=false;try {_boolean_result=((Boolean)((disableErrorMessages().isDefined(getObject("params:RenderLink"))))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",20,e);}if (_boolean_result) { %>
...
type: 'text',
dataKey: 'ID',
title: '<% {out.write(localizeISText("filter.ID",null,null,null,null,null,null,null,null,null,null,null,null));} %>',
sortable: false
}, {
id: 'description',
type: 'text',
dataKey: 'description',
title: '<% {out.write(localizeISText("filter.Description",null,null,null,null,null,null,null,null,null,null,null,null));} %>',
sortable: false
}]
<% printFooter(out); %>