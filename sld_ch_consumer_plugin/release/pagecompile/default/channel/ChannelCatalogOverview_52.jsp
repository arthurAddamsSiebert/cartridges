...
new TagParameter("modulo","2")}, 5); %><!-- Page Navigator --><% processOpenTag(response, pageContext, "breadcrumbtrail", new TagParameter[] {
...
new TagParameter("text",localizeText(context.getFormattedValue("catalogs.title",null)))}, 7); %><!-- EO Page Navigator -->
...
new TagParameter("key","catalogs.title")}, 10); %></div>
<div class="table_title_description"><% processOpenTag(response, pageContext, "apptext", new TagParameter[] {
new TagParameter("key","catalogs.description")}, 11); %><br/>&nbsp;</div><% {out.flush();processExtensionPoint((com.intershop.beehive.core.capi.request.ServletResponse)response,"ChannelCatalogsOverviewEntries", null, "12");} %></div><% printFooter(out); %>