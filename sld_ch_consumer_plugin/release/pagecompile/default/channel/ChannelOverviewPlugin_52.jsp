...
new TagParameter("modulo","2")}, 5); %><div class="overviewWrapper" data-testing-id="bo-channel-overview">
<div class="overview_title"><% processOpenTag(response, pageContext, "apptext", new TagParameter[] {
new TagParameter("key","overview.headline.title")}, 7); %></div>
<div class="table_title_description"><% processOpenTag(response, pageContext, "apptext", new TagParameter[] {
new TagParameter("key","overview.headline.description")}, 8); %><br/>&nbsp;</div><% {out.flush();processExtensionPoint((com.intershop.beehive.core.capi.request.ServletResponse)response,"ChannelOverviewOverviewEntries", null, "9");} %></div><% printFooter(out); %>