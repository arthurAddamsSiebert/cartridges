...
new TagParameter("modulo","2")}, 4); %><!-- Page Navigator --><% processOpenTag(response, pageContext, "breadcrumbtrail", new TagParameter[] {
...
new TagParameter("text",localizeText(context.getFormattedValue("customers.title",null)))}, 7); %><!-- EO Page Navigator -->
<div class="overviewWrapper">
<div class="overview_title"><% processOpenTag(response, pageContext, "apptext", new TagParameter[] {
new TagParameter("key","customers.title")}, 10); %></div>
...
new TagParameter("key","customers.description")}, 11); %><br/>&nbsp;</div><% {out.flush();processExtensionPoint((com.intershop.beehive.core.capi.request.ServletResponse)response,"CustomerManagementOverviewEntries", null, "12");} %></div><% printFooter(out); %>