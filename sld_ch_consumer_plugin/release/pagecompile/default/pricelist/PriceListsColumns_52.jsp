...
dataKey: 'name',
sortable: false,
title: '<% {out.write(localizeISText("PriceListsColumns_52.Name",null,null,null,null,null,null,null,null,null,null,null,null));} %>'
},
description: {
type: 'text',
dataKey: 'description',
title: '<% {out.write(localizeISText("PriceListsColumns_52.Description",null,null,null,null,null,null,null,null,null,null,null,null));} %>',
sortable: false
},
validFrom: {
type: 'text',
dataKey: 'validFrom',
sortable: false,
title: '<% {out.write(localizeISText("PriceListsColumns_52.ValidFrom",null,null,null,null,null,null,null,null,null,null,null,null));} %>' 
},
validTo: {
type: 'text',
dataKey: 'validTo',
sortable: false,
title: '<% {out.write(localizeISText("PriceListsColumns_52.ValidTo",null,null,null,null,null,null,null,null,null,null,null,null));} %>' 
}
},
names = [<% {String value = null;try{value=context.getFormattedValue(getObject("columns"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {46}",e);}if (value==null) value="";out.write(value);} %>],
