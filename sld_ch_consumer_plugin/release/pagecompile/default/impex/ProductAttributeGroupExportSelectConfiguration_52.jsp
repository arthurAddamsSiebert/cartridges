...
new TagParameter("link",url(true,(new URLPipelineAction(context.getFormattedValue("ViewProductAttributeGroupExport_52-SelectConfiguration",null))),(new URLParameterSet().addURLParameter(context.getFormattedValue("SelectedObjectUUID",null),context.getFormattedValue(getObject("SelectedObjectUUID"),null))).addURLParameter(context.getFormattedValue("ChannelID",null),context.getFormattedValue(getObject("ChannelID"),null)))),
new TagParameter("wizard","true"),
new TagParameter("id","prodAttrGrpExpSlcCfg"),
new TagParameter("text",localizeText(context.getFormattedValue("ProductAttributeGroupExportSelectConfiguration_52.ProductAttributeGroupExportStep2ConfigureExport",null)))}, 3); %><% URLPipelineAction action492 = new URLPipelineAction(context.getFormattedValue(url(true,(new URLPipelineAction(context.getFormattedValue("ViewProductAttributeGroupExport_52-Dispatch",null)))),null));String site492 = null;String serverGroup492 = null;String actionValue492 = context.getFormattedValue(url(true,(new URLPipelineAction(context.getFormattedValue("ViewProductAttributeGroupExport_52-Dispatch",null)))),null);if (site492 == null){  site492 = action492.getDomain();  if (site492 == null)  {      site492 = com.intershop.beehive.core.capi.request.Request.getCurrent().getRequestSite().getDomainName();  }}if (serverGroup492 == null){  serverGroup492 = action492.getServerGroup();  if (serverGroup492 == null)  {      serverGroup492 = com.intershop.beehive.core.capi.request.Request.getCurrent().getRequestSite().getServerGroup();  }}out.print("<form");out.print(" method=\"");out.print("post");out.print("\"");out.print(" action=\"");out.print(context.getFormattedValue(url(true,(new URLPipelineAction(context.getFormattedValue("ViewProductAttributeGroupExport_52-Dispatch",null)))),null));out.print("\"");out.print(" name=\"");out.print("ProductAttributeGroupExportForm");out.print("\"");out.print(">");out.print(context.prepareWACSRFTag(actionValue492, site492, serverGroup492,true)); %><input type="submit" name="Export" value="<%=context.getFormattedValue(localizeText(context.getFormattedValue("ProductAttributeGroupExportSelectConfiguration_52.Export.input",null)),null)%>" style="position: absolute; width: 0px; height: 0px; margin: 0px; border: 0px; padding: 0px; font-size: 0px;"/>
<table border="0" cellpadding="0" cellspacing="0" width="100%" class="aldi">
<tr>
<td width="100%" class="table_title"><% {out.write(localizeISText("ProductAttributeGroupExportSelectConfiguration_52.ProductAttributeGroupExportStep2ConfigureExport",null,null,null,null,null,null,null,null,null,null,null,null));} %></td>
</tr>
...
<td class="error top" width="100%"><% {out.write(localizeISText("ProductAttributeGroupExportSelectConfiguration_52.ExportCouldNotBeExecuted.error",null,null,null,null,null,null,null,null,null,null,null,null));} %></td>
</tr>
...
<tr>
<td class="table_title_description"><% {out.write(localizeISText("ProductAttributeGroupExportSelectConfiguration_52.Step2Of2.table_title_description",null,null,null,null,null,null,null,null,null,null,null,null));} %></td>
</tr>
<tr>
<td class="table_title_description"><% {out.write(localizeISText("ProductAttributeGroupExportSelectConfiguration_52.FieldsWithRedAsteriskAreMandatory.table_title_description",null,null,"star",null,null,null,null,null,null,null,null,null));} %></td>
</tr>
</table>
...
<td class="table_detail main w s" nowrap="nowrap"><label class="label label_radio_text label_light" for="ExportSearchResult">&nbsp;<% {out.write(localizeISText("ProductAttributeGroupExportSelectConfiguration_52.ExportAllProductAttributeGroups.label",null,null,null,null,null,null,null,null,null,null,null,null));} %></label></td>
</tr>
<tr>
...
<td class="table_detail main w s" nowrap="nowrap"><label class="label label_radio_text label_light" for="ExportSelectedProductAttributeGroups">&nbsp;<% {out.write(localizeISText("ProductAttributeGroupExportSelectConfiguration_52.ExportSelectedProductAttributeGroups.label",null,null,null,null,null,null,null,null,null,null,null,null));} %></label></td>
</tr>
</table>
</td>
</tr>
...
<tr><% _boolean_result=false;try {_boolean_result=((Boolean)(getObject("ProductAttributeGroupExportForm:isSubmitted"))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",53,e);}if (_boolean_result) { %><% _boolean_result=false;try {_boolean_result=((Boolean)((((((Boolean) getObject("ProductAttributeGroupExportForm:ExportFile:isMissing")).booleanValue() || ((Boolean) getObject("ProductAttributeGroupExportForm:ExportFile:isInvalid")).booleanValue()) ? Boolean.TRUE : Boolean.FALSE)))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",54,e);}if (_boolean_result) { %><td class="fielditem2_error s" nowrap="nowrap"><% {out.write(localizeISText("ProductAttributeGroupExportSelectConfiguration_52.ExportFile",null,null,null,null,null,null,null,null,null,null,null,null));} %>:<span class="star">*</span></td><% } else { %><td class="fielditem2 s" nowrap="nowrap"><% {out.write(localizeISText("ProductAttributeGroupExportSelectConfiguration_52.ExportFile",null,null,null,null,null,null,null,null,null,null,null,null));} %>:<span class="star">*</span></td><% } %><td class="fielditem2 s" width="100%"><input type="text" name="ProductAttributeGroupExportForm_ExportFile" size="40" class="inputfield_en" value="<% {String value = null;try{value=context.getFormattedValue(getObject("ProductAttributeGroupExportForm:ExportFile:Value"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {59}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} %>"/></td><% } else { %><td class="fielditem2 s" nowrap="nowrap"><% {out.write(localizeISText("ProductAttributeGroupExportSelectConfiguration_52.ExportFile",null,null,null,null,null,null,null,null,null,null,null,null));} %>:<span class="star">*</span></td>
...
<tr>
<td class="button">
<input type="submit" name="Back" value="&lt;&lt;&nbsp;<%=context.getFormattedValue(localizeText(context.getFormattedValue("ProductAttributeGroupExportSelectConfiguration_52.Previous.button",null)),null)%>" class="button"/>
</td>
</tr>
</table>
</td>
...
<input type="submit" name="Export" value="<%=context.getFormattedValue(localizeText(context.getFormattedValue("ProductAttributeGroupExportSelectConfiguration_52.Export.button",null)),null)%>" class="button"/>
</td>
<td class="button"><input type="submit" name="Cancel" value="<%=context.getFormattedValue(localizeText(context.getFormattedValue("ProductAttributeGroupExportSelectConfiguration_52.Cancel.button",null)),null)%>" class="button"/></td>
</tr>
</table>
</td>
</tr>
