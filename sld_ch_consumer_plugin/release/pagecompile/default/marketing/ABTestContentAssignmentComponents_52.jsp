...
new TagParameter("text",localizeText(context.getFormattedValue("ABTestContentAssignmentComponents_52.AssignTestContentStep2Of2.text",null)))}, 5); %><% processOpenTag(response, pageContext, "createmap", new TagParameter[] {
...
<tr>
<td width="100%" class="table_title aldi"><% {out.write(localizeISText("ABTestContentAssignmentComponents_52.AssignTestContentChooseAnObject.table_title",null,null,null,null,null,null,null,null,null,null,null,null));} %></td>
...
new TagParameter("uniqueid","ABTestContentPageletAssignment_52")}, 24); %><% printFooter(out); %>