...
new TagParameter("text",localizeText(context.getFormattedValue("marketing.title",null)))}, 7); %><!-- EO Page Navigator -->
<div class="overviewWrapper">
<div class="overview_title"><% processOpenTag(response, pageContext, "apptext", new TagParameter[] {
new TagParameter("key","marketing.title")}, 10); %></div>
<div class="table_title_description"><% processOpenTag(response, pageContext, "apptext", new TagParameter[] {
new TagParameter("key","marketing.description.viewmarketingrights")}, 11); %><br/>&nbsp;</div><% {out.flush();processExtensionPoint((com.intershop.beehive.core.capi.request.ServletResponse)response,"OnlineMarketingOverviewEntries", null, "12");} %></div><% printFooter(out); %>