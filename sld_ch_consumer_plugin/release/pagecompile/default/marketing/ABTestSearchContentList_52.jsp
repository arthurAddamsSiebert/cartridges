...
new TagParameter("link",url(true,(new URLPipelineAction(context.getFormattedValue("ViewPageletSearch-BackToList",null))),(new URLParameterSet().addURLParameter(context.getFormattedValue("UniquePageletSearchID",null),context.getFormattedValue("ABTestSerachContentList_52",null))).addURLParameter(context.getFormattedValue("SearchType",null),context.getFormattedValue(getObject("SearchType"),null)).addURLParameter(context.getFormattedValue("SelectedMenuItem",null),context.getFormattedValue(getObject("SelectedMenuItem"),null)).addURLParameter(context.getFormattedValue("PageFlag",null),context.getFormattedValue(getObject("page"),null)))),
new TagParameter("id","AssignPageToObject"),
new TagParameter("text",localizeText(context.getFormattedValue("ABTestSearchContentList_52.PageVariantList.text",null)))}, 6); %><% } else { %><% processOpenTag(response, pageContext, "breadcrumbtrail", new TagParameter[] {
new TagParameter("listview","true"),
new TagParameter("link",url(true,(new URLPipelineAction(context.getFormattedValue("ViewPageletSearch-BackToList",null))),(new URLParameterSet().addURLParameter(context.getFormattedValue("UniquePageletSearchID",null),context.getFormattedValue("ABTestSerachContentList_52",null))).addURLParameter(context.getFormattedValue("SearchType",null),context.getFormattedValue(getObject("SearchType"),null)).addURLParameter(context.getFormattedValue("SelectedMenuItem",null),context.getFormattedValue(getObject("SelectedMenuItem"),null)).addURLParameter(context.getFormattedValue("PageFlag",null),context.getFormattedValue(getObject("page"),null)))),
new TagParameter("id","AssignComponentToObject"),
new TagParameter("text",localizeText(context.getFormattedValue("ABTestSearchContentList_52.PageVariantList.text",null)))}, 8); %><% } %><% processOpenTag(response, pageContext, "createmap", new TagParameter[] {
...
new TagParameter("extendedheadingtemplate","marketing/ABTestContentSearchListHeader_52"),
new TagParameter("selectionlisting","true"),
new TagParameter("radiobuttons","false"),
new TagParameter("submitbuttonstemplate","marketing/ABTestContentSerachListButtons_52"),
...
new TagParameter("targetpageletviewpipeline","ViewABTestList_52-DispatchContentList"),
new TagParameter("uniqueid","ABTestSerachContentList_52")}, 16); %><% printFooter(out); %>