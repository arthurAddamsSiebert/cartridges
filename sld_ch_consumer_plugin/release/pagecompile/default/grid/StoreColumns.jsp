...
type: 'link',
dataKey: 'storename',
title: '<% {out.write(localizeISText("StoreColumns.StoreName",null,null,null,null,null,null,null,null,null,null,null,null));} %>',
url: '<% {String value = null;try{value=context.getFormattedValue(context.getFormattedValue(url(true,(new URLPipelineAction(context.getFormattedValue("ViewStores_52-Edit",null)))),null) + context.getFormattedValue("?StoreID={uuid}",null),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {26}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} %>',
params: ['uuid'],
sortable: true
},
storeid: {
...
type: 'text',
dataKey: 'country',
title: '<% {out.write(localizeISText("StoreColumns.Country",null,null,null,null,null,null,null,null,null,null,null,null));} %>',
sortable: true
}, 
state: {
type: 'text',
dataKey: 'state',
title: '<% {out.write(localizeISText("StoreColumns.State",null,null,null,null,null,null,null,null,null,null,null,null));} %>',
sortable: true
},
zipcode: {
type: 'text',
dataKey: 'zipcode',
title: '<% {out.write(localizeISText("StoreColumns.ZipCode",null,null,null,null,null,null,null,null,null,null,null,null));} %>',
sortable: true
}, 
city: {
type: 'text',
dataKey: 'city',
title: '<% {out.write(localizeISText("StoreColumns.City",null,null,null,null,null,null,null,null,null,null,null,null));} %>',
sortable: true
}, 
status: {
type: 'text',
dataKey: 'status',
title: '<% {out.write(localizeISText("StoreColumns.Status",null,null,null,null,null,null,null,null,null,null,null,null));} %>',
sortable: true,
width: 180,
maxWidth: 180
}
},
names = [<% {String value = null;try{value=context.getFormattedValue(getObject("columns"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {69}",e);}if (value==null) value="";out.write(value);} %>],
