...
dataKey: 'name',
sortable: false,
title: '<% {out.write(localizeISText("CatalogViewsColumns_52.Name",null,null,null,null,null,null,null,null,null,null,null,null));} %>'
},
description: {
type: 'text',
dataKey: 'description',
title: '<% {out.write(localizeISText("CatalogViewsColumns_52.Description",null,null,null,null,null,null,null,null,null,null,null,null));} %>',
sortable: false
},
status: {
type: 'text',
dataKey: 'status',
sortable: false,
title: '<% {out.write(localizeISText("CatalogViewsColumns_52.Status",null,null,null,null,null,null,null,null,null,null,null,null));} %>' 
}
},
names = [<% {String value = null;try{value=context.getFormattedValue(getObject("columns"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {40}",e);}if (value==null) value="";out.write(value);} %>],
