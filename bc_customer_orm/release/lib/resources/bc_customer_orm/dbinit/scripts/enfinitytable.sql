...
DEFINE _cartridge       = 'bc_customer_orm'
...
UPDATE enfinitytable
 ...
 WHERE version       = '&_enfinityVersion'
   AND cartridgename = '&_cartridge'
   AND (
               tablename LIKE 'COMPANYPROFILE'
            OR tablename LIKE 'COMPANYPROFILE_AV'
            OR tablename LIKE 'CUSTOMER'
            OR tablename LIKE 'CUSTOMER_AV'
            OR tablename LIKE 'CUSTOMERPROFILEASSIGNMENT'
       )
/
