...
public final class UserGroupsExport_jsp extends com.intershop.beehive.core.internal.template.AbstractTemplate
...
setEncodingType("text/xml"); 
 ...
 while (loop("UserGroups","UserGroup",null)) { 
      out.write("\n\t\t\t\t<user-group id=\"");
      out.print(context.getFormattedValue(stringToXml(context.getFormattedValue(getObject("UserGroup:ID"),null)),null));
      out.write('"');
 _boolean_result=false;try {_boolean_result=((Boolean)((disableErrorMessages().isDefined(getObject("ExportDomainRefs"))))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",14,e);}if (_boolean_result) { 
      out.write(" domain=\"");
      out.print(context.getFormattedValue(stringToXml(context.getFormattedValue(getObject("UserGroup:Domain:DomainName"),null)),null));
      out.write('"');
 } 
      out.write("/>\n\t\t\t");
 } 
 ...
 while (loop("UserGroups","UserGroup",null)) { 
      ...
      out.write("<user-groups>");

				}
				
      out.write("<user-group id=\"");
      out.print(context.getFormattedValue(stringToXml(context.getFormattedValue(getObject("UserGroup:ID"),null)),null));
      out.write('"');
 _boolean_result=false;try {_boolean_result=((Boolean)((disableErrorMessages().isDefined(getObject("ExportDomainRefs"))))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",38,e);}if (_boolean_result) { 
      out.write(" domain=\"");
      out.print(context.getFormattedValue(stringToXml(context.getFormattedValue(getObject("UserGroup:Domain:DomainName"),null)),null));
      out.write('"');
 } 
