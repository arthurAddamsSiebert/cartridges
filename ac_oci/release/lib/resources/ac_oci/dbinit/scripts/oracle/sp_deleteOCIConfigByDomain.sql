CREATE OR REPLACE PROCEDURE sp_deleteOCIConfigByDomain (domainID IN VARCHAR2)

------------------------------------------------------------------------------------------
-- Name        : deleteOCIConfigByDomain
...
BEGIN
    ...
    sp_genStagPoAvDeleteByDomain('OCIConfiguration', 'OCIConfiguration_AV', domainID, 'domainid');

    commit;

END sp_deleteOCIConfigByDomain;
/
