...
public final class SMCScheduleAttributes_jsp extends com.intershop.beehive.core.internal.template.AbstractTemplate
...
setEncodingType("text/html"); 
 ...
 {out.write(localizeISText("smc.Scheduling.link","",null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("</a>&nbsp;&gt;&nbsp;");
 {String value = null;try{value=context.getFormattedValue(getObject("Schedule:Name"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {12}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
      out.write("&nbsp;-&nbsp;");
 ...
 {out.flush();processLocalIncludeByServer((com.intershop.beehive.core.capi.request.ServletResponse)response,"SMCScheduleTabs", null, "23");} 
      out.write("</td>\n</tr>\n<tr>\n<td>\n<!-- Custom Attributes -->");
...
new TagParameter("Title2",localizeText(context.getFormattedValue("smc.NewAttribute.Title2",null)))}, 29); 
