...
public final class monitor_005fperformancemonitoring_005fmain_jsp extends com.intershop.beehive.core.internal.template.AbstractTemplate
...
new TagParameter("modulo","2")}, 5); 
 ...
 {out.write(localizeISText("monitor.Performance.overview_title","",null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("</td>\n</tr>\n<tr>\n<td colspan=\"5\" class=\"table_title_description\">");
 {out.write(localizeISText("monitor_performancemonitoring_main.MeasurementOfPipelinePerformance.table_title_description","",null,null,null,null,null,null,null,null,null,null,null));} 
      ...
      out.print(context.getFormattedValue(url(true,(new URLPipelineAction(context.getFormattedValue("ViewProfilingMode-Start",null)))),null));
 ...
 {out.write(localizeISText("monitor_performancemonitoring_main.PageDisplaysStatusOfPerformanceMonitor.overview_title_description","",null,null,null,null,null,null,null,null,null,null,null));} 
...
new TagParameter("name","count")}, 39); 
 _boolean_result=false;try {_boolean_result=((Boolean)((( ((Number) getObject("count")).doubleValue() ==((Number)(new Double(0))).doubleValue()) ? Boolean.TRUE : Boolean.FALSE))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",40,e);}if (_boolean_result) { 
      ...
      out.print(context.getFormattedValue(context.webRoot(),null));
      out.write("/images/arrow_right_down.gif\" width=\"9\" height=\"9\" alt=\"\" border=\"0\"/></td>\n<td class=\"overview_subtitle\" nowrap=\"nowrap\" width=\"100%\"><a href=\"");
      out.print(context.getFormattedValue(url(true,(new URLPipelineAction(context.getFormattedValue("ViewPerformanceComparison-Start",null)))),null));
      out.write("\" class=\"overview_subtitle\">");
 {out.write(localizeISText("monitor.ComparePerformanceMonitoringResults.link","",null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("</a></td>\n</tr>\n<tr>\n<td colspan=\"2\" class=\"overview_title_description\" valign=\"top\">");
 {out.write(localizeISText("monitor_performancemonitoring_main.PageDisplaysMonitorDiff.overview_title_description","",null,null,null,null,null,null,null,null,null,null,null));} 
      out.write(" <br/>&nbsp;</td>\n</tr>\n<tr>\n<td colspan=\"2\" class=\"overview_line\"><img src=\"");
      out.print(context.getFormattedValue(context.webRoot(),null));
      out.write("/images/space.gif\" width=\"2\" height=\"1\" alt=\"\" border=\"0\"/></td>\n</tr>\n</table>\n</td>");
 processOpenTag(response, pageContext, "seq-next", new TagParameter[] {
new TagParameter("name","count")}, 58); 
 _boolean_result=false;try {_boolean_result=((Boolean)((( ((Number) getObject("count")).doubleValue() ==((Number)(new Double(0))).doubleValue()) ? Boolean.TRUE : Boolean.FALSE))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",59,e);}if (_boolean_result) { 
      ...
      out.print(context.getFormattedValue(context.webRoot(),null));
      out.write("/images/arrow_right_down.gif\" width=\"9\" height=\"9\" alt=\"\" border=\"0\"/></td>\n<td class=\"overview_subtitle\" nowrap=\"nowrap\" width=\"100%\"><a href=\"");
      out.print(context.getFormattedValue(url(true,(new URLPipelineAction(context.getFormattedValue("ViewPipelinePerformance-Start",null)))),null));
      out.write("\" class=\"overview_subtitle\">");
 {out.write(localizeISText("monitor_performancemonitoring_main.PerformanceByApplicationAndRequest.link","",null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("</a></td>\n</tr>\n<tr>\n<td colspan=\"2\" class=\"overview_title_description\" valign=\"top\">");
 {out.write(localizeISText("monitor_performancemonitoring_main.PageDisplaysApplicationPerformance.overview_title_description","",null,null,null,null,null,null,null,null,null,null,null));} 
      out.write(" <br/>&nbsp;</td>\n</tr>\n<tr>\n<td colspan=\"2\" class=\"overview_line\"><img src=\"");
      out.print(context.getFormattedValue(context.webRoot(),null));
      out.write("/images/space.gif\" width=\"2\" height=\"1\" alt=\"\" border=\"0\"/></td>\n</tr>\n</table>\n</td>");
 processOpenTag(response, pageContext, "seq-next", new TagParameter[] {
new TagParameter("name","count")}, 78); 
 _boolean_result=false;try {_boolean_result=((Boolean)((( ((Number) getObject("count")).doubleValue() ==((Number)(new Double(0))).doubleValue()) ? Boolean.TRUE : Boolean.FALSE))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",79,e);}if (_boolean_result) { 
      ...
      out.print(context.getFormattedValue(context.webRoot(),null));
      out.write("/images/arrow_right_down.gif\" width=\"9\" height=\"9\" alt=\"\" border=\"0\"/></td>\n<td class=\"overview_subtitle\" nowrap=\"nowrap\" width=\"100%\"><a href=\"");
      out.print(context.getFormattedValue(url(true,(new URLPipelineAction(context.getFormattedValue("ViewPerformanceByType-Start",null)))),null));
      out.write("\" class=\"overview_subtitle\">");
 {out.write(localizeISText("monitor_performancemonitoring_main.PerformanceByType.link","",null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("</a></td>\n</tr>\n<tr>\n<td colspan=\"2\" class=\"overview_title_description\" valign=\"top\">");
 {out.write(localizeISText("monitor_performancemonitoring_main.PageDisplaysPerformanceOfType.overview_title_description1","",null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("<br/>&nbsp;</td>\n</tr>\n<tr>\n<td colspan=\"2\" class=\"overview_line\"><img src=\"");
      out.print(context.getFormattedValue(context.webRoot(),null));
      out.write("/images/space.gif\" width=\"2\" height=\"1\" alt=\"\" border=\"0\"/></td>\n</tr>\n</table>\n</td>");
 processOpenTag(response, pageContext, "seq-next", new TagParameter[] {
new TagParameter("name","count")}, 95); 
