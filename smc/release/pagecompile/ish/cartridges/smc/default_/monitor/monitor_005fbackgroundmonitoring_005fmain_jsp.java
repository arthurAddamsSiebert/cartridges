...
public final class monitor_005fbackgroundmonitoring_005fmain_jsp extends com.intershop.beehive.core.internal.template.AbstractTemplate
...
new TagParameter("modulo","2")}, 5); 
 ...
 {out.write(localizeISText("monitor.Background.overview_title","",null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("</td>\n</tr>\n<tr>\n<td colspan=\"5\" class=\"table_title_description\">");
 {out.write(localizeISText("monitor_backgroundmonitoring_main.ShowsInformationMonitoredInTheBackground.table_title_description","",null,null,null,null,null,null,null,null,null,null,null));} 
      ...
      out.print(context.getFormattedValue(url(true,(new URLPipelineAction(context.getFormattedValue("ViewBackgroundMonitoringStatus-View",null)))),null));
 ...
 {out.write(localizeISText("monitor_backgroundmonitoring_main.PageDisplaysCurrentMonitoringStatus.overview_title_description","",null,null,null,null,null,null,null,null,null,null,null));} 
...
new TagParameter("name","count")}, 36); 
 _boolean_result=false;try {_boolean_result=((Boolean)((( ((Number) getObject("count")).doubleValue() ==((Number)(new Double(0))).doubleValue()) ? Boolean.TRUE : Boolean.FALSE))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",37,e);}if (_boolean_result) { 
      ...
      out.print(context.getFormattedValue(context.webRoot(),null));
      out.write("/images/arrow_right_down.gif\" width=\"9\" height=\"9\" alt=\"\" border=\"0\"/></td>\n<td class=\"overview_subtitle\" nowrap=\"nowrap\" width=\"100%\"><a href=\"");
      out.print(context.getFormattedValue(url(true,(new URLPipelineAction(context.getFormattedValue("ViewChart-Memory",null)))),null));
      out.write("\" class=\"overview_subtitle\">");
 {out.write(localizeISText("monitor.MemoryCharts.link","",null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("</a></td>\n</tr>\n<tr>\n<td colspan=\"2\" class=\"overview_title_description\" valign=\"top\">");
 {out.write(localizeISText("monitor.PageDisplaysMemoryUsageInformation.overview_title_description","",null,null,null,null,null,null,null,null,null,null,null));} 
      out.write(" <br/>&nbsp;</td>\n</tr>\n<tr>\n<td colspan=\"2\" class=\"overview_line\"><img src=\"");
      out.print(context.getFormattedValue(context.webRoot(),null));
      out.write("/images/space.gif\" width=\"2\" height=\"1\" alt=\"\" border=\"0\"/></td>\n</tr>\n</table>\n</td>");
 processOpenTag(response, pageContext, "seq-next", new TagParameter[] {
new TagParameter("name","count")}, 53); 
 _boolean_result=false;try {_boolean_result=((Boolean)((( ((Number) getObject("count")).doubleValue() ==((Number)(new Double(0))).doubleValue()) ? Boolean.TRUE : Boolean.FALSE))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",54,e);}if (_boolean_result) { 
      ...
      out.print(context.getFormattedValue(context.webRoot(),null));
      out.write("/images/arrow_right_down.gif\" width=\"9\" height=\"9\" alt=\"\" border=\"0\"/></td>\n<td class=\"overview_subtitle\" nowrap=\"nowrap\" width=\"100%\"><a href=\"");
      out.print(context.getFormattedValue(url(true,(new URLPipelineAction(context.getFormattedValue("ViewChart-Session",null)))),null));
      out.write("\" class=\"overview_subtitle\">");
 {out.write(localizeISText("monitor.SessionCharts.link","",null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("</a></td>\n</tr>\n<tr>\n<td colspan=\"2\" class=\"overview_title_description\" valign=\"top\">");
 {out.write(localizeISText("monitor.PageDisplaysSessionInformation.overview_title_description","",null,null,null,null,null,null,null,null,null,null,null));} 
      out.write(" <br/>&nbsp;</td>\n</tr>\n<tr>\n<td colspan=\"2\" class=\"overview_line\"><img src=\"");
      out.print(context.getFormattedValue(context.webRoot(),null));
      out.write("/images/space.gif\" width=\"2\" height=\"1\" alt=\"\" border=\"0\"/></td>\n</tr>\n</table>\n</td>");
 processOpenTag(response, pageContext, "seq-next", new TagParameter[] {
new TagParameter("name","count")}, 70); 
 _boolean_result=false;try {_boolean_result=((Boolean)((( ((Number) getObject("count")).doubleValue() ==((Number)(new Double(0))).doubleValue()) ? Boolean.TRUE : Boolean.FALSE))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",71,e);}if (_boolean_result) { 
      ...
      out.print(context.getFormattedValue(context.webRoot(),null));
      out.write("/images/arrow_right_down.gif\" width=\"9\" height=\"9\" alt=\"\" border=\"0\"/></td>\n<td class=\"overview_subtitle\" nowrap=\"nowrap\" width=\"100%\"><a href=\"");
      out.print(context.getFormattedValue(url(true,(new URLPipelineAction(context.getFormattedValue("ViewChart-Performance",null)))),null));
      out.write("\" class=\"overview_subtitle\">");
 {out.write(localizeISText("monitor.PerformanceCharts.link","",null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("</a></td>\n</tr>\n<tr>\n<td colspan=\"2\" class=\"overview_title_description\" valign=\"top\">");
 {out.write(localizeISText("monitor.PageDisplaysDetailedPerformanceInformation.overview_title_description","",null,null,null,null,null,null,null,null,null,null,null));} 
      out.write(" <br/>&nbsp;</td>\n</tr>\n<tr>\n<td colspan=\"2\" class=\"overview_line\"><img src=\"");
      out.print(context.getFormattedValue(context.webRoot(),null));
      out.write("/images/space.gif\" width=\"2\" height=\"1\" alt=\"\" border=\"0\"/></td>\n</tr>\n</table>\n</td>");
 processOpenTag(response, pageContext, "seq-next", new TagParameter[] {
