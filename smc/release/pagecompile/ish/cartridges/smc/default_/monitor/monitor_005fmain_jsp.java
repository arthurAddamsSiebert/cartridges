...
public final class monitor_005fmain_jsp extends com.intershop.beehive.core.internal.template.AbstractTemplate
...
setEncodingType("text/html"); 
 ...
 {out.write(localizeISText("monitor_main.ClusterOverview.table_title","",null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("</td>\n</tr>\n<tr>\n<td class=\"table_title_description w e\">");
 {out.write(localizeISText("monitor_main.PageProvidesOverviewOfRunningServers.table_title_description",null,null,url(true,(new URLPipelineAction(context.getFormattedValue("PerformLogout-GlobalLogout",null)))),"table_title_description",null,null,null,null,null,null,null,null));} 
 ...
 {out.write(localizeISText("monitor.InstallationID.table_header","",null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("</td>\n<td class=\"table_header s e\" nowrap=\"nowrap\">");
 {out.write(localizeISText("monitor_main.PID.table_header","",null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("</td>\n<td class=\"table_header s e\" nowrap=\"nowrap\">");
 {out.write(localizeISText("monitor_main.StartedAt.table_header","",null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("</td>\n<td class=\"table_header s e\" nowrap=\"nowrap\">");
 {out.write(localizeISText("monitor_main.CPUUsage.table_header","",null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("</td>\n<td class=\"table_header s e\" nowrap=\"nowrap\">");
 {out.write(localizeISText("monitor_main.HeapUsage.table_header","",null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("</td>\n<td class=\"table_header s e\" nowrap=\"nowrap\">");
 {out.write(localizeISText("monitor_main.MemoryUsage.table_header","",null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("</td>\n<td class=\"table_header s\" nowrap=\"nowrap\">");
 {out.write(localizeISText("monitor_main.ActiveSessions.table_header","",null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("</td>\n</tr>");
...
finally
{
 ...
 {String value = null;try{value=context.getFormattedValue(getObject("TargetServer:Port"),"#",null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {31}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
      out.write("&nbsp;</td>\n<td class=\"table_detail e\" valign=\"top\">");
 ...
 {out.write(localizeISText("monitor.NA.table_detail","",null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("&nbsp;</td>\n<td class=\"table_detail e\" valign=\"top\">");
 {String value = null;try{value=context.getFormattedValue(getObject("TargetServer:StartDate"),"MM/dd/yyyy - HH:mm:ss",null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {34}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
      out.write("&nbsp;</td>\n<td class=\"table_detail e\" valign=\"top\" align=\"right\">");
 {out.write(localizeISText("monitor.NA.table_detail","",null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("&nbsp;</td>\n<td class=\"table_detail e\" valign=\"top\" align=\"right\">");
 {out.write(localizeISText("monitor.NA.table_detail","",null,null,null,null,null,null,null,null,null,null,null));} 
