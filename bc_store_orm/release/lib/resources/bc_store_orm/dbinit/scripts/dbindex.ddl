...
EXEC staging_ddl.create_index('STORE_AK001', 'STORE', '(storeID,domainID)', :table_space, 'UNIQUE', :recreate_indexes)

PROMPT -- Inversion Entry key indices


PROMPT /* Class com.intershop.component.store.orm.internal.orm.StorePOAttributeValue */
PROMPT -- Foreign key indices
EXEC staging_ddl.create_index('STORE_AV_FK002', 'STORE_AV', '(ownerID)', :table_space, 'NONUNIQUE', :recreate_indexes)

PROMPT -- Inversion Entry key indices
EXEC staging_ddl.create_index('STORE_AV_IE002', 'STORE_AV', '(intValue)', :table_space, 'NONUNIQUE', :recreate_indexes)
EXEC staging_ddl.create_index('STORE_AV_IE003', 'STORE_AV', '(doubleValue)', :table_space, 'NONUNIQUE', :recreate_indexes)
