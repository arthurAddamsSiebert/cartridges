...
var groupID = '<% {String value = null;try{value=context.getFormattedValue(getObject("UIPropertyGroup:ID"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {58}",e);}if (value==null) value="";value = encodeString(value,"javascript");out.write(value);} %>',
$el = id$(groupID),
$form = $el.closest('form'),
json = $.parseJSON("<% {String value = null;try{value=context.getFormattedValue(getObject("json"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {61}",e);}if (value==null) value="";value = encodeString(value,"javascript");out.write(value);} %>"),
Controller = intershop.propertygroups.ui.Controller,
propertyGroup = Controller.fromJSON(json),
propertyGroupHandlerName= 'propertygroups_'+'<% {String value = null;try{value=context.getFormattedValue(getObject("formfieldname"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {64}",e);}if (value==null) value="";value = encodeString(value,"javascript");out.write(value);} %>';
...
$form.find('input[name="<% {String value = null;try{value=context.getFormattedValue(getObject("formfieldname"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {101}",e);}if (value==null) value="";value = encodeString(value,"javascript");out.write(value);} %>"]').remove();
$($.parseHTML('<input type="hidden" name="<% {String value = null;try{value=context.getFormattedValue(getObject("formfieldname"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {102}",e);}if (value==null) value="";value = encodeString(value,"javascript");out.write(value);} %>" />'))
