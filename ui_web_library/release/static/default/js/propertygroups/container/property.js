...
!function (global, utils, $) {
    var ui = utils.namespace('intershop.propertygroups.ui'),
        ...
        template = '' + 
        '<div class="propertygroup-property">' +
            '<div class="propertygroup-property-label">' +
            ...
            '<div class="propertygroup-property-content"></div>' +
            '<div class="propertygroup-property-error"></div>' +
            '<div class="propertygroup-property-description"></div>' +
        '</div>';
    ...
    Property.prototype.render = function render() {
        ...
        if (this.mandatory && !this.subPropertyGroup) {
            $label.text(this.displayName).append('<span class="star">*</span>');
        }
        else {
        ...
        if (this.hidden != 'never') {
            if (this.editor.elementID != '')
            {
                $content.prop('id', this.editor.elementID);
            }
        ...
        if (this.invalid) {
            $el.addClass('propertygroup-property-invalid');
        }
        if (this.description) {
            if (this.subPropertyGroup) {
