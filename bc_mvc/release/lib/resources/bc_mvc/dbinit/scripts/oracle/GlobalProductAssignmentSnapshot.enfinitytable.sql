...
USING (SELECT 'IEPRODUCTCATEGORYASSI$1' AS tableName, 'bc_mvc' AS cartridgeName, '&_enfinityVersion' AS version FROM dual UNION
       SELECT 'IEPRODUCTCATEGORYASSI$2' AS tableName, 'bc_mvc' AS cartridgeName, '&_enfinityVersion' AS version FROM dual
      ) s
