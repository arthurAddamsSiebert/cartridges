...
-- //{{ index
EXEC staging_ddl.create_index('CATALOG_CI001', 'CATALOG', '(id, domainID)', :table_space, 'UNIQUE', :recreate_indexes);

EXEC staging_ddl.create_index('CLASSIFICATIONSYSTEM_CI001', 'CLASSIFICATIONSYSTEM', '(name, domainID)', :table_space, 'UNIQUE', :recreate_indexes)
-- //}} index
