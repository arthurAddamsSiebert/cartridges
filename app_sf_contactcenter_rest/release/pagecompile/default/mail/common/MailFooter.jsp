...
<tr>
<td class="footerImprint"><% {out.write(localizeISText("email.legal_notice.message",null,null,url(true,(new URLPipelineAction(context.getFormattedValue("ViewContent-Start",null))),(new URLParameterSet().addURLParameter(context.getFormattedValue("PageletEntryPointID",null),context.getFormattedValue("systempage.termsAndConditions.pagelet2-Page",null)))),null,null,null,null,null,null,null,null,null));} %></td>
</tr>
</table>
</td>
</tr>
