...
EXEC staging_ddl.create_index('PRICESCALETABLEASSIG_IE500', 'PRICESCALETABLEASSIGNMENT', '(PRICELISTUUID,PRODUCTUUID,PRICESCALETABLEUUID,DOMAINID)', :table_space, 'NONUNIQUE', :recreate_indexes)
-- //}} index
