...
public final class PartnerColumns_jsp extends com.intershop.beehive.core.internal.template.AbstractTemplate
...
setEncodingType("text/javascript"); 
 ...
 {String value = null;try{value=context.getFormattedValue(getObject("params:AvailableItemsName"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {19}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
      ...
      out.write("\nname: {\ntype: 'text',\ndataKey: 'name',\ntitle: '");
 {out.write(localizeISText("PartnerColumns.Name",null,null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("',\nsortable: true\n},\nnamelink: {\ntype: 'link',\ndataKey: 'name',\ntitle: '");
 {out.write(localizeISText("PartnerColumns.Name",null,null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("',\nurl: '");
 {String value = null;try{value=context.getFormattedValue(context.getFormattedValue(url(true,(new URLPipelineAction(context.getFormattedValue("ViewChannel-Edit",null)))),null) + context.getFormattedValue("?RepositoryUUID={uuid}",null),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {32}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
      out.write("',\nparams: ['uuid'],\nsortable: true\n},\nid: {\ntype: 'text',\ndataKey: 'id',\ntitle: '");
 {out.write(localizeISText("PartnerColumns.ID",null,null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("',\nsortable: true\n},\nidlink: {\ntype: 'link',\ndataKey: 'id',\ntitle: '");
 {out.write(localizeISText("PartnerColumns.ID",null,null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("',\nurl: '");
