...
public final class NewProductGrantedBonusPointsMappingRule_005f32_jsp extends com.intershop.beehive.core.internal.template.AbstractTemplate
...
new TagParameter("text1",context.getFormattedValue(" - ",null) + context.getFormattedValue(localizeText(context.getFormattedValue("NewProductGrantedBonusPointsMappingRule_32.MappingRules.text1",null)),null)),
...
new TagParameter("text",localizeText(context.getFormattedValue("NewProductGrantedBonusPointsMappingRule_32.GrantedBonusPoints.text",null)))}, 6); 
      out.write("<table border=\"0\" cellspacing=\"0\" cellpadding=\"0\" width=\"100%\">\n<tr>\n<td>");
 URLPipelineAction action238 = new URLPipelineAction(context.getFormattedValue(url(true,(new URLPipelineAction(context.getFormattedValue("ViewProductPriceMapping_32-Dispatch",null)))),null));String site238 = null;String serverGroup238 = null;String actionValue238 = context.getFormattedValue(url(true,(new URLPipelineAction(context.getFormattedValue("ViewProductPriceMapping_32-Dispatch",null)))),null);if (site238 == null){  site238 = action238.getDomain();  if (site238 == null)  {      site238 = com.intershop.beehive.core.capi.request.Request.getCurrent().getRequestSite().getDomainName();  }}if (serverGroup238 == null){  serverGroup238 = action238.getServerGroup();  if (serverGroup238 == null)  {      serverGroup238 = com.intershop.beehive.core.capi.request.Request.getCurrent().getRequestSite().getServerGroup();  }}out.print("<form");out.print(" method=\"");out.print("post");out.print("\"");out.print(" action=\"");out.print(context.getFormattedValue(url(true,(new URLPipelineAction(context.getFormattedValue("ViewProductPriceMapping_32-Dispatch",null)))),null));out.print("\"");out.print(" name=\"");out.print("detailForm");out.print("\"");out.print(">");out.print(context.prepareWACSRFTag(actionValue238, site238, serverGroup238,true)); 
