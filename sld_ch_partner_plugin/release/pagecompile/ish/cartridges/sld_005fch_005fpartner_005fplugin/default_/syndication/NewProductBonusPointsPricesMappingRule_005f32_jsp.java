...
public final class NewProductBonusPointsPricesMappingRule_005f32_jsp extends com.intershop.beehive.core.internal.template.AbstractTemplate
...
new TagParameter("text",localizeText(context.getFormattedValue("NewProductBonusPointsPricesMappingRule_32.BonusPointsPrice.text",null)))}, 6); 
      out.write("<table border=\"0\" cellspacing=\"0\" cellpadding=\"0\" width=\"100%\">\n<tr>\n<td>");
 URLPipelineAction action236 = new URLPipelineAction(context.getFormattedValue(url(true,(new URLPipelineAction(context.getFormattedValue("ViewProductPriceMapping_32-Dispatch",null)))),null));String site236 = null;String serverGroup236 = null;String actionValue236 = context.getFormattedValue(url(true,(new URLPipelineAction(context.getFormattedValue("ViewProductPriceMapping_32-Dispatch",null)))),null);if (site236 == null){  site236 = action236.getDomain();  if (site236 == null)  {      site236 = com.intershop.beehive.core.capi.request.Request.getCurrent().getRequestSite().getDomainName();  }}if (serverGroup236 == null){  serverGroup236 = action236.getServerGroup();  if (serverGroup236 == null)  {      serverGroup236 = com.intershop.beehive.core.capi.request.Request.getCurrent().getRequestSite().getServerGroup();  }}out.print("<form");out.print(" method=\"");out.print("post");out.print("\"");out.print(" action=\"");out.print(context.getFormattedValue(url(true,(new URLPipelineAction(context.getFormattedValue("ViewProductPriceMapping_32-Dispatch",null)))),null));out.print("\"");out.print(" name=\"");out.print("detailForm");out.print("\"");out.print(">");out.print(context.prepareWACSRFTag(actionValue236, site236, serverGroup236,true)); 
