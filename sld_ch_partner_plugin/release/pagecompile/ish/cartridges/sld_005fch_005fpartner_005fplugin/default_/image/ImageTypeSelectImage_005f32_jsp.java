...
public final class ImageTypeSelectImage_005f32_jsp extends com.intershop.beehive.core.internal.template.AbstractTemplate
...
new TagParameter("text",localizeText(context.getFormattedValue("ImageTypeSelectImage_32.SelectImage.text",null)))}, 5); 
 ...
 {out.write(localizeISText("ImageTypeSelectImage_32.SelectDefaultImage.table_title",null,null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("</td>\n</tr>");
...
new TagParameter("message",localizeText(context.getFormattedValue("ImageTypeSelectImage_32.PleaseSelectAnImage.message",null)))}, 13); 
 ...
 {out.write(localizeISText("ImageTypeSelectImage_32.SelectLanguage.infobox_item",null,null,null,null,null,null,null,null,null,null,null,null));} 
 ...
 {String value = null;try{value=context.getFormattedValue(getObject("Locales:getDisplayName(CurrentSession:Locale)"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {38}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
      ...
      out.print(context.getFormattedValue(localizeText(context.getFormattedValue("ImageTypeSelectImage_32.Apply.button",null)),null));
...
new TagParameter("parametervalue8",getObject("LocaleId"))}, 58); 
 ...
 {out.write(localizeISText("ImageTypeSelectImage_32.ImageSearch.infobox_title",null,null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("</td></tr>\n</table>\n<table border=\"0\" cellpadding=\"0\" cellspacing=\"1\" width=\"100%\" class=\"infobox w e s\">\n<tr>\n<td class=\"infobox_item left\" width=\"100%\">\n<table width=\"80%\">\n<tr>\n<td class=\"infobox_item\" nowrap=\"nowrap\">&nbsp;");
 {out.write(localizeISText("ImageTypeSelectImage_32.Name.infobox_item",null,null,null,null,null,null,null,null,null,null,null,null));} 
 ...
 {String value = null;try{value=context.getFormattedValue(getObject("Expression"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {98}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
      ...
      out.print(context.getFormattedValue(localizeText(context.getFormattedValue("ImageTypeSelectImage_32.Search.button",null)),null));
...
new TagParameter("FilesIterator",getObject("Files"))}, 115); 
 ...
 {out.write(localizeISText("ImageTypeSelectImage_32.ThisDirectoryDoesNotContainAnyImages.table_detail",null,null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("</td></tr>\n</table>");
 } 
 ...
 _boolean_result=false;try {_boolean_result=((Boolean)(((((Boolean) (hasLoopElements("Directory:Files") ? Boolean.TRUE : Boolean.FALSE)).booleanValue() && ((Boolean) (hasLoopElements("Files") ? Boolean.TRUE : Boolean.FALSE)).booleanValue()) ? Boolean.TRUE : Boolean.FALSE))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",130,e);}if (_boolean_result) { 
      ...
      out.print(context.getFormattedValue(localizeText(context.getFormattedValue("ImageTypeSelectImage_32.OK.button",null)),null));
      out.write("\" class=\"button\"/></td>");
 } 
      out.write("<td class=\"button\"><input type=\"submit\" name=\"cancelImageSelection\" value=\"");
      out.print(context.getFormattedValue(localizeText(context.getFormattedValue("ImageTypeSelectImage_32.Cancel.button",null)),null));
      out.write("\" class=\"button\"/></td>\n</tr>\n</table>\n</td>\n</tr>\n</table>\n<div><img src=\"");
      out.print(context.getFormattedValue(context.webRoot(),null));
