...
public final class ReplicationTaskHistory_005f32_jsp extends com.intershop.beehive.core.internal.template.AbstractTemplate
...
new TagParameter("text",getObject("ReplicationTask:TaskID"))}, 3); 
 ...
 {String value = null;try{value=context.getFormattedValue(getObject("ReplicationTask:TaskID"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {18}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
      ...
      out.write('-');
      out.write(' ');
 {out.write(localizeISText("ReplicationTaskHistory_32.StatusHistory.table_title",null,null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("</td>\n</tr>\n<tr>\n<td class=\"e w\"><img src=\"");
      out.print(context.getFormattedValue(context.webRoot(),null));
      out.write("/images/space.gif\" width=\"1\" height=\"1\" border=\"0\" alt=\"\"/></td>\n</tr>\n</table>");
 URLPipelineAction action132 = new URLPipelineAction(context.getFormattedValue(url(true,(new URLPipelineAction(context.getFormattedValue("ViewReplicationTask_32-Dispatch",null)))),null));String site132 = null;String serverGroup132 = null;String actionValue132 = context.getFormattedValue(url(true,(new URLPipelineAction(context.getFormattedValue("ViewReplicationTask_32-Dispatch",null)))),null);if (site132 == null){  site132 = action132.getDomain();  if (site132 == null)  {      site132 = com.intershop.beehive.core.capi.request.Request.getCurrent().getRequestSite().getDomainName();  }}if (serverGroup132 == null){  serverGroup132 = action132.getServerGroup();  if (serverGroup132 == null)  {      serverGroup132 = com.intershop.beehive.core.capi.request.Request.getCurrent().getRequestSite().getServerGroup();  }}out.print("<form");out.print(" method=\"");out.print("post");out.print("\"");out.print(" action=\"");out.print(context.getFormattedValue(url(true,(new URLPipelineAction(context.getFormattedValue("ViewReplicationTask_32-Dispatch",null)))),null));out.print("\"");out.print(" name=\"");out.print("dispatch");out.print("\"");out.print(">");out.print(context.prepareWACSRFTag(actionValue132, site132, serverGroup132,true)); 
 ...
 {out.write(localizeISText("ReplicationTaskHistory_32.NewStatus.table_header",null,null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("&nbsp;</td>\n<td class=\"table_header e s\" nowrap=\"nowrap\">");
 {out.write(localizeISText("ReplicationTaskHistory_32.ChangedBy.table_header",null,null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("&nbsp;</td>\n<td class=\"table_header e s\" nowrap=\"nowrap\">");
 {out.write(localizeISText("ReplicationTaskHistory_32.ChangeTime.table_header",null,null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("&nbsp;</td>\n</tr>");
...
new TagParameter("state",getObject("entry:NewState"))}, 39); 
 ...
 {out.write(localizeISText("ReplicationTaskHistory_32.NoStatusHistoryEntries.table_detail",null,null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("</td>\n</tr>");
 } 
      out.write("</table>\n<!-- Start Page Cursor -->\n<table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\">\n<tr> \n<td>");
