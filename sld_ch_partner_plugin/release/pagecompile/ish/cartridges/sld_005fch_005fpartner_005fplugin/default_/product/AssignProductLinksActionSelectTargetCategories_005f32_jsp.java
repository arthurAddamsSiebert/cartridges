...
public final class AssignProductLinksActionSelectTargetCategories_005f32_jsp extends com.intershop.beehive.core.internal.template.AbstractTemplate
...
setEncodingType("text/html"); 
      out.write("<!-- Working Area -->\n<!--AssignProductLinksActionSelectCategories_32.isml-->\n<!-- Page Navigator -->");
...
new TagParameter("text",localizeText(context.getFormattedValue("AssignProductLinksActionSelectTargetCategories_32.Step2AssignProductCategoryLinksSelectLinkType.text",null))),
new TagParameter("id","SelectLinkType")}, 7); 
 processOpenTag(response, pageContext, "breadcrumbtrail", new TagParameter[] {
new TagParameter("listview","true"),
new TagParameter("link",url(true,(new URLPipelineAction(context.getFormattedValue("ViewProductProcessingWizard_32-Dispatch",null))),(new URLParameterSet().addURLParameter(context.getFormattedValue("ActionID",null),context.getFormattedValue("AssignProductLinks",null))).addURLParameter(context.getFormattedValue("LinkTarget",null),context.getFormattedValue(getObject("LinkTarget"),null)).addURLParameter(context.getFormattedValue("CategoryLinkType",null),context.getFormattedValue(getObject("CategoryLinkType"),null)).addURLParameter(context.getFormattedValue("ProductLinkType",null),context.getFormattedValue(getObject("ProductLinkType"),null)).addURLParameter(context.getFormattedValue("PageableID",null),context.getFormattedValue(getObject("PageableID"),null)).addURLParameter(context.getFormattedValue("linkType",null),context.getFormattedValue("Next >>",null)))),
new TagParameter("wizard","true"),
new TagParameter("text",localizeText(context.getFormattedValue("AssignProductLinksActionSelectTargetCategories_32.Step3AssignProductCategoryLinksSelectCategories.text",null)))}, 18); 
      out.write("<!-- EO Page Navigator -->");
 URLPipelineAction action10 = new URLPipelineAction(context.getFormattedValue(url(true,(new URLPipelineAction(context.getFormattedValue("ViewProductProcessingWizard_32-Dispatch",null)))),null));String site10 = null;String serverGroup10 = null;String actionValue10 = context.getFormattedValue(url(true,(new URLPipelineAction(context.getFormattedValue("ViewProductProcessingWizard_32-Dispatch",null)))),null);if (site10 == null){  site10 = action10.getDomain();  if (site10 == null)  {      site10 = com.intershop.beehive.core.capi.request.Request.getCurrent().getRequestSite().getDomainName();  }}if (serverGroup10 == null){  serverGroup10 = action10.getServerGroup();  if (serverGroup10 == null)  {      serverGroup10 = com.intershop.beehive.core.capi.request.Request.getCurrent().getRequestSite().getServerGroup();  }}out.print("<form");out.print(" method=\"");out.print("post");out.print("\"");out.print(" action=\"");out.print(context.getFormattedValue(url(true,(new URLPipelineAction(context.getFormattedValue("ViewProductProcessingWizard_32-Dispatch",null)))),null));out.print("\"");out.print(" name=\"");out.print("ActionParameterForm");out.print("\"");out.print(">");out.print(context.prepareWACSRFTag(actionValue10, site10, serverGroup10,true)); 
 {out.flush();processLocalIncludeByServer((com.intershop.beehive.core.capi.request.ServletResponse)response,"inc/AssignProductLinksActionSelectTargetCategories", null, "30");} 
 out.print("</form>"); 
