...
new TagParameter("text",localizeText(context.getFormattedValue("ProductHistoryDeletedProductDetails_32.ProductDetails.text",null)))}, 2); %><table border="0" cellpadding="0" cellspacing="0" width="100%">
<tr>
...
<td><% URLPipelineAction action300 = new URLPipelineAction(context.getFormattedValue(url(true,(new URLPipelineAction(context.getFormattedValue("ViewProductHistory_32-Dispatch",null)))),null));String site300 = null;String serverGroup300 = null;String actionValue300 = context.getFormattedValue(url(true,(new URLPipelineAction(context.getFormattedValue("ViewProductHistory_32-Dispatch",null)))),null);if (site300 == null){  site300 = action300.getDomain();  if (site300 == null)  {      site300 = com.intershop.beehive.core.capi.request.Request.getCurrent().getRequestSite().getDomainName();  }}if (serverGroup300 == null){  serverGroup300 = action300.getServerGroup();  if (serverGroup300 == null)  {      serverGroup300 = com.intershop.beehive.core.capi.request.Request.getCurrent().getRequestSite().getServerGroup();  }}out.print("<form");out.print(" method=\"");out.print("post");out.print("\"");out.print(" action=\"");out.print(context.getFormattedValue(url(true,(new URLPipelineAction(context.getFormattedValue("ViewProductHistory_32-Dispatch",null)))),null));out.print("\"");out.print(" name=\"");out.print("deleteForm");out.print("\"");out.print(">");out.print(context.prepareWACSRFTag(actionValue300, site300, serverGroup300,true)); %><table border="0" cellspacing="0" cellpadding="4" width="100%" class="confirm_box w e">
<tr>
<td class="error_icon e">
<img src="<%=context.getFormattedValue(context.webRoot(),null)%>/images/confirmation.gif" width="16" height="15" alt="" border="0"/>
</td>
<td class="error" width="100%"><% {out.write(localizeISText("ProductHistoryDeletedProductDetails_32.AreYouSureThatYouWantToDeleteThisProduct.error",null,null,null,null,null,null,null,null,null,null,null,null));} %></td>
<td>
<table border="0" cellspacing="0" cellpadding="0">
<tr>
<td class="button">
<input type="submit" name="confirmDelete" value="<%=context.getFormattedValue(localizeText(context.getFormattedValue("ProductHistoryDeletedProductDetails_32.OK.button",null)),null)%>" class="button"/>
</td>
<td>&nbsp;</td>
<td class="button">
<input type="hidden" name="ProductID" value="<%=context.getFormattedValue(getObject("Product:UUID"),null)%>"/>
<input type="submit" name="cancelDelete" value="<%=context.getFormattedValue(localizeText(context.getFormattedValue("ProductHistoryDeletedProductDetails_32.Cancel.button",null)),null)%>" class="button"/>
</td>
</tr>
</table>
</td>
...
<tr>
<td class="infobox_item" nowrap="nowrap"><% {out.write(localizeISText("ProductHistoryDeletedProductDetails_32.SelectLanguage.infobox_item",null,null,null,null,null,null,null,null,null,null,null,null));} %>:&nbsp;</td>
<td>
...
<tr>
<td class="button"><input type="submit" name="apply" value="<%=context.getFormattedValue(localizeText(context.getFormattedValue("ProductHistoryDeletedProductDetails_32.Apply.button",null)),null)%>" class="button"/></td>
</tr>
</table>
</td>
</tr>
...
</table><% out.print("</form>"); %><% URLPipelineAction action302 = new URLPipelineAction(context.getFormattedValue(url(true,(new URLPipelineAction(context.getFormattedValue("ViewProductHistory_32-Dispatch",null)))),null));String site302 = null;String serverGroup302 = null;String actionValue302 = context.getFormattedValue(url(true,(new URLPipelineAction(context.getFormattedValue("ViewProductHistory_32-Dispatch",null)))),null);if (site302 == null){  site302 = action302.getDomain();  if (site302 == null)  {      site302 = com.intershop.beehive.core.capi.request.Request.getCurrent().getRequestSite().getDomainName();  }}if (serverGroup302 == null){  serverGroup302 = action302.getServerGroup();  if (serverGroup302 == null)  {      serverGroup302 = com.intershop.beehive.core.capi.request.Request.getCurrent().getRequestSite().getServerGroup();  }}out.print("<form");out.print(" method=\"");out.print("post");out.print("\"");out.print(" action=\"");out.print(context.getFormattedValue(url(true,(new URLPipelineAction(context.getFormattedValue("ViewProductHistory_32-Dispatch",null)))),null));out.print("\"");out.print(" name=\"");out.print("formMask");out.print("\"");out.print(">");out.print(context.prepareWACSRFTag(actionValue302, site302, serverGroup302,true)); %><table border="0" cellspacing="0" cellpadding="0" width="100%">
<tr>
<td class="table_header w e s"><% {out.write(localizeISText("ProductHistoryDeletedProductDetails_32.StandardProductAttributes.table_header",null,null,null,null,null,null,null,null,null,null,null,null));} %></td>
</tr>
<tr>
<td>
<table border="0" cellspacing="0" cellpadding="0" width="100%" class="w e">
<tr>
<td class="productdetail_item s e" width="50%"><% {out.write(localizeISText("ProductHistoryDeletedProductDetails_32.ProductID.productdetail_item",null,null,null,null,null,null,null,null,null,null,null,null));} %>:</td>
...
<tr>
<td class="productdetail_item s e" width="50%"><% {out.write(localizeISText("ProductHistoryDeletedProductDetails_32.Supplier.productdetail_item",null,null,null,null,null,null,null,null,null,null,null,null));} %>:</td>
...
<tr>
<td class="productdetail_item s e" width="50%"><% {out.write(localizeISText("ProductHistoryDeletedProductDetails_32.SupplierProductID.productdetail_item",null,null,null,null,null,null,null,null,null,null,null,null));} %>:</td>
...
<tr>
<td class="productdetail_item s e" width="50%"><% {out.write(localizeISText("ProductHistoryDeletedProductDetails_32.Manufacturer.productdetail_item",null,null,null,null,null,null,null,null,null,null,null,null));} %>:</td>
...
<tr>
<td class="productdetail_item s e" width="50%"><% {out.write(localizeISText("ProductHistoryDeletedProductDetails_32.ManufacturerProductID.productdetail_item",null,null,null,null,null,null,null,null,null,null,null,null));} %>:</td>
...
<tr>
<td class="productdetail_item s e" width="50%"><% {out.write(localizeISText("ProductHistoryDeletedProductDetails_32.PackingUnit.productdetail_item",null,null,null,null,null,null,null,null,null,null,null,null));} %>:</td>
...
<tr>
<td class="productdetail_item s e" width="50%"><% {out.write(localizeISText("ProductHistoryDeletedProductDetails_32.MinOrderQuantity.productdetail_item",null,null,null,null,null,null,null,null,null,null,null,null));} %>:</td>
...
<tr>
<td class="productdetail_item s e" width="50%"><% {out.write(localizeISText("ProductHistoryDeletedProductDetails_32.StepQuantity.productdetail_item",null,null,null,null,null,null,null,null,null,null,null,null));} %>:</td>
...
<tr>
<td class="productdetail_item s e" width="50%"><% {out.write(localizeISText("ProductHistoryDeletedProductDetails_32.EANUCCCode.productdetail_item",null,null,null,null,null,null,null,null,null,null,null,null));} %>:</td>
...
<td class="table_header s" colspan="2"><% {out.write(localizeISText("ProductHistoryDeletedProductDetails_32.ListPrices.table_header",null,null,null,null,null,null,null,null,null,null,null,null));} %>:</td>
...
<td class="productdetail_value s" width="50%"><% _boolean_result=false;try {_boolean_result=((Boolean)((disableErrorMessages().isDefined(getObject("Product:ListPrice(Currency:Mnemonic):Amount"))))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",141,e);}if (_boolean_result) { %><% {String value = null;try{value=context.getFormattedValue(getObject("Product:ListPrice(Currency:Mnemonic):Amount"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {141}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} %><% } else { %><% {out.write(localizeISText("ProductHistoryDeletedProductDetails_32.NA.productdetail_value",null,null,null,null,null,null,null,null,null,null,null,null));} %><% } %>&nbsp;</td>
...
<tr>
<td class="button">
<input type="submit" name="restore" value="<%=context.getFormattedValue(localizeText(context.getFormattedValue("ProductHistoryDeletedProductDetails_32.Restore.button",null)),null)%>" class="button"/>
<input type="hidden" name="ProductID" value="<%=context.getFormattedValue(getObject("Product:UUID"),null)%>"/>
</td>
<td class="button">
<input type="submit" name="delete" value="<%=context.getFormattedValue(localizeText(context.getFormattedValue("ProductHistoryDeletedProductDetails_32.Delete.button",null)),null)%>" class="button"/>
<input type="hidden" name="ProductID" value="<%=context.getFormattedValue(getObject("Product:UUID"),null)%>"/>
</td>
</tr>
</table>
