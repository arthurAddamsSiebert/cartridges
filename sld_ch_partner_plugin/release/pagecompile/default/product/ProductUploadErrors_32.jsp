...
new TagParameter("message",localizeText(context.getFormattedValue("ProductUploadErrors_32.TheSizeOfTheSelectedFileExceedsTheAllowedFileUploa.message",null)))}, 2); %>
...
new TagParameter("subject","file"),
new TagParameter("type","nse"),
new TagParameter("message",localizeText(context.getFormattedValue("ProductUploadErrors_32.TheSelectedFileCouldNotBeUploadedThisMayBeCausedBy.message",null)))}, 4); %>
...
new TagParameter("subject","file"),
new TagParameter("type","nse"),
new TagParameter("message",localizeText(context.getFormattedValue("ProductUploadErrors_32.TheSelectedFileCouldNotBeUploadedBecauseTheFileLen.message",null)))}, 6); %>
...
new TagParameter("subject","file"),
new TagParameter("type","nse"),
new TagParameter("message",localizeText(context.getFormattedValue("ProductUploadErrors_32.YouHaveNotSelectedAFileToUploadSelect.message",null)))}, 8); %>
<% }}}} %><% printFooter(out); %>