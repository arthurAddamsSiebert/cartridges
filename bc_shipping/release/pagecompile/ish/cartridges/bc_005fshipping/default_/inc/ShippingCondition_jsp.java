...
import com.intershop.component.shipping.internal.shippingrule.*;
import java.util.*;

public final class ShippingCondition_jsp extends com.intershop.beehive.core.internal.template.AbstractTemplate
...
setEncodingType("text/xml"); 
 ...
 _boolean_result=false;try {_boolean_result=((Boolean)(((((Boolean) (disableErrorMessages().isDefined(getObject("shippingcondition:ParentCondition")))).booleanValue() && ((Boolean) (((!(context.getFormattedValue(getObject("shippingcondition:ParentCondition"),null).equals(context.getFormattedValue(getObject("null"),null)))) ? Boolean.TRUE : Boolean.FALSE))).booleanValue()) ? Boolean.TRUE : Boolean.FALSE))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",15,e);}if (_boolean_result) { 
      out.write("\n\t\t<position>");
 {String value = null;try{value=context.getFormattedValue(getObject("shippingcondition:Position"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {16}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
      out.write("</position>\n\t");
 } 
      out.write("\n\t<condition-descriptor-id>");
 {String value = null;try{value=context.getFormattedValue(getObject("shippingcondition:ConditionDescriptorID"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {18}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
      out.write("</condition-descriptor-id>\n\t<operator>");
 {String value = null;try{value=context.getFormattedValue(getObject("shippingcondition:Operator"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {19}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
      out.write("</operator>\n\t<grouping>");
 {String value = null;try{value=context.getFormattedValue(getObject("shippingcondition:GroupingOperator"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {20}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
      out.write("</grouping>\n\t");
