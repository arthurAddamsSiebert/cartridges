...
setEncodingType("text/html"); 
 ...
 {out.write(localizeISText("ShippingMethodCondition.ShippingMethodIsOneOfTheFollowing.table_detail","",null,null,null,null,null,null,null,null,null,null,null));} 
 ...
 {String value = null;try{value=context.getFormattedValue(getObject("SM:DisplayName"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {45}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
      ...
      out.print(context.getFormattedValue(localizeText(context.getFormattedValue("ShippingMethodCondition.Add.button",null)),null));
