...
public final class DisplayRegionAttributeCondition_jsp extends com.intershop.beehive.core.internal.template.AbstractTemplate
...
setEncodingType("text/html"); 
 ...
 {out.write(localizeISText("DisplayRegionAttributeCondition.Region.link","",null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("</a>&nbsp;");
 {out.write(localizeISText("DisplayRegionAttributeCondition.Attribute.link","",null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("&nbsp;<a href=\"");
 {String value = null;try{value=context.getFormattedValue(getObject("ConditionConfigurationURL"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {7}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
      out.write("\" class=\"table_detail_link\">");
 ...
 {out.write(localizeISText("DisplayRegionAttributeCondition.RegionAttribute.link","",null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("&nbsp;");
 {String value = null;try{value=context.getFormattedValue(getObject("Condition:AttributeName"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {7}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
      out.write("&nbsp;");
 } 
 ...
 {out.write(localizeISText("DisplayRegionAttributeCondition.EqualTo.link","",null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("&nbsp;");
 } 
 ...
 {out.write(localizeISText("DisplayRegionAttributeCondition.NotEqualTo.link","",null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("&nbsp;");
 } 
 ...
 {out.write(localizeISText("DisplayRegionAttributeCondition.GreaterThan.link","",null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("&nbsp;");
 } 
 ...
 {out.write(localizeISText("DisplayRegionAttributeCondition.LessThan.link","",null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("&nbsp;");
 } 
 ...
 {out.write(localizeISText("DisplayRegionAttributeCondition.GreaterOrEqualTo.link","",null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("&nbsp;");
 } 
 ...
 {out.write(localizeISText("DisplayRegionAttributeCondition.LessOrEqualTo.link","",null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("&nbsp;");
 } 
 {String value = null;try{value=context.getFormattedValue(getObject("Condition:AttributeValue"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {14}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
      out.write("&nbsp;");
 {String value = null;try{value=context.getFormattedValue(getObject("Condition:AttributeUnit"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {14}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
      out.write("&nbsp;\n</td>\n</tr>\n</table>");
 printFooter(out); 
