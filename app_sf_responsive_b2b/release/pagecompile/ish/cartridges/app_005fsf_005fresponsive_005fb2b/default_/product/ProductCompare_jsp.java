 ...
 */
package ish.cartridges.app_005fsf_005fresponsive_005fb2b.default_.product;
...
response.setHeader(TemplateConstants.PERSONALIZED_HEADER, "1");setEncodingType("text/html"); 
 ...
 _boolean_result=false;try {_boolean_result=((Boolean)((disableErrorMessages().isDefined(getObject("CustomerBO"))))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",6,e);}if (_boolean_result) { 
 {Object temp_obj = (getObject("CustomerBO:Extension(\"PricingPreferences\"):PriceDisplayPreferences")); getPipelineDictionary().put("PriceDisplayPreferences", temp_obj);} 
 } else { 
 {Object temp_obj = (getObject("UserBO:Extension(\"PricingPreferences\"):PriceDisplayPreferences")); getPipelineDictionary().put("PriceDisplayPreferences", temp_obj);} 
 } 
 {out.flush();processLocalIncludeByServer((com.intershop.beehive.core.capi.request.ServletResponse)response,"modules/Modules", null, "12");} 
...
new TagParameter("id","baseMarketing")}, 22); 
      out.write("</div>\n<div class=\"product-list\">\n<h1>");
 {out.write(localizeISText("product.compare.link","",null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("</h1>");
 _boolean_result=false;try {_boolean_result=((Boolean)((hasLoopElements("ProductBOs") ? Boolean.TRUE : Boolean.FALSE))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",29,e);}if (_boolean_result) { 
      out.write("<h2>");
 ...
 _boolean_result=false;try {_boolean_result=((Boolean)((hasLoopElements("ProductBOs") ? Boolean.TRUE : Boolean.FALSE))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",35,e);}if (_boolean_result) { 
 processOpenTag(response, pageContext, "productcomparepaging", new TagParameter[] {
new TagParameter("ProductBOs",getObject("ProductBOs"))}, 36); 
...
new TagParameter("ImageType","M")}, 48); 
 ...
 {out.write(localizeISText("product.compare.remove.link","",null,null,null,null,null,null,null,null,null,null,null));} 
      ...
      out.write('"');
      out.write('>');
 {String value = null;try{value=context.getFormattedValue(getObject("ProductBO:Name"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {58}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
 ...
 _boolean_result=false;try {_boolean_result=((Boolean)((((context.getFormattedValue(getObject("RichSnippetsEnabled"),null).equals(context.getFormattedValue("true",null)))) ? Boolean.TRUE : Boolean.FALSE))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",65,e);}if (_boolean_result) { 
      ...
      out.write('>');
 {String value = null;try{value=context.getFormattedValue(getObject("ProductBO:SKU"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {65}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
      out.write("</span>\n</div>");
 ...
 URLPipelineAction action26 = new URLPipelineAction(context.getFormattedValue(url(true,(new URLPipelineAction(context.getFormattedValue("ViewProductCompare-Dispatch",null)))),null));String site26 = null;String serverGroup26 = null;String actionValue26 = context.getFormattedValue(url(true,(new URLPipelineAction(context.getFormattedValue("ViewProductCompare-Dispatch",null)))),null);if (site26 == null){  site26 = action26.getDomain();  if (site26 == null)  {      site26 = com.intershop.beehive.core.capi.request.Request.getCurrent().getRequestSite().getDomainName();  }}if (serverGroup26 == null){  serverGroup26 = action26.getServerGroup();  if (serverGroup26 == null)  {      serverGroup26 = com.intershop.beehive.core.capi.request.Request.getCurrent().getRequestSite().getServerGroup();  }}out.print("<form");out.print(" method=\"");out.print("post");out.print("\"");out.print(" action=\"");out.print(context.getFormattedValue(url(true,(new URLPipelineAction(context.getFormattedValue("ViewProductCompare-Dispatch",null)))),null));out.print("\"");out.print(" name=\"");out.print(context.getFormattedValue(getObject("ProductBO:ID"),null));out.print("\"");out.print(">");out.print(context.prepareWACSRFTag(actionValue26, site26, serverGroup26,true)); 
      out.write("<input type=\"hidden\" name=\"SKU\" value=\"");
 {String value = null;try{value=context.getFormattedValue(getObject("ProductBO:SKU"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {70}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
      out.write("\" />\n<input type=\"hidden\" name=\"PageNumber\" value=\"");
 {String value = null;try{value=context.getFormattedValue(getObject("ProductBOs:Page"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {71}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
      out.write("\" />");
...
new TagParameter("ProductBO",getObject("ProductBO"))}, 83); 
 ...
 {out.write(localizeISText("product.compare.ratings.label","",null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("</th>");
 while (loop("ProductBOs","ProductBO",null)) { 
      out.write("<td>\n<div class=\"ish-productRating\">");
 processOpenTag(response, pageContext, "productrating", new TagParameter[] {
new TagParameter("ProductBO",getObject("ProductBO")),
new TagParameter("SimpleRatingView","true")}, 101); 
      out.write("</div>\n</td>");
 } 
      out.write("</tr>\n<tr>\n<th>");
 {out.write(localizeISText("product.productid.label","",null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("</th>");
 while (loop("ProductBOs","ProductBO",null)) { 
      out.write("<td>");
 {String value = null;try{value=context.getFormattedValue(getObject("LookupHelper:get(ProductBO:ID):ProductIdentifierMap(ProductBO:Extension(\"PersistentObjectBOExtension\"):PersistentObject:Domain):SellerID:Value"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {113}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
      out.write("</td>");
 } 
      out.write("</tr>\n<tr>\n<th>");
...
new TagParameter("value",getObject("ProductBO:ShortDescription"))}, 121); 
      out.write("</td>");
 } 
      out.write("</tr>\n<tr>\n<th>");
 {out.write(localizeISText("product.long_description.label","",null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("</th>");
 while (loop("ProductBOs","ProductBO",null)) { 
      out.write("<td>");
 processOpenTag(response, pageContext, "htmlprint", new TagParameter[] {
new TagParameter("mode","storefront"),
new TagParameter("value",getObject("ProductBO:LongDescription"))}, 129); 
      out.write("</td>");
 } 
      out.write("</tr>\n<tr>\n<th>");
 ...
 while (loop("ProductBOs","ProductBO",null)) { 
      out.write("<td>");
 _boolean_result=false;try {_boolean_result=((Boolean)((disableErrorMessages().isDefined(getObject("LookupHelper:get(ProductBO:ID):ProductIdentifierMap:ManufacturerID:Owner"))))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",137,e);}if (_boolean_result) { 
 ...
 {String value = null;try{value=context.getFormattedValue(getObject("ProductBO:ManufacturerName"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {140}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
 } 
      out.write("</td>");
 } 
      out.write("</tr>\n<tr>\n<th>");
 ...
 while (loop("ProductBOs","ProductBO",null)) { 
      out.write("<td>");
 {String value = null;try{value=context.getFormattedValue(getObject("LookupHelper:get(ProductBO:ID):ProductIdentifierMap:ManufacturerID:Value"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {149}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
      out.write("</td>");
 } 
      out.write("</tr>");
 ...
 _boolean_result=false;try {_boolean_result=((Boolean)((disableErrorMessages().isDefined(getObject("AttributeGroup:AttributeDescriptor(common)"))))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",155,e);}if (_boolean_result) { 
      out.write("<tr>\n<th>");
 {String value = null;try{value=context.getFormattedValue(getObject("AttributeGroup:AttributeDescriptor(common):DisplayName"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {157}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
      out.write("</th>");
 while (loop("ProductBOs","ProductBO",null)) { 
      out.write("<td>");
...
new TagParameter("attributelabel","")}, 160); 
      out.write("</td>");
 } 
      out.write("</tr>");
 } 
 ...
 while (loop("ProductBOs","ProductBO",null)) { 
      out.write("<td>");
 _boolean_result=false;try {_boolean_result=((Boolean)((disableErrorMessages().isDefined(getObject("AttributeGroup"))))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",171,e);}if (_boolean_result) { 
...
new TagParameter("attributeseparator","|"),
new TagParameter("attributelabel",getObject("specific"))}, 179); 
...
new TagParameter("attributeseparator","|"),
new TagParameter("attributelabel",getObject("specific"))}, 181); 
 }} 
 } 
 } 
      out.write("</dl>");
 ...
 processOpenTag(response, pageContext, "productcomparepaging", new TagParameter[] {
new TagParameter("ProductBOs",getObject("ProductBOs"))}, 205); 
 } else { 
      out.write('<');
      out.write('p');
      out.write('>');
