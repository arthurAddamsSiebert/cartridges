...
public final class ExpressShop_jsp extends com.intershop.beehive.core.internal.template.AbstractTemplate
...
response.setHeader(TemplateConstants.PERSONALIZED_HEADER, "1");setEncodingType("text/html"); 
 ...
 {out.flush();processLocalIncludeByServer((com.intershop.beehive.core.capi.request.ServletResponse)response,"modules/captcha/Modules", null, "5");} 
      out.write("<script type=\"text/javascript\">RetailShop.onCollapseChangeArrow();</script>");
 processOpenTag(response, pageContext, "currentuserbo", new TagParameter[] {
new TagParameter("currentuserbo","UserBO")}, 9); 
 ...
 {String value = null;try{value=context.getFormattedValue(getObject("Pagelet:UUID"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {21}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
 ...
 {String value = null;try{value=context.getFormattedValue(getObject("ProductBO:ID"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {22}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
      out.write("\"\n>\n<div class=\"modal-content\">\n<div class=\"modal-header\">\n<button type=\"button\" class=\"close\" data-testing-id=\"button-expressshop-close\" data-dismiss=\"modal\" title=\"");
...
new TagParameter("SimpleRatingView","false")}, 32); 
      out.write("</div>\n<div class=\"row product-details\">\n<div class=\"col-sm-6 col-md-7\">\n<div class=\"col-xs-12 product-detail-img clearfix\">\n<div class=\"product-image-container\">");
 processOpenTag(response, pageContext, "productimagescarousel", new TagParameter[] {
new TagParameter("ExpressShop","true"),
new TagParameter("RichSnippetsEnabled",getObject("RichSnippetsEnabled")),
new TagParameter("ProductBO",getObject("ProductBO")),
new TagParameter("ImageType","L")}, 45); 
 processOpenTag(response, pageContext, "productlabel", new TagParameter[] {
new TagParameter("ProductBO",getObject("ProductBO"))}, 50); 
      out.write("</div>\n</div>\n<div class=\"col-md-12 hidden-xs hidden-sm\">");
 processOpenTag(response, pageContext, "productalternateimages", new TagParameter[] {
new TagParameter("RichSnippetsEnabled",getObject("RichSnippetsEnabled")),
new TagParameter("ProductBO",getObject("ProductBO")),
new TagParameter("ImageType","S")}, 54); 
      out.write("</div>\n</div>\n<div class=\"col-sm-6 col-md-5 col-xs-12\">");
 {out.flush();processLocalIncludeByServer((com.intershop.beehive.core.capi.request.ServletResponse)response,"expressshop/ProductInfos", null, "63");} 
      out.write("<div id=\"accordion\" class=\"panel-group\">");
 {out.flush();processLocalIncludeByServer((com.intershop.beehive.core.capi.request.ServletResponse)response,"inc/product/DescriptionTab", null, "67");} 
 {out.flush();processLocalIncludeByServer((com.intershop.beehive.core.capi.request.ServletResponse)response,"inc/product/DetailsTab", null, "68");} 
 {out.flush();processLocalIncludeByServer((com.intershop.beehive.core.capi.request.ServletResponse)response,"inc/product/AttachmentsTab", null, "69");} 
 ...
 {out.flush();processLocalIncludeByServer((com.intershop.beehive.core.capi.request.ServletResponse)response,"inc/product/PolicyTab", null, "72");} 
 {out.flush();processLocalIncludeByServer((com.intershop.beehive.core.capi.request.ServletResponse)response,"inc/product/ShippingTab", null, "73");} 
 } 
      out.write("</div>\n</div>\n</div>\n<div class=\"marketing-area\">");
 processOpenTag(response, pageContext, "slot", new TagParameter[] {
new TagParameter("slot","app_sf_responsive_cm:slot.marketing.product.pagelet2-Slot")}, 79); 
