...
setEncodingType("text/html"); 
 context.setCustomTagTemplateName("roleselection","account/inc/RoleSelection",true,new String[]{"ImplicitlyAssignedRoles","AssignableRoles","CurrentUser","SelectedUser","Language"},null); 
 printFooter(out); 
