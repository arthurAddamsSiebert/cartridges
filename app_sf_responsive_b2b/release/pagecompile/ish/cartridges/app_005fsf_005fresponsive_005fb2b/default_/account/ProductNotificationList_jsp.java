...
new TagParameter("selecteditem","BACKINSTOCK")}, 19); 
 } else { 
 processOpenTag(response, pageContext, "accountnavigation", new TagParameter[] {
new TagParameter("selecteditem","PRODUCTNOTIFICATION")}, 21); 
 } 
      out.write("</div>\n<div class=\"col-md-9\">\n<div class=\"marketing-area\">");
 processOpenTag(response, pageContext, "marketingslot", new TagParameter[] {
new TagParameter("id","contentMarketing")}, 27); 
 ...
 _boolean_result=false;try {_boolean_result=((Boolean)((hasLoopElements("UserAlerts") ? Boolean.TRUE : Boolean.FALSE))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",36,e);}if (_boolean_result) { 
...
new TagParameter("ProductBO",getObject("ProductBORepository:ProductBOBySKU(ListItem:Product:SKU)"))}, 43); 
 } 
      out.write("</div>");
 } else { 
