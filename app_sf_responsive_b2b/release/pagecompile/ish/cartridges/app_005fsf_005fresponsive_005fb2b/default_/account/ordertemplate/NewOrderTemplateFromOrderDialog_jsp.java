...
public final class NewOrderTemplateFromOrderDialog_jsp extends com.intershop.beehive.core.internal.template.AbstractTemplate
...
setEncodingType("text/html"); 
 ...
 context.setCustomTagTemplateName("wishlistpropertiesform","modules/account/WishlistPropertiesForm.isml",true,new String[]{"CurrentForm","TargetPipeline","SubmitButtonName","SubmitButtonText","WishlistBO","TitleText","ParameterName1","ParameterValue1"},null); 
...
new TagParameter("ParameterValue1",getObject("OrderID"))}, 18); 
 printFooter(out); 
