...
new TagParameter("text",localizeText(context.getFormattedValue("account.allapprovedorders.link",null)))}, 5); 
...
new TagParameter("selecteditem","ALLAPPROVEDORDERS")}, 18); 
      out.write("</div>\n<div class=\"col-md-9\">\n<div class=\"marketing-area\">");
 processOpenTag(response, pageContext, "marketingslot", new TagParameter[] {
new TagParameter("id","contentMarketing")}, 23); 
      out.write("</div>");
 {out.flush();processLocalIncludeByServer((com.intershop.beehive.core.capi.request.ServletResponse)response,"account/orders/OrderDetails", null, "27");} 
      out.write("<div class=\"section\">\n<a href=\"");
 processOpenTag(response, pageContext, "link", new TagParameter[] {
new TagParameter("link",url(true,(new URLPipelineAction(context.getFormattedValue("ViewApprovals-AllApproved",null)))))}, 29); 
      out.write('"');
      out.write('>');
 {out.write(localizeISText("approval.detailspage.back_to_allapproved.link","",null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("</a>\n</div>\n</div>\n</div>\n</div>");
 printFooter(out); 
