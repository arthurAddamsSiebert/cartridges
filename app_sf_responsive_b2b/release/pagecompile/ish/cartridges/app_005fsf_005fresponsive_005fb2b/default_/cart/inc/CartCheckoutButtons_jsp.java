 ...
 */
package ish.cartridges.app_005fsf_005fresponsive_005fb2b.default_.cart.inc;
...
setEncodingType("text/html"); 
 ...
 _boolean_result=false;try {_boolean_result=((Boolean)(getObject("UserBO:Extension(\"UserBORoleExtension\"):hasRole(\"APP_B2B_OCI_USER\")"))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",6,e);}if (_boolean_result) { 
      out.write("<input type=\"hidden\" name=\"AUTOSUBMIT\" value=\"true\">\n<button \ntype=\"submit\" \nclass=\"btn btn-lg btn-block btn-primary\" \nname=\"transferOCI\" \n");
 ...
 {out.write(localizeISText("shopping_cart.max.total.value.error.text2","",null,null,null,null,null,null,null,null,null,null,null));} 
      ...
      out.write('\n');
      out.write('>');
 {out.write(localizeISText("shopping_cart.oci.transfer_basket.button","",null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("</button>");
 } else { 
      out.write("<button \ntype=\"submit\" \nclass=\"btn btn-lg btn-block btn-primary\" \nname=\"checkout\" \n");
 ...
 _boolean_result=false;try {_boolean_result=((Boolean)((hasLoopElements("PaymentServiceBOs") ? Boolean.TRUE : Boolean.FALSE))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",27,e);}if (_boolean_result) { 
 {Object temp_obj = (((((Boolean) getObject("CurrentSession:LoggedIn")).booleanValue() && ((Boolean) (disableErrorMessages().isDefined(getObject("CurrentCartBO:Extension(\"Approval\"):Enabled")))).booleanValue() && ((Boolean) getObject("CurrentCartBO:Extension(\"Approval\"):Enabled")).booleanValue()) ? Boolean.TRUE : Boolean.FALSE)); getPipelineDictionary().put("DisableFastCheckoutButtons", temp_obj);} 
 _boolean_result=false;try {_boolean_result=((Boolean)((((context.getFormattedValue(getObject("DisableFastCheckoutButtons"),null).equals(context.getFormattedValue("false",null)))) ? Boolean.TRUE : Boolean.FALSE))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",30,e);}if (_boolean_result) { 
 ...
 {Object temp_obj = ("false"); getPipelineDictionary().put("FirstPaymentCheckoutButton", temp_obj);} 
      ...
      out.write("<button \ntype=\"submit\" \nclass=\"btn btn-info\" \nname=\"fastCheckout_");
 {String value = null;try{value=context.getFormattedValue(getObject("PaymentServiceBO:ID"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {43}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
      out.write('"');
      out.write('\n');
 ...
 {String value = null;try{value=context.getFormattedValue(getObject("Restriction"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {48}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
      out.write("&nbsp;\n");
 } 
 } 
