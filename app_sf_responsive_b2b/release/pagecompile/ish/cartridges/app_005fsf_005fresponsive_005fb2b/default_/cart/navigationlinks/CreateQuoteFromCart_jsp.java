...
public final class CreateQuoteFromCart_jsp extends com.intershop.beehive.core.internal.template.AbstractTemplate
...
setEncodingType("text/html"); 
 ...
 _boolean_result=false;try {_boolean_result=((Boolean)((((Boolean) getObject("UserBO:Extension(\"UserBORoleExtension\"):hasRole(\"APP_B2B_OCI_USER\")")).booleanValue() ? Boolean.FALSE : Boolean.TRUE) )).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",7,e);}if (_boolean_result) { 
      ...
      out.print(context.getFormattedValue(url(true,(new URLPipelineAction(context.getFormattedValue("ViewCart-Dispatch",null))),(new URLParameterSet().addURLParameter(context.getFormattedValue("createQuote",null),context.getFormattedValue("true",null)))),null));
      out.write("\" class=\"btn btn-default\" id=\"createQuote\" name=\"createQuote\">\n\t\t");
