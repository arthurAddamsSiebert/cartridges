...
public final class PunchoutSettings_jsp extends com.intershop.beehive.core.internal.template.AbstractTemplate
...
new TagParameter("trailtext",localizeText(context.getFormattedValue("account.punchout.link",null)))}, 7); 
...
new TagParameter("selecteditem","PUNCHOUT")}, 20); 
      out.write("</div>\n<div class=\"col-md-9\">\n<div class=\"marketing-area\">");
 processOpenTag(response, pageContext, "marketingslot", new TagParameter[] {
new TagParameter("id","contentMarketing")}, 25); 
      out.write("</div>");
 {Object temp_obj = ("oci"); getPipelineDictionary().put("PunchoutType", temp_obj);} 
      out.write(" \n<h1>");
 {out.write(localizeISText("account.punchout.heading","",null,null,null,null,null,null,null,null,null,null,null));} 
 _boolean_result=false;try {_boolean_result=((Boolean)((hasLoopElements("PunchoutExtension:PunchoutUserBOs(PunchoutType)") ? Boolean.TRUE : Boolean.FALSE))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",32,e);}if (_boolean_result) { 
      out.write("<a href=\"");
      out.print(context.getFormattedValue(url(true,(new URLPipelineAction(context.getFormattedValue("ViewOCIConfiguration-Start",null)))),null));
      out.write("\" \ndata-testing-class=\"link-oci-punchout-configuration\"\nclass=\"btn btn-default\">");
 {out.write(localizeISText("account.punchout.button.configure","",null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("</a>");
 } 
      out.write("</h1>");
 {out.flush();processLocalIncludeByServer((com.intershop.beehive.core.capi.request.ServletResponse)response,"punchout/inc/OCI", null, "39");} 
      out.write("</div>\n</div>\n</div>");
 printFooter(out); 
