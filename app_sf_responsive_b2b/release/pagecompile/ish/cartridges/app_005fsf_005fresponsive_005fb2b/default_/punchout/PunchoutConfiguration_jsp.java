...
public final class PunchoutConfiguration_jsp extends com.intershop.beehive.core.internal.template.AbstractTemplate
...
new TagParameter("selecteditem","PUNCHOUT")}, 21); 
      out.write("</div>\n<div class=\"col-md-9\">\n<div class=\"marketing-area\">");
 processOpenTag(response, pageContext, "marketingslot", new TagParameter[] {
new TagParameter("id","contentMarketing")}, 26); 
      out.write("</div>\n<h1>");
 {out.write(localizeISText("account.punchout.configuration.heading","",null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("</h1>");
 {out.flush();processLocalIncludeByServer((com.intershop.beehive.core.capi.request.ServletResponse)response,"punchout/inc/OCIConfiguration", null, "31");} 
      out.write("</div>\n</div>\n</div>");
 printFooter(out); 
