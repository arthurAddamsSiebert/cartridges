...
new TagParameter("text",localizeText(context.getFormattedValue("account.punchout.link",null)))}, 5); 
      out.write("</div>");
...
new TagParameter("selecteditem","PUNCHOUT")}, 24); 
      out.write("</div>\n<div class=\"col-md-9 user-profile\">\n<div class=\"marketing-area\">");
 processOpenTag(response, pageContext, "marketingslot", new TagParameter[] {
new TagParameter("id","contentMarketing")}, 29); 
      out.write("</div>\n<h1>");
 {out.write(localizeISText("account.punchout.profile.link","",null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("</h1>");
 {out.flush();processLocalIncludeByServer((com.intershop.beehive.core.capi.request.ServletResponse)response,"account/profile/SuccessMessage", null, "34");} 
 {out.flush();processLocalIncludeByServer((com.intershop.beehive.core.capi.request.ServletResponse)response,"punchout/inc/OCIEmail", null, "36");} 
 {out.flush();processLocalIncludeByServer((com.intershop.beehive.core.capi.request.ServletResponse)response,"punchout/inc/OCIPassword", null, "38");} 
      out.write("</div>\n</div>\n</div>");
 printFooter(out); 
