 ...
 */
package ish.cartridges.app_005fsf_005fresponsive_005fb2b.default_.inc;
...
public final class ExtensionJS_jsp extends com.intershop.beehive.core.internal.template.AbstractTemplate
...
setEncodingType("text/html"); 
 { ISFileBundle filebundle = new ISFileBundle("/js/extension_b2b.min.js");List<? extends Resource> resources = null;
...
TemplateExecutionConfig context = getTemplateExecutionConfig(); 
 ...
 {String value = null;try{value=context.getFormattedValue(getObject("File:LastModified"),"0",null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {10}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
      out.write("\"></script>");
