...
new TagParameter("ProductBO",getObject("BundledProductBO"))}, 47); %></div> 
<% _boolean_result=false;try {_boolean_result=((Boolean)(getObject("BundledProductBO:InventoryStatus:InStock"))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",55,e);}if (_boolean_result) { %><input type="hidden" name="SKU" value="<% {String value = null;try{value=context.getFormattedValue(getObject("BundledProductBO:SKU"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {56}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} %>"/><% } %></div><% _boolean_result=false;try {_boolean_result=((Boolean)(getObject("BundledProductBO:InventoryStatus:InStock"))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",60,e);}if (_boolean_result) { %><input type="hidden" name="SKU" value="<% {String value = null;try{value=context.getFormattedValue(getObject("BundledProductBO:SKU"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {61}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} %>"/><% } %><% processOpenTag(response, pageContext, "productvariationselect", new TagParameter[] {
new TagParameter("ProductBO",getObject("BundledProductBO"))}, 64); %><div class="quantity"><% processOpenTag(response, pageContext, "productquantity", new TagParameter[] {
new TagParameter("displayQuantity",new Double(1)),
new TagParameter("Currency",getObject("CurrentRequest:Currency")),
new TagParameter("nullQuantity","true"),
new TagParameter("ProductBO",getObject("BundledProductBO"))}, 67); %></div><% _boolean_result=false;try {_boolean_result=((Boolean)(((!((Boolean) ((disableErrorMessages().isDefined(getObject("USER_HAS_ROLE_APP_B2B_OCI_USER"))))).booleanValue() || ((Boolean) ((((context.getFormattedValue(getObject("USER_HAS_ROLE_APP_B2B_OCI_USER"),null).equals(context.getFormattedValue("false",null)))) ? Boolean.TRUE : Boolean.FALSE))).booleanValue()) ? Boolean.TRUE : Boolean.FALSE))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",71,e);}if (_boolean_result) { %><% processOpenTag(response, pageContext, "productshipping", new TagParameter[] {
new TagParameter("ProductBO",getObject("BundledProductBO"))}, 72); %><% } %></div>
</div>
</div>
</div><% printFooter(out); %>