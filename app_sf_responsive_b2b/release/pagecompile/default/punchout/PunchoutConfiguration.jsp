...
<div class="account-wrapper" data-testing-id="page-oci-punchout-configuration">
<div class="row account-main">
<div class="col-md-3 account-nav-box"><% processOpenTag(response, pageContext, "accountnavigation", new TagParameter[] {
new TagParameter("selecteditem","PUNCHOUT")}, 21); %></div>
<div class="col-md-9">
<div class="marketing-area"><% processOpenTag(response, pageContext, "marketingslot", new TagParameter[] {
new TagParameter("id","contentMarketing")}, 26); %></div>
<h1><% {out.write(localizeISText("account.punchout.configuration.heading","",null,null,null,null,null,null,null,null,null,null,null));} %></h1><% {out.flush();processLocalIncludeByServer((com.intershop.beehive.core.capi.request.ServletResponse)response,"punchout/inc/OCIConfiguration", null, "31");} %></div>
</div>
</div><% printFooter(out); %>