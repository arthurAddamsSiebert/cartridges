...
new TagParameter("link",url(true,(new URLPipelineAction(context.getFormattedValue("ViewApprovals-AllApproved",null))))),
...
new TagParameter("text",localizeText(context.getFormattedValue("account.allapprovedorders.link",null)))}, 5); %></div>
...
new TagParameter("selecteditem","ALLAPPROVEDORDERS")}, 18); %></div>
<div class="col-md-9">
<div class="marketing-area"><% processOpenTag(response, pageContext, "marketingslot", new TagParameter[] {
new TagParameter("id","contentMarketing")}, 23); %></div><% {out.flush();processLocalIncludeByServer((com.intershop.beehive.core.capi.request.ServletResponse)response,"account/orders/OrderDetails", null, "27");} %><div class="section">
<a href="<% processOpenTag(response, pageContext, "link", new TagParameter[] {
new TagParameter("link",url(true,(new URLPipelineAction(context.getFormattedValue("ViewApprovals-AllApproved",null)))))}, 29); %>"><% {out.write(localizeISText("approval.detailspage.back_to_allapproved.link","",null,null,null,null,null,null,null,null,null,null,null));} %></a>
</div>
</div>
</div>
</div><% printFooter(out); %>