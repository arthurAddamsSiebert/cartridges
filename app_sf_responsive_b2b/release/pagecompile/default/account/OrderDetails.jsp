...
new TagParameter("link",url(true,(new URLPipelineAction(context.getFormattedValue("ViewOrders-SimpleOrderSearch",null)))))}, 5); %></div>
...
new TagParameter("selecteditem","ORDERS")}, 19); %></div>
<div class="col-md-9">
<div class="marketing-area"><% processOpenTag(response, pageContext, "marketingslot", new TagParameter[] {
new TagParameter("id","contentMarketing")}, 25); %></div><% {out.flush();processLocalIncludeByServer((com.intershop.beehive.core.capi.request.ServletResponse)response,"account/orders/OrderDetails", null, "29");} %><div class="section">
<a href="<% processOpenTag(response, pageContext, "link", new TagParameter[] {
new TagParameter("link",url(true,(new URLPipelineAction(context.getFormattedValue("ViewOrders-SimpleOrderSearch",null)))))}, 32); %>"><% {out.write(localizeISText("account.orderdetails.links.return_to_orders","",null,null,null,null,null,null,null,null,null,null,null));} %></a>
<a class="pull-right" href="<% processOpenTag(response, pageContext, "link", new TagParameter[] {
new TagParameter("link",url(true,context.getFormattedValue(getObject("InsecureURL"),null), context.getFormattedValue("",null), (new URLPipelineAction(context.getFormattedValue("ViewHomepage-Start",null)))))}, 35); %>"><% {out.write(localizeISText("account.orderdetails.links.continue_shopping","",null,null,null,null,null,null,null,null,null,null,null));} %></a>
</div>
</div>
</div>
</div><% printFooter(out); %>