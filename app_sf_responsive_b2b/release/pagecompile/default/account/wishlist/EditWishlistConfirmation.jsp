...
<a class="close" href="<%=context.getFormattedValue(url(true,(new URLPipelineAction(context.getFormattedValue("ViewOrderTemplate-View",null))),(new URLParameterSet().addURLParameter(context.getFormattedValue("WishlistID",null),context.getFormattedValue(getObject("WishlistBO:ID"),null)))),null)%>" title="<% {out.write(localizeISText("dialog.close.text","",null,null,null,null,null,null,null,null,null,null,null));} %>" aria-label="<% {out.write(localizeISText("dialog.close.text","",null,null,null,null,null,null,null,null,null,null,null));} %>"><span aria-hidden="true">&times;</span></a>
<h2 class="modal-title"><% {out.write(localizeISText("account.order_template.edit.heading","",null,null,null,null,null,null,null,null,null,null,null));} %></h2> 
</div>
<div class="modal-body"><% {out.write(localizeISText("account.wishlists.edit_wishlist.confirmation","",null,getObject("WishlistBO:Name"),null,null,null,null,null,null,null,null,null));} %></div>
