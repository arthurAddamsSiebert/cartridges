 ...
 */
package ish.cartridges.sld_005fpmc.default_.inc;
...
import com.intershop.sellside.pmc.internal.htmleditor.KupuFilterWriter;
...
public final class HtmlPrint_jsp extends com.intershop.beehive.core.internal.template.AbstractTemplate
...
setEncodingType("text/html"); 
 _boolean_result=false;try {_boolean_result=((Boolean)((disableErrorMessages().isDefined(getObject("value"))))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",2,e);}if (_boolean_result) { 
 ...
 {String value = null;try{value=context.getFormattedValue(getObject("value"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {30}",e);}if (value==null) value="";out.write(value);} 
 } 
 printFooter(out); 
