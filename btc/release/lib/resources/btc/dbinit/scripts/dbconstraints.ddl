...
EXEC staging_ddl.add_constraint('JURISDICTIONMAPPING','JURISDICTIONMAPPING_CO999','FOREIGN KEY (DOMAINID) REFERENCES DOMAIN (UUID) INITIALLY DEFERRED DEFERRABLE DISABLE NOVALIDATE');
