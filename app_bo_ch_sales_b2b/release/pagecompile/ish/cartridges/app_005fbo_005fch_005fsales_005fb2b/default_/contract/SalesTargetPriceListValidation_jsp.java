...
public final class SalesTargetPriceListValidation_jsp extends com.intershop.beehive.core.internal.template.AbstractTemplate
...
setEncodingType("text/html"); 
 ...
 {try{executePipeline("ProcessContract-ValidateSalesTargetPriceList",((java.util.Map)(((new ParameterMap().addParameter(new ParameterEntry("ContractID",getObject("Contract:ID"))))))),"ValidationDict");}catch(Exception e){Logger.error(this,"ISPIPELINE failed. Line: 4.",e);}} 
      out.write(' ');
      out.write('\n');
 ...
 {out.write(localizeISText("contract.configuration.pricelist.violation",null,null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("</td>\n</tr>\n</tbody>\n</table> \n</td>\n<tr>");
 } 
 printFooter(out); 
