...
PROMPT /* Class */
PROMPT -- Compound indices
EXEC staging_ddl.create_index('SERVICECONFIGURATION_CI001', 'SERVICECONFIGURATION', '(SERVICEDEFINITIONKEYID,DOMAINID)', :table_space, 'NONUNIQUE', :recreate_indexes)
