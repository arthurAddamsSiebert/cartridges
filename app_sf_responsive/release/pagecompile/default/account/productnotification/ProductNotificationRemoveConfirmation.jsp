...
<p><% {out.write(localizeISText("account.productnotification.remove.confirmation.message","",null,null,null,null,null,null,null,null,null,null,null));} %></p>
</div>
<div class="modal-footer">
<a class="btn btn-default" href="<%=context.getFormattedValue(url(true,context.getFormattedValue(getObject("SecureURL"),null), context.getFormattedValue("",null), (new URLPipelineAction(context.getFormattedValue("ViewProductNotification-List",null)))),null)%>"><% {out.write(localizeISText("account.productnotification.set.close","",null,null,null,null,null,null,null,null,null,null,null));} %></a>
</div>
</div>
</div><% printFooter(out); %>