...
client.get('/recurringorders/' + '<% {String value = null;try{value=context.getFormattedValue(getObject("SubscriptionID"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {21}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} %>').then(function(data) {
controller
.model(data)
.update();
}, function() {
