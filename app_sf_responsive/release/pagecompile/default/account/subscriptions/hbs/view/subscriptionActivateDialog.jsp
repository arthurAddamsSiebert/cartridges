...
<h2 class="modal-title"><% {out.write(localizeISText("account.subscriptions.list.activate","",null,null,null,null,null,null,null,null,null,null,null));} %></h2>
</div>
{{<%=context.getFormattedValue("#",null)%>if confirm}}
<div class="modal-body">
<p><% {out.write(localizeISText("account.subscriptions.dialog.confirm.activate","",null,null,null,null,null,null,null,null,null,null,null));} %></p>
</div>
<div class="modal-footer">
<button class="btn btn-primary {{<%=context.getFormattedValue("#",null)%>if loading}}btn-loader{{/if}}" type="submit" value="{{sid}}" name="activate">
<div class="loader"></div>
<span class="btn-content"><% {out.write(localizeISText("account.subscriptions.dialog.confirm.button.activate","",null,null,null,null,null,null,null,null,null,null,null));} %></span>
</button>
...
{{else}}
<p><% {out.write(localizeISText("account.subscriptions.dialog.activated","",null,null,null,null,null,null,null,null,null,null,null));} %></p>
{{/if}}
</div>
<div class="modal-footer">
