...
new TagParameter("trailtext",localizeText(context.getFormattedValue("account.update_password.breadcrumb",null))),
...
<div class="account-wrapper" data-testing-id="profile-settings-password-page">
...
<p><% {out.write(localizeISText("account.update_password.change.message","",null,null,null,null,null,null,null,null,null,null,null));} %></p>
<div class="section"><% {out.flush();processLocalIncludeByServer((com.intershop.beehive.core.capi.request.ServletResponse)response,"account/profile/PasswordEdit", null, "34");} %></div>
...
<p class="help-block"><% {out.write(localizeISText("account.update_password.question.text","",null,null,null,null,null,null,null,null,null,null,null));} %><br /><% {out.write(localizeISText("account.update_password.answer.text","",null,null,null,null,null,null,null,null,null,null,null));} %></p>
</div>
</div>
</div><% printFooter(out); %>