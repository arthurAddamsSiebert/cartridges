...
<div class="modal-body"><% {out.write(localizeISText("account.wishlists.delete_wishlist.confirmation","",null,getObject("DeletedWishlistName"),null,null,null,null,null,null,null,null,null));} %></div>
<div class="modal-footer">
<a class="btn btn-primary" href="<%=context.getFormattedValue(url(true,(new URLPipelineAction(context.getFormattedValue("ViewWishlist-ViewAll",null)))),null)%>"><% {out.write(localizeISText("account.wishlists.delete_wishlist.confirmation.ok_button.text","",null,null,null,null,null,null,null,null,null,null,null));} %></a>
</div>
</div>
</div><% printFooter(out); %>