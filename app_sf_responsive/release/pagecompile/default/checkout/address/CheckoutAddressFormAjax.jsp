...
new TagParameter("addresstemplate",context.getFormattedValue("modules/address/forms/",null) + context.getFormattedValue(getObject("WebFormFileName"),null))}, 4); %><% printFooter(out); %>