...
%>href="<% processOpenTag(response, pageContext, "link", new TagParameter[] {
new TagParameter("linkparameters",getObject("linkparameters")),
new TagParameter("forcesecure",getObject("forcesecure")),
new TagParameter("link",getObject("link")),
new TagParameter("forceinsecure",getObject("forceinsecure"))}, 3); %>"<%
%><% } else { %><%
%>href=""<%
%><% } %><% printFooter(out); %>