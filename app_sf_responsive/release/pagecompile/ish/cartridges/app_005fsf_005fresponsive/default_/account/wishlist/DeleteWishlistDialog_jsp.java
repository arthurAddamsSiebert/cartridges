...
setEncodingType("text/html"); 
 ...
 {out.write(localizeISText("account.wishlists.delete_wishlist_dialog.header","",null,getObject("WishlistBO:Name"),null,null,null,null,null,null,null,null,null));} 
      out.write("</h2>\n</div>");
 URLPipelineAction action22 = new URLPipelineAction(context.getFormattedValue(url(true,(new URLPipelineAction(context.getFormattedValue("ViewWishlist-DeleteWishlist",null)))),null));String site22 = null;String serverGroup22 = null;String actionValue22 = context.getFormattedValue(url(true,(new URLPipelineAction(context.getFormattedValue("ViewWishlist-DeleteWishlist",null)))),null);if (site22 == null){  site22 = action22.getDomain();  if (site22 == null)  {      site22 = com.intershop.beehive.core.capi.request.Request.getCurrent().getRequestSite().getDomainName();  }}if (serverGroup22 == null){  serverGroup22 = action22.getServerGroup();  if (serverGroup22 == null)  {      serverGroup22 = com.intershop.beehive.core.capi.request.Request.getCurrent().getRequestSite().getServerGroup();  }}out.print("<form");out.print(" method=\"");out.print("post");out.print("\"");out.print(" action=\"");out.print(context.getFormattedValue(url(true,(new URLPipelineAction(context.getFormattedValue("ViewWishlist-DeleteWishlist",null)))),null));out.print("\"");out.print(" data-hijax=\"");out.print("true");out.print("\"");out.print(" class=\"");out.print("form-horizontal");out.print("\"");out.print(">");out.print(context.prepareWACSRFTag(actionValue22, site22, serverGroup22,true)); 
      out.write("<div class=\"modal-body\">\n<div class=\"form-group\">\n<div class=\"col-xs-12\">\n<p>");
 {out.write(localizeISText("account.wishlists.delete_wishlist_dialog.are_you_sure_paragraph","",null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("</p>");
 _boolean_result=false;try {_boolean_result=((Boolean)((((context.getFormattedValue(getObject("PreferredWishlistID"),null).equals(context.getFormattedValue(getObject("WishlistBO:ID"),null)))) ? Boolean.TRUE : Boolean.FALSE))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",16,e);}if (_boolean_result) { 
      ...
      out.write('p');
      out.write('>');
 {out.write(localizeISText("account.wishlists.delete_wishlist_dialog.preferred_wishlist_paragraph","",null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("</p>");
 } 
      out.write("<input type=\"hidden\" name=\"WishlistID\" value=\"");
 {String value = null;try{value=context.getFormattedValue(getObject("WishlistBO:ID"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {17}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
      out.write("\" />");
 ...
 {out.write(localizeISText("account.wishlists.delete_wishlist_dialog.move_products_before_deletion.label","",null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("</label>\n</div>\n</fieldset>\n<div id=\"targetWishlistSection\" class=\"collapse row col-xs-6\">\n<select class=\"form-control\" name=\"");
 {String value = null;try{value=context.getFormattedValue(getObject("DeleteWishlistForm:TargetWishlistID:QualifiedName"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {30}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
      out.write('"');
      out.write(' ');
      out.write('>');
 ...
 {String value = null;try{value=context.getFormattedValue(getObject("CurrentWishlistBO:ID"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {33}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
      out.write('"');
      out.write('>');
 {String value = null;try{value=context.getFormattedValue(getObject("CurrentWishlistBO:Name"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {34}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
      out.write("</option>");
 } 
 } 
      out.write("</select>\n</div>");
