...
new TagParameter("trailtext",localizeText(context.getFormattedValue("account.order_history.link",null)))}, 5); 
...
new TagParameter("selecteditem","ORDERS")}, 17); 
      out.write("</div>\n<div class=\"col-md-9\">\n<div class=\"marketing-area\">");
 processOpenTag(response, pageContext, "marketingslot", new TagParameter[] {
new TagParameter("id","contentMarketing")}, 22); 
      out.write("</div>\n<h1>");
 _boolean_result=false;try {_boolean_result=((Boolean)((disableErrorMessages().isDefined(getObject("MyOrderSearch"))))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",26,e);}if (_boolean_result) { 
 {out.write(localizeISText("account.order_history.myOrders.heading","",null,null,null,null,null,null,null,null,null,null,null));} 
 } else { 
 {out.write(localizeISText("account.order_history.heading","",null,null,null,null,null,null,null,null,null,null,null));} 
 } 
      out.write("</h1>");
 ...
 {out.write(localizeISText("account.order.subtitle","",null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("</p>");
 {out.flush();processLocalIncludeByServer((com.intershop.beehive.core.capi.request.ServletResponse)response,"account/orders/OrderList", null, "37");} 
 } 
      out.write("<h4 class=\"help-block\">");
