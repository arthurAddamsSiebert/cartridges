...
public final class WishListDetails_jsp extends com.intershop.beehive.core.internal.template.AbstractTemplate
...
new TagParameter("template","BasketChangeAdd")}, 8); 
...
new TagParameter("selecteditem","WISHLISTS")}, 19); 
...
new TagParameter("contenttype","html")}, 26); 
 {out.flush();processLocalIncludeByServer((com.intershop.beehive.core.capi.request.ServletResponse)response,"account/wishlist/WishlistHeader", null, "33");} 
 {out.flush();processLocalIncludeByServer((com.intershop.beehive.core.capi.request.ServletResponse)response,"account/wishlist/Wishlist", null, "35");} 
 {out.flush();processLocalIncludeByServer((com.intershop.beehive.core.capi.request.ServletResponse)response,"account/wishlist/WishlistSearchForm", null, "37");} 
      out.write("</div>\n</div>\n</div>");
 printFooter(out); 
