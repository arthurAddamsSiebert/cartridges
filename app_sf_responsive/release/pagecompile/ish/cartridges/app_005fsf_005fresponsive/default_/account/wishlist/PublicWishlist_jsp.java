...
public final class PublicWishlist_jsp extends com.intershop.beehive.core.internal.template.AbstractTemplate
...
new TagParameter("wishlistBO",getObject("WishlistBO"))}, 5); 
...
new TagParameter("text",localizeText(context.getFormattedValue("account.wishlists.link",null)))}, 6); 
...
new TagParameter("selecteditem","WISHLISTS")}, 22); 
      out.write("</div>\n<div class=\"col-md-9\">\n<div class=\"marketing-area\">");
 processOpenTag(response, pageContext, "marketingslot", new TagParameter[] {
new TagParameter("id","contentMarketing")}, 27); 
      out.write("</div>");
 {out.flush();processLocalIncludeByServer((com.intershop.beehive.core.capi.request.ServletResponse)response,"account/wishlist/PublicWishlistHeader", null, "30");} 
 {out.flush();processLocalIncludeByServer((com.intershop.beehive.core.capi.request.ServletResponse)response,"account/wishlist/PublicWishlistInclude", null, "32");} 
