...
public final class WishLists_jsp extends com.intershop.beehive.core.internal.template.AbstractTemplate
...
new TagParameter("trailtext",localizeText(context.getFormattedValue("account.wishlists.link",null)))}, 5); 
...
new TagParameter("contenttype","html")}, 25); 
      out.write("<h1>");
 {out.write(localizeISText("account.wishlists.heading","",null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("<a class=\"btn btn-default\" data-dialog href=\"");
      out.print(context.getFormattedValue(url(true,(new URLPipelineAction(context.getFormattedValue("ViewWishlist-ShowNewWishlistDialog",null))),(new URLParameterSet().addURLParameter(context.getFormattedValue("AjaxRequestMarker",null),context.getFormattedValue("true",null)))),null));
      out.write('"');
      out.write('>');
 {out.write(localizeISText("account.wishlists.add_wishlist","",null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("</a>\n</h1>");
 {out.flush();processLocalIncludeByServer((com.intershop.beehive.core.capi.request.ServletResponse)response,"account/wishlist/WishlistsList", null, "37");} 
 {out.flush();processLocalIncludeByServer((com.intershop.beehive.core.capi.request.ServletResponse)response,"account/wishlist/WishlistSettings", null, "39");} 
 {out.flush();processLocalIncludeByServer((com.intershop.beehive.core.capi.request.ServletResponse)response,"account/wishlist/WishlistSearchForm", null, "41");} 
      out.write("</div>\n</div>\n</div>\n</div>");
 printFooter(out); 
