...
setEncodingType("text/html"); 
 context.setCustomTagTemplateName("mailheader","email/mailTemplate/MailHeader.isml",true,new String[]{"ChannelName","OrganizationName","ShowMyAccountLink","ShowCustomerInformation"},null); 
 printFooter(out); 
