...
response.setHeader(TemplateConstants.PERSONALIZED_HEADER, "1");setEncodingType("text/html"); 
 ...
 {Object temp_obj = (getObject("CurrentCartBO:Extension(\"ShippingMethod\")")); getPipelineDictionary().put("CartShippingMethod", temp_obj);} 
      out.write(" \n<a data-csrf-guarded class=\"pull-right btn-tool\" title=\"");
 ...
 {out.write(localizeISText("checkout.widget.shipping_method.heading","",null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("</h3>");
 {out.flush();processLocalIncludeByServer((com.intershop.beehive.core.capi.request.ServletResponse)response,"checkout/common/widgets/ShippingMethodInc", null, "9");} 
      out.write("</div>");
 printFooter(out); 
