...
public final class BillingAddress_jsp extends com.intershop.beehive.core.internal.template.AbstractTemplate
...
response.setHeader(TemplateConstants.PERSONALIZED_HEADER, "1");setEncodingType("text/html"); 
      out.write("<div class=\"infobox\" data-testing-id='address-slot-invoice-to-address'>\n<a class=\"pull-right btn-tool\" href=\"");
 ...
 {out.write(localizeISText("checkout.widget.billing-address.heading","",null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("</h3>");
...
new TagParameter("address",getObject("CurrentCartBO:InvoiceToAddressBO"))}, 9); 
      out.write("</div>");
 printFooter(out); 
