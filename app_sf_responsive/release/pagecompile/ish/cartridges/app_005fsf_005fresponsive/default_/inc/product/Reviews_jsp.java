...
public final class Reviews_jsp extends com.intershop.beehive.core.internal.template.AbstractTemplate
...
response.setHeader(TemplateConstants.PERSONALIZED_HEADER, "1");setEncodingType("text/html"); 
 ...
 {Object temp_obj = (getObject("OwningDomain:Configuration:String(\"RichSnippetsEnabled\")")); getPipelineDictionary().put("RichSnippetsEnabled", temp_obj);} 
      out.write("<h2>");
 {out.write(localizeISText("product.reviews.heading","",null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("</h2>");
 {out.flush();
...
new TagParameter("ProductBO",getObject("ProductBO"))}, 13); 
 } else { 
 processOpenTag(response, pageContext, "reviewlist", new TagParameter[] {
new TagParameter("CategoryDomainName",getObject("CategoryDomainName")),
new TagParameter("CurrentUser",getObject("CurrentUser")),
...
new TagParameter("ListNavigationVO",getObject("ListNavigationVO"))}, 24); 
 } 
 printFooter(out); 
