...
public final class PolicyTab_jsp extends com.intershop.beehive.core.internal.template.AbstractTemplate
...
new TagParameter("name","collectionItemID")}, 6); 
      out.write("<div class=\"panel-heading\" data-testing-id=\"section-returnpolicy-tab\">\n<a data-toggle=\"collapse\" data-parent=\"");
      out.print(context.getFormattedValue("#",null));
      out.write("accordion\" href=\"");
      out.print(context.getFormattedValue("#",null));
 {String value = null;try{value=context.getFormattedValue(getObject("collectionItemID"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {8}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
      out.write("\" class=\"collapsed\">");
 {out.write(localizeISText("product.return_policy.heading","",null,null,null,null,null,null,null,null,null,null,null));} 
      out.write(" <span class=\"glyphicon glyphicon-plus pull-right\"></span>\n</a>\n</div>\n<div id=\"");
 {String value = null;try{value=context.getFormattedValue(getObject("collectionItemID"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {12}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
      out.write("\" class=\"panel-collapse collapse\">\n<div class=\"panel-body\">");
 {out.write(localizeISText("product.return_policy.text",null,null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("</div>\n</div>");
 printFooter(out); 
