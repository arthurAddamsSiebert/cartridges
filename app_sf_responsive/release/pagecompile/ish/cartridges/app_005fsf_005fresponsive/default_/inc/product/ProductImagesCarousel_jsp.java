...
public final class ProductImagesCarousel_jsp extends com.intershop.beehive.core.internal.template.AbstractTemplate
...
response.setHeader(TemplateConstants.PERSONALIZED_HEADER, "1");setEncodingType("text/html"); 
 ...
 {Object temp_obj = (getObject("ProductBO:Extension(\"Image\"):ImageContainerBO:getImageViewIDsExcludePrimary(ImageType)")); getPipelineDictionary().put("ImageViews", temp_obj);} 
 _boolean_result=false;try {_boolean_result=((Boolean)((hasLoopElements("ImageViews") ? Boolean.TRUE : Boolean.FALSE))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",8,e);}if (_boolean_result) { 
      out.write("<div ");
 _boolean_result=false;try {_boolean_result=((Boolean)((disableErrorMessages().isDefined(getObject("ExpressShop"))))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",9,e);}if (_boolean_result) { 
      out.write("id=\"prodimgcarouselexprshop\"");
 } else { 
      out.write("id=\"prodimgcarousel\"");
 } 
      out.write(" class=\"carousel slide\">\n<div class=\"carousel-inner product-img-inner\">");
 _boolean_result=false;try {_boolean_result=((Boolean)(((((Boolean) (disableErrorMessages().isDefined(getObject("IncludePrimaryImage")))).booleanValue() && ((Boolean) ((((context.getFormattedValue(getObject("IncludePrimaryImage"),null).equals(context.getFormattedValue("false",null)))) ? Boolean.TRUE : Boolean.FALSE))).booleanValue()) ? Boolean.TRUE : Boolean.FALSE))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",11,e);}if (_boolean_result) { 
 } else { 
...
new TagParameter("ImageType",getObject("ImageType"))}, 13); 
 } 
...
new TagParameter("ProductBO",getObject("ProductBO")),
new TagParameter("ImageType",getObject("ImageType"))}, 16); 
 } 
      out.write("</div>\n<a class=\"left carousel-control\" ");
 _boolean_result=false;try {_boolean_result=((Boolean)((disableErrorMessages().isDefined(getObject("ExpressShop"))))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",19,e);}if (_boolean_result) { 
      out.write("href=\"");
      out.print(context.getFormattedValue("#",null));
      out.write("prodimgcarouselexprshop\"");
 } else { 
      out.write("href=\"");
      out.print(context.getFormattedValue("#",null));
      out.write("prodimgcarousel\"");
 } 
      out.write(" role=\"button\" data-slide=\"prev\">\n<span class=\"glyphicon glyphicon-chevron-left\"></span>\n</a>\n<a class=\"right carousel-control\" ");
 _boolean_result=false;try {_boolean_result=((Boolean)((disableErrorMessages().isDefined(getObject("ExpressShop"))))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",22,e);}if (_boolean_result) { 
      out.write("href=\"");
      out.print(context.getFormattedValue("#",null));
      out.write("prodimgcarouselexprshop\"");
 } else { 
      ...
      out.write("<div id=\"prodimgcarousel\" class=\"carousel slide\">\n<div class=\"product-img-main product-img-inner\">");
 processOpenTag(response, pageContext, "productimage", new TagParameter[] {
new TagParameter("RichSnippetsEnabled",getObject("RichSnippetsEnabled")),
new TagParameter("ImageView","front"),
new TagParameter("ProductBO",getObject("ProductBO")),
new TagParameter("ImageType",getObject("ImageType"))}, 29); 
      out.write("</div>\n</div>");
 } 
 printFooter(out); 
