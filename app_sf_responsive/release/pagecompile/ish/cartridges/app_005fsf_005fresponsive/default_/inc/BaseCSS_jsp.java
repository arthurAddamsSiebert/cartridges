...
public final class BaseCSS_jsp extends com.intershop.beehive.core.internal.template.AbstractTemplate
...
setEncodingType("text/html"); 
 { ISFileBundle filebundle = new ISFileBundle("/css/theme.min.css");List<? extends Resource> resources = null;
...
TemplateExecutionConfig context = getTemplateExecutionConfig(); 
 ...
 {String value = null;try{value=context.getFormattedValue(getObject("File:LastModified"),"0",null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {5}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
      out.write('"');
      out.write('/');
      out.write('>');
