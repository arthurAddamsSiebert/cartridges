...
public final class AttachmentsTab_jsp extends com.intershop.beehive.core.internal.template.AbstractTemplate
...
setEncodingType("text/html"); 
 ...
 _boolean_result=false;try {_boolean_result=((Boolean)((hasLoopElements("ProductBO:ProductAttachments") ? Boolean.TRUE : Boolean.FALSE))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",7,e);}if (_boolean_result) { 
...
new TagParameter("name","collectionItemID")}, 8); 
 ...
 {out.write(localizeISText("product.attachments.heading","",null,null,null,null,null,null,null,null,null,null,null));} 
 ...
 processOpenTag(response, pageContext, "productattachments", new TagParameter[] {
