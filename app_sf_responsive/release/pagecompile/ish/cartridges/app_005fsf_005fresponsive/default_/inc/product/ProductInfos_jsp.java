...
new TagParameter("ProductBO",getObject("ProductBO"))}, 40); 
 ...
 {String value = null;try{value=context.getFormattedValue(getObject("ProductBO:SKU"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {49}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
      out.write('"');
      out.write('/');
      out.write('>');
 } else { 
 while (loop("ProductBO:BundleInformation:BundledProductBOs","RetailSetProduct",null)) { 
 _boolean_result=false;try {_boolean_result=((Boolean)(getObject("RetailSetProduct:Online"))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",52,e);}if (_boolean_result) { 
      out.write("<input type=\"hidden\" name=\"SKU\" value=\"");
 {String value = null;try{value=context.getFormattedValue(getObject("RetailSetProduct:SKU"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {53}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
      out.write('"');
      out.write('/');
      out.write('>');
 } 
...
new TagParameter("ProductBO",getObject("ProductBO"))}, 62); 
 _boolean_result=false;try {_boolean_result=((Boolean)((getObject("ProductBO:isRetailSet")))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",64,e);}if (_boolean_result) { 
...
new TagParameter("Currency",getObject("CurrentRequest:Currency")),
new TagParameter("ProductBO",getObject("ProductBO")),
new TagParameter("class","btn-lg btn-block")}, 65); 
 } else {_boolean_result=false;try {_boolean_result=((Boolean)((getObject("ProductBO:isProductBundle")))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",66,e);}if (_boolean_result) { 
 processOpenTag(response, pageContext, "addtocart", new TagParameter[] {
new TagParameter("InventoryStatus",getObject("InventoryStatus")),
new TagParameter("DataAttributes","data-click-target=ProductBundleAddToCart"),
new TagParameter("Currency",getObject("CurrentRequest:Currency")),
new TagParameter("ProductBO",getObject("ProductBO")),
new TagParameter("class","btn-lg btn-block")}, 67); 
 } else { 
 processOpenTag(response, pageContext, "addtocart", new TagParameter[] {
new TagParameter("InventoryStatus",getObject("InventoryStatus")),
new TagParameter("Currency",getObject("CurrentRequest:Currency")),
...
new TagParameter("CurrentSession",getObject("CurrentSession"))}, 72); 
 processOpenTag(response, pageContext, "productwarranty", new TagParameter[] {
new TagParameter("Currency",getObject("CurrentRequest:Currency")),
new TagParameter("ProductBO",getObject("ProductBO"))}, 74); 
 out.print("</form>"); 
      out.write("</div>");
 printFooter(out); 
