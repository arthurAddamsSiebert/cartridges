...
public final class ShippingTab_jsp extends com.intershop.beehive.core.internal.template.AbstractTemplate
...
response.setHeader(TemplateConstants.PERSONALIZED_HEADER, "1");setEncodingType("text/html"); 
 ...
 {try{executePipeline("ProcessProductTabs-GetShippingDetails",((java.util.Map)(((new ParameterMap().addParameter(new ParameterEntry("ProductBO",getObject("ProductBO"))))))),"ShippingDetailsDict");}catch(Exception e){Logger.error(this,"ISPIPELINE failed. Line: 6.",e);}} 
 processOpenTag(response, pageContext, "uuid", new TagParameter[] {
new TagParameter("name","collectionItemID")}, 8); 
      out.write("<div class=\"panel-heading\" data-testing-id=\"section-shipping-tab\">\n<a data-toggle=\"collapse\" data-parent=\"");
      out.print(context.getFormattedValue("#",null));
      out.write("accordion\" href=\"");
      out.print(context.getFormattedValue("#",null));
 {String value = null;try{value=context.getFormattedValue(getObject("collectionItemID"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {10}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
      out.write("\" class=\"collapsed\">");
 {out.write(localizeISText("product.shipping.heading","",null,null,null,null,null,null,null,null,null,null,null));} 
      out.write(" <span class=\"glyphicon glyphicon-plus pull-right\"></span>\n</a>\n</div>\n<div id=\"");
 {String value = null;try{value=context.getFormattedValue(getObject("collectionItemID"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {14}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
...
new TagParameter("ProductBO",getObject("ProductBO"))}, 16); 
 _boolean_result=false;try {_boolean_result=((Boolean)((hasLoopElements("ShippingDetailsDict:ShippingInformation") ? Boolean.TRUE : Boolean.FALSE))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",18,e);}if (_boolean_result) { 
      out.write("<ul>");
 while (loop("ShippingDetailsDict:ShippingInformation","Info",null)) { 
      out.write("<li>");
 {String value = null;try{value=context.getFormattedValue(getObject("Info"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {21}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
      out.write("</li>");
 } 
      out.write("</ul>");
 } 
      out.write("<strong>");
 {out.write(localizeISText("product.shipping.available_methods","",null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("</strong>");
 _boolean_result=false;try {_boolean_result=((Boolean)((hasLoopElements("ShippingDetailsDict:AdvancedShippingMethods") ? Boolean.TRUE : Boolean.FALSE))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",28,e);}if (_boolean_result) { 
      out.write("<ul>");
 while (loop("ShippingDetailsDict:AdvancedShippingMethods","ShippingMethod",null)) { 
      out.write("<li>");
 {String value = null;try{value=context.getFormattedValue(getObject("ShippingMethod:DisplayName"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {31}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
      out.write("</li>");
 } 
      out.write("</ul>");
 } 
