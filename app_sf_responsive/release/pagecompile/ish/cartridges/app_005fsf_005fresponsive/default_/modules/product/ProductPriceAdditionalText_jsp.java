...
public final class ProductPriceAdditionalText_jsp extends com.intershop.beehive.core.internal.template.AbstractTemplate
...
new TagParameter("currentuserbo","UserBO")}, 4); 
 ...
 _boolean_result=false;try {_boolean_result=((Boolean)((((context.getFormattedValue(getObject("SetAsDictionaryValue"),null).equals(context.getFormattedValue("true",null)))) ? Boolean.TRUE : Boolean.FALSE))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",7,e);}if (_boolean_result) { 
 {Object temp_obj = (getObject("PriceDisplayPreferences:AdditionalText")); getPipelineDictionary().put("ProductPriceAdditionalText", temp_obj);} 
 } else { 
      out.write("<span class=\"price-note\">\n&nbsp;");
 {String value = null;try{value=context.getFormattedValue(getObject("PriceDisplayPreferences:AdditionalText"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {11}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
      out.write("</span>");
 } 
 } 
 } 
