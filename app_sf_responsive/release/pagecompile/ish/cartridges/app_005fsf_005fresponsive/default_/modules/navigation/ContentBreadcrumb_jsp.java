...
public final class ContentBreadcrumb_jsp extends com.intershop.beehive.core.internal.template.AbstractTemplate
...
setEncodingType("text/html"); 
 ...
 {try{executePipeline("ProcessContentNavigation-Breadcrumbs",((java.util.Map)(((new ParameterMap().addParameter(new ParameterEntry("RootID",getObject("navigationRoot")))).addParameter(new ParameterEntry("Locale",getObject("locale"))).addParameter(new ParameterEntry("PageletEntryPointID",getObject("currentPageletEntryPointID")))))),"dict");}catch(Exception e){Logger.error(this,"ISPIPELINE failed. Line: 4.",e);}} 
...
new TagParameter("link2",url(true,(new URLPipelineAction(context.getFormattedValue("ViewContent-Start",null))),(new URLParameterSet().addURLParameter(context.getFormattedValue("PageletEntryPointID",null),context.getFormattedValue(getObject("dict:EntryPoint2"),null)))))}, 6); 
 printFooter(out); 
