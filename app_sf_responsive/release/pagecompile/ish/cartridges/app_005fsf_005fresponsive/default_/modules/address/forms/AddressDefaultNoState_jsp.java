...
new TagParameter("useaddress3","true")}, 10); 
 ...
 {out.flush();processLocalIncludeByServer((com.intershop.beehive.core.capi.request.ServletResponse)response,"modules/address/forms/inc/CountrySelect.isml", null, "17");} 
      out.write("</fieldset>");
 {out.flush();processExtensionPoint((com.intershop.beehive.core.capi.request.ServletResponse)response,"AddressDefaultNoStateExtensions", null, "20");} 
      out.write("<fieldset>");
 ...
 {out.flush();processLocalIncludeByServer((com.intershop.beehive.core.capi.request.ServletResponse)response,"modules/address/forms/inc/PostalCodeInput.isml", null, "31");} 
 processOpenTag(response, pageContext, "cityinput", new TagParameter[] {
new TagParameter("showtooltip","false")}, 32); 
      out.write("</fieldset>");
 {out.flush();processLocalIncludeByServer((com.intershop.beehive.core.capi.request.ServletResponse)response,"modules/address/forms/inc/PhoneInput.isml", null, "34");} 
 _boolean_result=false;try {_boolean_result=((Boolean)((disableErrorMessages().isDefined(getObject("isRegistration"))))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",36,e);}if (_boolean_result) { 
 {out.flush();processLocalIncludeByServer((com.intershop.beehive.core.capi.request.ServletResponse)response,"modules/address/forms/RegistrationAddition", null, "37");} 
 } 
      out.write("</div>");
 printFooter(out); 
