...
public final class SecurityQuestionSelectBox_jsp extends com.intershop.beehive.core.internal.template.AbstractTemplate
...
setEncodingType("text/html"); 
 ...
 while (loop("SecurityQuestionEnumerationKeyProvider:AllKeys","CurrentKey",null)) { 
 processOpenTag(response, pageContext, "addsecurityquestion", new TagParameter[] {
