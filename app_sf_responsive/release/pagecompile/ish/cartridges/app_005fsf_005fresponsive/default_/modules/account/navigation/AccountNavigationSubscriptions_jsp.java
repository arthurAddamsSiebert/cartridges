...
public final class AccountNavigationSubscriptions_jsp extends com.intershop.beehive.core.internal.template.AbstractTemplate
...
new TagParameter("return","EnableRecurringOrders")}, 6); 
 ...
 _boolean_result=false;try {_boolean_result=((Boolean)((((context.getFormattedValue(getObject("selecteditem"),null).equals(context.getFormattedValue("SUBSCRIPTIONS",null)))) ? Boolean.TRUE : Boolean.FALSE))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",9,e);}if (_boolean_result) { 
      ...
      out.write("\" data-testing-id=\"myaccount-subscriptions-link\">");
