...
public final class ProductListFilters_jsp extends com.intershop.beehive.core.internal.template.AbstractTemplate
...
setEncodingType("text/html"); 
 {out.flush();processLocalIncludeByServer((com.intershop.beehive.core.capi.request.ServletResponse)response,"modules/Modules", null, "3");} 
      out.write("<div class=\"filters-row row\">\n<div class=\"col-md-7 col-sm-9 col-xs-12 switch-layout\">");
 _boolean_result=false;try {_boolean_result=((Boolean)((disableErrorMessages().isDefined(getObject("ListNavigationVO"))))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",6,e);}if (_boolean_result) { 
...
new TagParameter("pagenumber",getObject("ListNavigationVO:CurrentPage"))}, 22); 
 ...
 _boolean_result=false;try {_boolean_result=((Boolean)(((((Boolean) (disableErrorMessages().isDefined(getObject("ViewType")))).booleanValue() && ((Boolean) ((((context.getFormattedValue(getObject("ViewType"),null).equals(context.getFormattedValue("2",null)))) ? Boolean.TRUE : Boolean.FALSE))).booleanValue() || ((Boolean) ((((Boolean) ((disableErrorMessages().isDefined(getObject("ViewType"))))).booleanValue() ? Boolean.FALSE : Boolean.TRUE) )).booleanValue()) ? Boolean.TRUE : Boolean.FALSE))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",29,e);}if (_boolean_result) { 
      out.write(" list-active");
 } 
      out.write("\">\n<span class=\"glyphicon glyphicon-list\"></span>\n</a>\n<a data-testing-id=\"grid-view-link\" href=\"");
 processOpenTag(response, pageContext, "paginglink", new TagParameter[] {
new TagParameter("pipelinename",context.getFormattedValue(getObject("ListNavigationVO:HandlerPipeline"),null) + context.getFormattedValue("-ProductPaging",null)),
new TagParameter("sortvalue",getObject("ListNavigationVO:SortingAttribute")),
new TagParameter("pagesize",getObject("ListNavigationVO:PageSize")),
...
new TagParameter("ListNavigationVO",getObject("ListNavigationVO"))}, 48); 
      out.write("</div> \n</div>");
 printFooter(out); 
