 ...
 */
package ish.cartridges.app_005fsf_005fresponsive.default_.expressshop;
...
new TagParameter("ProductBO",getObject("ProductBO"))}, 40); 
 ...
 {String value = null;try{value=context.getFormattedValue(getObject("ProductBO:SKU"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {44}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
      out.write('"');
      out.write('/');
      out.write('>');
 } else { 
 while (loop("ProductBO:BundleInformation:BundledProductBOs","RetailSetProduct",null)) { 
 _boolean_result=false;try {_boolean_result=((Boolean)(getObject("RetailSetProduct:Online"))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",47,e);}if (_boolean_result) { 
      out.write("<input type=\"hidden\" name=\"SKU\" value=\"");
 {String value = null;try{value=context.getFormattedValue(getObject("RetailSetProduct:SKU"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {48}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
      out.write('"');
      out.write('/');
      out.write('>');
 } 
...
new TagParameter("CurrentSession",getObject("CurrentSession"))}, 65); 
