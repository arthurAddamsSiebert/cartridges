...
new TagParameter("useaddress3","true")}, 10); 
 ...
 {out.flush();processExtensionPoint((com.intershop.beehive.core.capi.request.ServletResponse)response,"AddressDefaultExtensions", null, "21");} 
      out.write("<fieldset>");
...
new TagParameter("showtooltip","false")}, 35); 
 {out.flush();processLocalIncludeByServer((com.intershop.beehive.core.capi.request.ServletResponse)response,"modules/address/forms/inc/PostalCodeInput.isml", null, "36");} 
      out.write("</fieldset>");
 {out.flush();processLocalIncludeByServer((com.intershop.beehive.core.capi.request.ServletResponse)response,"modules/address/forms/inc/StateSelect.isml", null, "39");} 
 _boolean_result=false;try {_boolean_result=((Boolean)((disableErrorMessages().isDefined(getObject("isRegistration"))))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",41,e);}if (_boolean_result) { 
 {out.flush();processLocalIncludeByServer((com.intershop.beehive.core.capi.request.ServletResponse)response,"modules/address/forms/RegistrationAddition", null, "42");} 
 } else { 
 {out.flush();processLocalIncludeByServer((com.intershop.beehive.core.capi.request.ServletResponse)response,"modules/address/forms/inc/PhoneInput.isml", null, "44");} 
 } 
      out.write("</div>");
 printFooter(out); 
