 ...
 */
package ish.cartridges.app_005fsf_005fresponsive_005fsmb.default_.account.overview;
...
setEncodingType("text/html"); 
 {try{executePipeline("ProcessOrders-GetLatestOrders",((java.util.Map)(((new ParameterMap().addParameter(new ParameterEntry("CurrentUser",getObject("CurrentUser")))).addParameter(new ParameterEntry("CurrentRequest",getObject("CurrentRequest")))))),"dict");}catch(Exception e){Logger.error(this,"ISPIPELINE failed. Line: 3.",e);}} 
      out.write("<div class=\"section\">");
 _boolean_result=false;try {_boolean_result=((Boolean)((hasLoopElements("dict:SortedOrders") ? Boolean.TRUE : Boolean.FALSE))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",6,e);}if (_boolean_result) { 
 ...
 while (loop("dict:SortedOrders","OrderBO",null)) { 
...
new TagParameter("numberOfItemsColumnWith","2")}, 19); 
 } 
      out.write("</div>");
 } else { 
      out.write('<');
