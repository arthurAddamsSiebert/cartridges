...
public final class CheckoutAddressCompanyInformation_jsp extends com.intershop.beehive.core.internal.template.AbstractTemplate
...
setEncodingType("text/html"); 
 ...
 _boolean_result=false;try {_boolean_result=((Boolean)(getObject("CheckoutAddressCompanyInformationForm:Department:isInvalid"))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",5,e);}if (_boolean_result) { 
      out.write(" has-error");
 } 
 ...
 {String value = null;try{value=context.getFormattedValue(getObject("CheckoutAddressCompanyInformationForm:Department:Value"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {14}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
      ...
      out.write("\nvalue=\"");
 {String value = null;try{value=context.getFormattedValue(getObject("BasketBOCompanyCustomerExtension:Department"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {16}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
      out.write('"');
      out.write('\n');
 } 
      out.write("\nclass=\"form-control\"\nmaxlength=\"60\"\n/>\n</div>\n</div>\n<div class=\"form-group ");
 _boolean_result=false;try {_boolean_result=((Boolean)(getObject("CheckoutAddressCompanyInformationForm:TaxationID:isInvalid"))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",24,e);}if (_boolean_result) { 
      out.write(" has-error");
 } 
      out.write("\">\n<label class=\"control-label col-sm-4\" for=\"");
 ...
 {String value = null;try{value=context.getFormattedValue(getObject("CheckoutAddressCompanyInformationForm:TaxationID:Value"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {33}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
      ...
      out.write("\nvalue=\"");
 {String value = null;try{value=context.getFormattedValue(getObject("BasketBOCompanyCustomerExtension:TaxationID"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {35}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
      out.write('"');
      out.write('\n');
 } 
      out.write("\nclass=\"form-control\"\nmaxlength=\"60\" \n/>\n</div>\n</div>");
