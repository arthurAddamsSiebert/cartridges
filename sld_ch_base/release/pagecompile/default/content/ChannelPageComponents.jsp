...
new TagParameter("link",url(true,(new URLPipelineAction(context.getFormattedValue("ViewOverview-Content",null))),(new URLParameterSet().addURLParameter(context.getFormattedValue("ChannelID",null),context.getFormattedValue(getObject("ChannelID"),null))).addURLParameter(context.getFormattedValue("UniquePageletSearchID",null),context.getFormattedValue("ChannelPageComponents",null)))),
new TagParameter("start","true"),
new TagParameter("text",localizeText(context.getFormattedValue("ChannelPageComponents.Content.text",null)))}, 8); %><% processOpenTag(response, pageContext, "breadcrumbtrail", new TagParameter[] {
...
new TagParameter("id","CompSearchContainer"),
new TagParameter("text",localizeText(context.getFormattedValue("ChannelPageComponents.Components.text",null)))}, 9); %><!-- EO Page Navigator --><% processOpenTag(response, pageContext, "pageletsearch", new TagParameter[] {
...
new TagParameter("targetpageletviewpipeline","ViewChannelPageComponents-Dispatch"),
new TagParameter("notfoundtemplate","content/search/inc/EmptyPageletSearchResult"),
new TagParameter("uniqueid","ChannelPageComponents")}, 12); %><% printFooter(out); %>