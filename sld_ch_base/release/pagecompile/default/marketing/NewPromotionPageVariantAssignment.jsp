...
new TagParameter("link",url(true,(new URLPipelineAction(context.getFormattedValue("ViewPromotionContentAssignment-AssignPageVariantsPaging",null))),(new URLParameterSet().addURLParameter(context.getFormattedValue("PageFlag",null),context.getFormattedValue(getObject("PageFlag"),null))).addURLParameter(context.getFormattedValue("PromotionUUID",null),context.getFormattedValue(getObject("ContextObjectUUID"),null)).addURLParameter(context.getFormattedValue("RepositoryUUID",null),context.getFormattedValue(getObject("RepositoryUUID"),null)).addURLParameter(context.getFormattedValue("ContextObjectUUID",null),context.getFormattedValue(getObject("ContextObjectUUID"),null)))),
new TagParameter("id","AssignPageToObject"),
new TagParameter("text",localizeText(context.getFormattedValue("NewPromotionPageVariantAssignment.AssignPageVariant.text",null)))}, 5); %><% processOpenTag(response, pageContext, "createmap", new TagParameter[] {
...
new TagParameter("targetpageletviewpipeline","ViewPromotionContentAssignment-DispatchPageVariantAssignment"),
new TagParameter("uniqueid","NewPromotionPageVariantAssignment")}, 12); %><% printFooter(out); %>