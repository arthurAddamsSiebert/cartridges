...
new TagParameter("text",localizeText(context.getFormattedValue("ApplicationPermissionSelectUser.Step1SelectUser.text",null)))}, 7); %><!-- Main Content --><% URLPipelineAction action335 = new URLPipelineAction(context.getFormattedValue(url(true,(new URLPipelineAction(context.getFormattedValue("ViewApplicationPermissionList-Dispatch",null)))),null));String site335 = null;String serverGroup335 = null;String actionValue335 = context.getFormattedValue(url(true,(new URLPipelineAction(context.getFormattedValue("ViewApplicationPermissionList-Dispatch",null)))),null);if (site335 == null){  site335 = action335.getDomain();  if (site335 == null)  {      site335 = com.intershop.beehive.core.capi.request.Request.getCurrent().getRequestSite().getDomainName();  }}if (serverGroup335 == null){  serverGroup335 = action335.getServerGroup();  if (serverGroup335 == null)  {      serverGroup335 = com.intershop.beehive.core.capi.request.Request.getCurrent().getRequestSite().getServerGroup();  }}out.print("<form");out.print(" method=\"");out.print("post");out.print("\"");out.print(" action=\"");out.print(context.getFormattedValue(url(true,(new URLPipelineAction(context.getFormattedValue("ViewApplicationPermissionList-Dispatch",null)))),null));out.print("\"");out.print(" data-testing-id=\"");out.print("bo-application-permission-select-user-page");out.print("\"");out.print(" name=\"");out.print("detailForm");out.print("\"");out.print(">");out.print(context.prepareWACSRFTag(actionValue335, site335, serverGroup335,true)); %><table border="0" cellspacing="0" cellpadding="0" width="100%">
<tr>
<td>
<table border="0" cellpadding="0" cellspacing="0" width="100%" class="aldi">
<tr>
<td class="table_title s"><% {out.write(localizeISText("ApplicationPermissionSelectUser.Step1SelectUser.table_title",null,null,null,null,null,null,null,null,null,null,null,null));} %></td>
</tr>
...
<td class="error top" width="100%"><% {out.write(localizeISText("ApplicationPermissionSelectUser.PleaseSelectAtLeastOneUser.error",null,null,null,null,null,null,null,null,null,null,null,null));} %></td>
</tr>
</table>
</td>
</tr><% } %><tr>
<td class="table_title_description"><% {out.write(localizeISText("ApplicationPermissionSelectUser.Step1Of2NextStepsSelectAccessPrivileges.table_title_description",null,null,null,null,null,null,null,null,null,null,null,null));} %></td>
</tr>
</table>
...
<tr>
<td nowrap="nowrap"><a href="javascript:selectAll('detailForm','SelectedUser','A','B');" class="tableheader"><% {out.write(localizeISText("ApplicationPermissionSelectUser.SelectAll.link",null,null,null,null,null,null,null,null,null,null,null,null));} %></a></td>
</tr>
</table>
</div>
...
<table border="0" cellspacing="0" cellpadding="0" class="table_header center" width="80">
<tr>
<td nowrap="nowrap"><a href="javascript:selectAll('detailForm','SelectedUser','A','B');" class="tableheader"><% {out.write(localizeISText("ApplicationPermissionSelectUser.ClearAll.link",null,null,null,null,null,null,null,null,null,null,null,null));} %></a></td>
</tr>
</table>
</div>
...
<td class="table_header e s"><% {out.write(localizeISText("ApplicationPermissionSelectUser.Name.table_header",null,null,null,null,null,null,null,null,null,null,null,null));} %></td>
...
<td class="table_detail e s top"> <% {out.write(localizeISText("ApplicationPermissionSelectUser.AllUsersHaveAlreadyBeenAssigned.table_detail",null,null,null,null,null,null,null,null,null,null,null,null));} %> </td>
</tr><% } %></table>
<table class="w e s" width="100%" border="0" cellspacing="0" cellpadding="0">
<tr>
<td align="right">
<table cellpadding="0" cellspacing="4" border="0">
<tr><% _boolean_result=false;try {_boolean_result=((Boolean)((hasLoopElements("UserProfiles") ? Boolean.TRUE : Boolean.FALSE))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",82,e);}if (_boolean_result) { %><td class="button"><input type="submit" name="next" value="<%=context.getFormattedValue(localizeText(context.getFormattedValue("ApplicationPermissionSelectUser.Next.button",null)),null)%>&nbsp;&gt;&gt;" class="button"/></td>
<td class="button"><input type="submit" name="cancelUser" value="<%=context.getFormattedValue(localizeText(context.getFormattedValue("ApplicationPermissionSelectUser.Cancel.button",null)),null)%>" class="button"/></td><% } else { %><td>&nbsp;</td>
<td class="button"><input type="submit" name="cancelUser" value="<%=context.getFormattedValue(localizeText(context.getFormattedValue("ApplicationPermissionSelectUser.Cancel.button",null)),null)%>" class="button"/></td><% } %></tr>
</table>
</td>
</tr>
</table>
...
new TagParameter("pipeline","ViewApplicationPermissionWizard-SelectUserPaging"),
