...
new TagParameter("link",url(true,(new URLPipelineAction(context.getFormattedValue("ViewApplicationPermission-Dispatch",null))),(new URLParameterSet().addURLParameter(context.getFormattedValue("RepositoryUUID",null),context.getFormattedValue(getObject("RepositoryUUID"),null))).addURLParameter(context.getFormattedValue("PermissionType",null),context.getFormattedValue(getObject("PermissionType"),null)).addURLParameter(context.getFormattedValue("previous",null),context.getFormattedValue("",null)))),
new TagParameter("text",localizeText(context.getFormattedValue("ApplicationPermissionSelectMasterRole.Step1SelectMasterRole.text",null)))}, 6); %><% URLPipelineAction action329 = new URLPipelineAction(context.getFormattedValue(url(true,(new URLPipelineAction(context.getFormattedValue("ViewApplicationPermissionList-Dispatch",null)))),null));String site329 = null;String serverGroup329 = null;String actionValue329 = context.getFormattedValue(url(true,(new URLPipelineAction(context.getFormattedValue("ViewApplicationPermissionList-Dispatch",null)))),null);if (site329 == null){  site329 = action329.getDomain();  if (site329 == null)  {      site329 = com.intershop.beehive.core.capi.request.Request.getCurrent().getRequestSite().getDomainName();  }}if (serverGroup329 == null){  serverGroup329 = action329.getServerGroup();  if (serverGroup329 == null)  {      serverGroup329 = com.intershop.beehive.core.capi.request.Request.getCurrent().getRequestSite().getServerGroup();  }}out.print("<form");out.print(" method=\"");out.print("post");out.print("\"");out.print(" action=\"");out.print(context.getFormattedValue(url(true,(new URLPipelineAction(context.getFormattedValue("ViewApplicationPermissionList-Dispatch",null)))),null));out.print("\"");out.print(" name=\"");out.print("detailForm");out.print("\"");out.print(">");out.print(context.prepareWACSRFTag(actionValue329, site329, serverGroup329,true)); %><input type="hidden" name="RepositoryUUID" value="<% {String value = null;try{value=context.getFormattedValue(getObject("RepositoryUUID"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {9}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} %>"/>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
<tr>
<td class="table_title aldi"><% {out.write(localizeISText("ApplicationPermissionSelectMasterRole.Step1SelectMasterRole.table_title",null,null,null,null,null,null,null,null,null,null,null,null));} %></td>
</tr>
...
<td class="error top" width="100%"><% {out.write(localizeISText("ApplicationPermissionSelectMasterRole.YouHaveNotSelectedAMasterRoleSelectOne.error",null,null,null,null,null,null,null,null,null,null,null,null));} %></td>
</tr>
</table>
</td>
</tr><% } %><tr>
<td class="table_title_description w e s"><% {out.write(localizeISText("ApplicationPermissionSelectMasterRole.Step1Of2NextStepSelectAccessPrivileges.table_title_description",null,null,null,null,null,null,null,null,null,null,null,null));} %></td>
</tr>
</table>
...
<tr>
<td nowrap="nowrap">
<a href="javascript:selectAll('detailForm','SelectedRole','A','B');" class="tableheader"><% {out.write(localizeISText("ApplicationPermissionSelectMasterRole.SelectAll.link",null,null,null,null,null,null,null,null,null,null,null,null));} %></a>
</td>
</tr>
</table>
</div>
...
<tr>
<td nowrap="nowrap">
<a href="javascript:selectAll('detailForm','SelectedRole','A','B');" class="tableheader"><% {out.write(localizeISText("ApplicationPermissionSelectMasterRole.ClearAll.link",null,null,null,null,null,null,null,null,null,null,null,null));} %></a>
</td>
</tr>
</table>
</div></td>
<td class="table_header e s"><% {out.write(localizeISText("ApplicationPermissionSelectMasterRole.Name.table_header",null,null,null,null,null,null,null,null,null,null,null,null));} %></td>
<td class="table_header e s"><% {out.write(localizeISText("ApplicationPermissionSelectMasterRole.Type.table_header",null,null,null,null,null,null,null,null,null,null,null,null));} %></td>
<td class="table_header e s"><% {out.write(localizeISText("ApplicationPermissionSelectMasterRole.Description.table_header",null,null,null,null,null,null,null,null,null,null,null,null));} %></td>
...
<td class="table_detail e s top"><% _boolean_result=false;try {_boolean_result=((Boolean)(getObject("Role:isFix"))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",66,e);}if (_boolean_result) { %><% {out.write(localizeISText("ApplicationPermissionSelectMasterRole.Standard.table_detail",null,null,null,null,null,null,null,null,null,null,null,null));} %><% } else { %><% {out.write(localizeISText("ApplicationPermissionSelectMasterRole.Custom.table_detail",null,null,null,null,null,null,null,null,null,null,null,null));} %><% } %></td>
...
<td class="table_detail w e s top" colspan="4"> <% {out.write(localizeISText("ApplicationPermissionSelectMasterRole.AllMasterRolesHaveAlreadyBeenAssigned.table_detail",null,null,null,null,null,null,null,null,null,null,null,null));} %> </td>
</tr><% } %></table>
<table class="w e s" width="100%" border="0" cellspacing="0" cellpadding="0">
<tr>
<td align="right">
<table cellpadding="0" cellspacing="4" border="0">
<tr><% _boolean_result=false;try {_boolean_result=((Boolean)((disableErrorMessages().isDefined(getObject("Roles"))))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",81,e);}if (_boolean_result) { %><td class="button"><input type="submit" name="next" value="<%=context.getFormattedValue(localizeText(context.getFormattedValue("ApplicationPermissionSelectMasterRole.Next.button",null)),null)%>&nbsp;&gt;&gt;" class="button"/></td><% } %><td class="button"><input type="submit" name="cancelDMR" value="<%=context.getFormattedValue(localizeText(context.getFormattedValue("ApplicationPermissionSelectMasterRole.Cancel.button",null)),null)%>" class="button"/></td>
</tr>
</table>
</td>
</tr>
...
new TagParameter("pipeline","ViewApplicationPermissionWizard-SelectMasterRolePaging"),
