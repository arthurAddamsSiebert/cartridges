...
public final class ChannelCatalogFilterCatalogsExceptionsCatalogInclude_jsp extends com.intershop.beehive.core.internal.template.AbstractTemplate
...
setEncodingType("text/html"); 
 ...
 {out.write(localizeISText("ChannelCatalogFilterCatalogsExceptionsCatalogInclude.Exclude.table_header",null,null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("</td>\n<td class=\"table_header s e\" nowrap=\"nowrap\">");
 {out.write(localizeISText("ChannelCatalogFilterCatalogsExceptionsCatalogInclude.Name.table_header",null,null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("</td>\n<td class=\"table_header s\" nowrap=\"nowrap\" width=\"99%\">");
 {out.write(localizeISText("ChannelCatalogFilterCatalogsExceptionsCatalogInclude.Description.table_header",null,null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("</td>\n</tr>");
...
new TagParameter("mapname","GetSQDByNameParamMap")}, 17); 
 ...
 _boolean_result=false;try {_boolean_result=((Boolean)(((!((Boolean) (getObject("CatalogFilter:isInExcludedCategories(Catalog:Root)"))).booleanValue() && ((Boolean) getObject("CFHelper:isChildExclusionRule(Catalog:Root)")).booleanValue()) ? Boolean.TRUE : Boolean.FALSE))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",25,e);}if (_boolean_result) { 
 ...
 } else {_boolean_result=false;try {_boolean_result=((Boolean)(getObject("CatalogFilter:isInExcludedCategories(Catalog:Root)"))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",41,e);}if (_boolean_result) { 
 ...
 _boolean_result=false;try {_boolean_result=((Boolean)(getObject("CFHelper:isChildExclusionRule(Catalog:Root)"))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",57,e);}if (_boolean_result) { 
      out.write("<img src=\"");
      out.print(context.getFormattedValue(context.webRoot(),null));
      out.write("/images/catalogfilter.gif\" alt=\"");
      out.print(context.getFormattedValue(localizeText(context.getFormattedValue("ChannelCatalogFilterCatalogsExceptionsCatalogInclude.ImplicitlyExcludedByLowerLevel.alt",null)),null));
      out.write("\" border=\"0\"/>");
 } else { 
      out.write("<img src=\"");
      out.print(context.getFormattedValue(context.webRoot(),null));
 ...
 _boolean_result=false;try {_boolean_result=((Boolean)(getObject("CFHelper:isCurrentlyVisible(Catalog:Root)"))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",63,e);}if (_boolean_result) { 
      ...
      out.write("\" class=\"catalog\"><span class=\"catalogfilter_visible\">");
 ...
 _boolean_result=false;try {_boolean_result=((Boolean)((disableErrorMessages().isDefined(getObject("GetCatalogSQDByNameResultDict:SearchQueryDefinition"))))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",66,e);}if (_boolean_result) { 
      ...
      out.print(context.getFormattedValue(localizeText(context.getFormattedValue("ChannelCatalogFilterCatalogsExceptionsCatalogInclude.DynamicProductBinding.alt",null)),null));
      out.write("\" title=\"");
      out.print(context.getFormattedValue(localizeText(context.getFormattedValue("ChannelCatalogFilterCatalogsExceptionsCatalogInclude.DynamicProductBinding.title",null)),null));
      out.write("\" border=\"0\"/>");
 } 
      out.write("</td>\n<td class=\"table_detail s\" width=\"99%\">\n<span class=\"catalogfilter_visible\">");
 {String value = null;try{value=context.getFormattedValue(getObject("Catalog:ShortDescription"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {69}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
      ...
      out.write("<td class=\"table_detail s e\" nowrap=\"nowrap\">\n<a href=\"");
      out.print(context.getFormattedValue(url(true,(new URLPipelineAction(context.getFormattedValue("ViewChannelCatalogFilterCatalogsExceptions-Edit",null))),(new URLParameterSet().addURLParameter(context.getFormattedValue("ChannelID",null),context.getFormattedValue(getObject("CurrentChannel:UUID"),null))).addURLParameter(context.getFormattedValue("CatalogFilterUUID",null),context.getFormattedValue(getObject("CatalogFilter:UUID"),null)).addURLParameter(context.getFormattedValue("CatalogCategoryUUID",null),context.getFormattedValue(getObject("Catalog:Root:UUID"),null))),null));
      out.write("\" class=\"catalog\"><span class=\"catalogfilter_invisible\">");
 ...
 _boolean_result=false;try {_boolean_result=((Boolean)((disableErrorMessages().isDefined(getObject("GetCatalogSQDByNameResultDict:SearchQueryDefinition"))))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",74,e);}if (_boolean_result) { 
      ...
      out.write("</td>\n<td class=\"table_detail s\" width=\"99%\">\n<span class=\"catalogfilter_invisible\">");
