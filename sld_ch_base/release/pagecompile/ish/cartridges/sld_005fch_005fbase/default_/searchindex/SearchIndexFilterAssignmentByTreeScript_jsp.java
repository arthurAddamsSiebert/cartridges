...
public final class SearchIndexFilterAssignmentByTreeScript_jsp extends com.intershop.beehive.core.internal.template.AbstractTemplate
...
setEncodingType("text/javascript"); 
      ...
      out.print(context.getFormattedValue(context.getFormattedValue("#",null) + context.getFormattedValue(getObject("params:TreeId"),null),null));
      ...
      out.write("children.each(function eachChild() {\nchangeState($(this));\n});\n}\n} else {\naddState(node, typeAdd);\n}\n};\nnodes.each(function eachNode() {\nchangeState($(this));\n}); \n});\n");
 printFooter(out); 
