...
public final class PromotionDetailsHeadingInc_jsp extends com.intershop.beehive.core.internal.template.AbstractTemplate
...
setEncodingType("text/html"); 
 ...
 {String value = null;try{value=context.getFormattedValue(getObject("Promotion:UUID"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {9}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
      out.write("\"/>\n\t\t\t\t<input type=\"submit\" name=\"copyDialog\" value=\"");
      out.print(context.getFormattedValue(localizeText(context.getFormattedValue("PromotionDetailsHeadingInc.Copy.button",null)),null));
      out.write("\" class=\"button\"/>\n\t\t\t\t<input type=\"submit\" name=\"confirmDelete\" value=\"");
      out.print(context.getFormattedValue(localizeText(context.getFormattedValue("PromotionDetailsHeadingInc.Delete.button",null)),null));
      out.write("\" class=\"button\"/>\n\t\t\t</div>\n\t\t\t");
 ...
 {String value = null;try{value=context.getFormattedValue(getObject("Promotion:UUID"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {15}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
      out.write("\" />\n\t\t\t\t\t<input type=\"submit\" name=\"selectStagingTarget\" value=\"");
      out.print(context.getFormattedValue(localizeText(context.getFormattedValue("PromotionDetailsHeadingInc.PublishToLiveSystem.button",null)),null));
      out.write("\" class=\"button\" />\n\t\t\t\t</div>\n\t\t\t");
 } 
      out.write("\n\t\t</div>\n\t");
 } 
 ...
 {String value = null;try{value=context.getFormattedValue(getObject("Promotion:Description"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {28}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
      out.write("</div>");
 } 
      out.write('\n');
      out.write('	');
 ...
 _boolean_result=false;try {_boolean_result=((Boolean)((disableErrorMessages().isDefined(getObject("CurrentChannelPermissionMap:SLD_MANAGE_MARKETING"))))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",31,e);}if (_boolean_result) { 
      out.write("\n\t\t<h1 class=\"headline headline-top\">");
 {out.write(localizeISText("PromotionDetailsHeadingInc.NewPromotion.headline",null,null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("</h1>\n\t");
 } 
      out.write('\n');
 } 
