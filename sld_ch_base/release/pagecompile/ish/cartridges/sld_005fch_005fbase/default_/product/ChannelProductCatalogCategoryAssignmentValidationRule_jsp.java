...
public final class ChannelProductCatalogCategoryAssignmentValidationRule_jsp extends com.intershop.beehive.core.internal.template.AbstractTemplate
...
setEncodingType("text/html"); 
 ...
 {out.write(localizeISText("validationrule.page.selectAtLeastOneCategoryAssignment","",null,null,null,null,null,null,null,null,null,null,null));} 
 ...
 {out.write(localizeISText("validationrule.product.categoryassignment.page.standardCatalog","",null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("</label>\n</td>\n</tr>\n</table>\n</td>\n</tr>");
 _boolean_result=false;try {_boolean_result=((Boolean)((hasLoopElements("ClassificationCatalogs") ? Boolean.TRUE : Boolean.FALSE))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",59,e);}if (_boolean_result) { 
      out.write("<tr>\n<td>\n<div>\n<table border=\"0\" cellpadding=\"3\" cellspacing=\"\">");
 while (loop("ClassificationCatalogs","Catalog",null)) { 
      out.write("<tr>\n<td class=\"input_checkbox\" width=\"4%\">\n<input type=\"checkbox\" id=\"ProductCategoryAssignmentValidationRuleConfigurationForm_assignedToClassificationCatalogs\" name=\"ProductCategoryAssignmentValidationRuleConfigurationForm_assignedToClassificationCatalogs_");
      out.print(context.getFormattedValue(getObject("Catalog:UUID"),null));
      out.write("\" class=\"rule_configuration_input\"/>\n</td>\n<td nowrap=\"nowrap\" class=\"label_checkbox_text\">\n<label class=\"label label_checkbox_text label_light\" for=\"ProductCategoryAssignmentValidationRuleConfigurationForm_assignedToClassificationCatalogs\">");
 {out.write(localizeISText("validationrule.product.categoryassignment.page.classificationCatalog","",null,context.getFormattedValue(getObject("Catalog:DisplayName"),null),null,null,null,null,null,null,null,null,null));} 
      out.write("</label>\n</td>\n</tr>");
 } 
      out.write("</table>\n</div>\n</td>\n</tr>");
 } 
