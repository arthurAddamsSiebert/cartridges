...
public final class ChannelProductValidationRuleListColumns_jsp extends com.intershop.beehive.core.internal.template.AbstractTemplate
...
setEncodingType("text/javascript"); 
 ...
 _boolean_result=false;try {_boolean_result=((Boolean)((disableErrorMessages().isDefined(getObject("params:ProductValidationRulePermissionForEdit"))))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",13,e);}if (_boolean_result) { 
      ...
      out.write("\nname: {\ntype: 'text',\ndataKey: 'displayName',\ntitle: '");
 {out.write(localizeISText("ChannelProductValidationRuleListColumns.Name",null,null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("',\nsortable: true\n}, \ntype: {\ntype: 'text',\ndataKey: 'type',\nsortable: true,\nwidth: 250,\ntitle: '");
 {out.write(localizeISText("ChannelProductValidationRuleListColumns.Type",null,null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("'\n},\nactive: {\ntype: 'status',\ndataKey: 'isActive',\nsortable: true,\ntitle: '");
 {out.write(localizeISText("ChannelProductValidationRuleListColumns.Active",null,null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("',\nwidth: 70,\nrender: function(params) {\nvar isActive = params.row.isActive,\nsrc = '',\ntitle = '';\nif (isActive) {\ntitle = '");
 {out.write(localizeISText("product.validationrules.active","",null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("';\nsrc = 'online.png';\n} else {\ntitle = '");
 {out.write(localizeISText("product.validationrules.inactive","",null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("';\nsrc = 'inactive.png'; \n} \nreturn '<img src=\"");
      out.print(context.getFormattedValue(context.webRoot(),null));
      out.write("/images/' + src + '\" alt=\"' + title + '\" title=\"' + title + '\" border=\"0\" />&nbsp;';\n}\n} \n},\nnames = [");
 {String value = null;try{value=context.getFormattedValue(getObject("columns"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {58}",e);}if (value==null) value="";out.write(value);} 
