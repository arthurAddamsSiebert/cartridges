...
public final class ChannelProductValidationAssortmentListColumns_jsp extends com.intershop.beehive.core.internal.template.AbstractTemplate
...
setEncodingType("text/javascript"); 
 ...
 _boolean_result=false;try {_boolean_result=((Boolean)((disableErrorMessages().isDefined(getObject("params:ProductValidationAssortmentPermissionForEdit"))))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",13,e);}if (_boolean_result) { 
      ...
      out.write("\nname: {\ntype: 'text',\ndataKey: 'name',\nsortable: false,\ntitle: '");
 {out.write(localizeISText("ChannelProductValidationAssortmentListColumns.Name",null,null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("',\nwidth: 500\n},\ntype: {\ntype: 'text',\ndataKey: 'type',\ntitle: '");
 {out.write(localizeISText("ChannelProductValidationAssortmentListColumns.Type",null,null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("',\nsortable: false\n}\n},\nnames = [");
 {String value = null;try{value=context.getFormattedValue(getObject("columns"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {35}",e);}if (value==null) value="";out.write(value);} 
