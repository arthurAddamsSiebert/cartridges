...
public final class ChannelProductPriceListValidationRule_jsp extends com.intershop.beehive.core.internal.template.AbstractTemplate
...
setEncodingType("text/html"); 
 ...
 out.print("</waplacement>"); 
      ...
      out.write("<table border=\"0\" cellpadding=\"0\" cellspacing=\"0\" width=\"100%\">\n<tr>\n<th align=\"left\" class=\"table_detail_without_bgrond_and_padding\">");
 {out.write(localizeISText("validationrule.product.pricelist.checkProductPricesForSelectedPriceList","",null,null,null,null,null,null,null,null,null,null,null));} 
 ...
 {out.write(localizeISText("validationrule.product.pricelist.page.priceListRequired","",null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("!</td>\n</tr>\n</table>\n</td>\n</tr>\n<tr\nid=\"ProductPriceListValidationRuleConfigurationForm_InvalidCurrenciesParameter_ErrorContainer\"\nclass=\"ErrorContainer\" style=\"display: none;\">\n<td>\n<table border=\"0\" cellspacing=\"0\" cellpadding=\"4\" width=\"100%\"\nclass=\"error_box\">\n<tr>\n<td><img src=\"");
      out.print(context.getFormattedValue(context.webRoot(),null));
      out.write("/images/error.gif\" width=\"16\"\nheight=\"15\" alt=\"\" border=\"0\" /></td>\n<td width=\"100%\" class=\"product_validation_error\">");
 {out.write(localizeISText("validationrule.page.selectCurrencyWhenProductPriceListIsSelected","",null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("!</td>\n</tr>\n</table>\n</td>\n</tr>\n<tr>\n<td>\n<table border=\"0\" cellpadding=\"0\" cellspacing=\"0\">\n<tr>\n<td nowrap=\"nowrap\" width=\"130\"><label class=\"label label_dialog\" for=\"ProductPriceListValidationRuleConfigurationForm_PriceList\">");
 {out.write(localizeISText("validationrule.product.pricelist.page.priceList","",null,null,null,null,null,null,null,null,null,null,null));} 
 ...
 {String value = null;try{value=context.getFormattedValue(getObject("PriceList:ID"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {70}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
      out.write('"');
      out.write('>');
 {String value = null;try{value=context.getFormattedValue(getObject("PriceList:DisplayName(CurrentLocale)"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {70}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
      out.write("</option>");
 } 
