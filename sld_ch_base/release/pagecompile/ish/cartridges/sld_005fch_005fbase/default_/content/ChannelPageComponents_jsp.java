...
public final class ChannelPageComponents_jsp extends com.intershop.beehive.core.internal.template.AbstractTemplate
...
new TagParameter("text",localizeText(context.getFormattedValue("ChannelPageComponents.Content.text",null)))}, 8); 
 processOpenTag(response, pageContext, "breadcrumbtrail", new TagParameter[] {
...
new TagParameter("text",localizeText(context.getFormattedValue("ChannelPageComponents.Components.text",null)))}, 9); 
...
new TagParameter("uniqueid","ChannelPageComponents")}, 12); 
 printFooter(out); 
