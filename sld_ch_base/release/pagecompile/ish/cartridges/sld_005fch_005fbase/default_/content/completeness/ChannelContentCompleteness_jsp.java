 ...
 */
package ish.cartridges.sld_005fch_005fbase.default_.content.completeness;
...
public final class ChannelContentCompleteness_jsp extends com.intershop.beehive.core.internal.template.AbstractTemplate
...
new TagParameter("text",localizeText(context.getFormattedValue("ChannelContentCompleteness.Content.text",null)))}, 4); 
 processOpenTag(response, pageContext, "breadcrumbtrail", new TagParameter[] {
...
new TagParameter("text",localizeText(context.getFormattedValue("ChannelContentCompleteness.ContentOverview.text",null)))}, 5); 
...
new TagParameter("mapname","ContextPipelineMap")}, 7); 
 processOpenTag(response, pageContext, "contentsummary", new TagParameter[] {
...
new TagParameter("ContextPipelineMap",getObject("ContextPipelineMap"))}, 12); 
 ...
 processOpenTag(response, pageContext, "completenessproblemstatistic", new TagParameter[] {
new TagParameter("ContentRepository",getObject("ContentRepository")),
new TagParameter("ContextPipeline","ViewChannelContentCompleteness-Start"),
...
new TagParameter("NeedRevalidate",getObject("NeedRevalidate"))}, 19); 
 printFooter(out); 
