...
import com.intershop.beehive.core.capi.security.CrossSiteRequestForgeryGuard;
import com.intershop.beehive.core.capi.security.StateChangeGuardProvider;
import com.intershop.beehive.core.capi.naming.NamingMgr;

public final class CSRFGuardJSToken_jsp extends com.intershop.beehive.core.internal.template.AbstractTemplate
...
if (isSecureHeader != null)
{
 ...
 {String value = null;try{value=context.getFormattedValue(getObject("SessionSynchronizerToken"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {22}",e);}if (value==null) value="";value = encodeString(value,"JavaScript");out.write(value);} 
      out.write("';\n</script>");
 printFooter(out); 
