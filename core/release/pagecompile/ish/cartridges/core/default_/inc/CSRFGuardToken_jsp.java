...
public final class CSRFGuardToken_jsp extends com.intershop.beehive.core.internal.template.AbstractTemplate
...
getPipelineDictionary().put("SessionSynchronizerToken", guard.getSessionSynchronizerToken());
 ...
 {String value = null;try{value=context.getFormattedValue(getObject("SessionSynchronizerToken"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {12}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
      out.write("\" />");
 printFooter(out); 
