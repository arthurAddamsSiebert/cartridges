...
<html>
	<head><% insertIntershopSignature(request,(com.intershop.beehive.core.capi.request.ServletResponse)response); %>
		<title><% {out.write(localizeISText("templates.error_site_maintenance.SiteMaintenance.title","",null,null,null,null,null,null,null,null,null,null,null));} %></title>
	...
	<body>
	  ...
	  <div class="sysMessage">
		<% {out.write(localizeISText("templates.error_site_maintenance.ThisSiteIsInMaintenanceMode.sysMessage","",null,null,null,null,null,null,null,null,null,null,null));} %>	  
	  </div>
	</body>
