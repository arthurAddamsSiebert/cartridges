...
<html>
	<head><% insertIntershopSignature(request,(com.intershop.beehive.core.capi.request.ServletResponse)response); %>
		<title><% {out.write(localizeISText("templates.error_site_disabled.SiteDisabled.title","",null,null,null,null,null,null,null,null,null,null,null));} %></title>
	...
	<body>
	  ...
	  <div class="sysMessage">
		<% {out.write(localizeISText("templates.error_site_disabled.ThisSiteHasBeenDisabledNoRequests.sysMessage","",null,null,null,null,null,null,null,null,null,null,null));} %>
	  </div>
	</body>
