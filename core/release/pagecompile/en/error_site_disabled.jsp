...
<html>
	<head><% insertIntershopSignature(request,(com.intershop.beehive.core.capi.request.ServletResponse)response); %>
		<title><% {out.write(localizeISText("templates.error_site_disabled.SiteDisabled.title1","",null,null,null,null,null,null,null,null,null,null,null));} %></title>
	...
	<body>
	  ...
	  <div class="sysMessage">
		<% {out.write(localizeISText("templates.error_site_disabled.ThisSiteHasBeenDisabledNoRequest.sysMessage1","",null,null,null,null,null,null,null,null,null,null,null));} %>
	  </div>
	</body>
