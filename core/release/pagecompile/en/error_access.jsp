...
<html>
	<head><% insertIntershopSignature(request,(com.intershop.beehive.core.capi.request.ServletResponse)response); %>
		<title><% {out.write(localizeISText("templates.error_access.AccessDenied.title1","",null,null,null,null,null,null,null,null,null,null,null));} %></title>
		<style>
	...
	<body>
		<b><% {out.write(localizeISText("templates.error_access.AccessDenied1","",null,null,null,null,null,null,null,null,null,null,null));} %></b><br/><hr/>
	</body>
