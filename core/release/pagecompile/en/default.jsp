...
<!-- TemplateName : default.isml -->
<!-- TemplateComment : default template -->

<html>
	<head><% insertIntershopSignature(request,(com.intershop.beehive.core.capi.request.ServletResponse)response); %>
		<title><% {out.write(localizeISText("templates.default.DefaultPage.title","",null,null,null,null,null,null,null,null,null,null,null));} %></title>
	...
	<body>
	  ...
	  <div class="sysMessage">
		<% {out.write(localizeISText("templates.default.DefaultPage.sysMessage","",null,null,null,null,null,null,null,null,null,null,null));} %>
	  </div>
	</body>
