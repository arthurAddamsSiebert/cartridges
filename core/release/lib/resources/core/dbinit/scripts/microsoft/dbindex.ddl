...
EXEC staging_ddl.create_index('CACHECLEARKEYBATCHCONTAI_IE098', 'CACHECLEARKEYBATCHCONTAINER', '(DESIREDCACHECLEARDATE)', :table_space, 'NONUNIQUE', :recreate_indexes)
EXEC staging_ddl.create_index('CACHECLEARKEYBATCHCONTAI_IE099', 'CACHECLEARKEYBATCHCONTAINER', '(CACHECLEARPROCESSID)', :table_space, 'NONUNIQUE', :recreate_indexes)
