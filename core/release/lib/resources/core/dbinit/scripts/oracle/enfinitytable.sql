...
USING (
        SELECT 'MY_USER_CONSTRAINTS'    AS tableName, '&_cartridge' AS cartridgeName, '&_enfinityVersion' AS version FROM dual UNION
        SELECT 'MY_USER_INDEXES'        AS tableName, '&_cartridge' AS cartridgeName, '&_enfinityVersion' AS version FROM dual UNION
        SELECT 'MY_USER_IND_COLUMNS'    AS tableName, '&_cartridge' AS cartridgeName, '&_enfinityVersion' AS version FROM dual UNION
        SELECT 'NOT_USABLE_INDEXES'     AS tableName, '&_cartridge' AS cartridgeName, '&_enfinityVersion' AS version FROM dual UNION
        SELECT 'PLSQLLOG'               AS tableName, '&_cartridge' AS cartridgeName, '&_enfinityVersion' AS version FROM dual
      ) s
