CREATE OR REPLACE PROCEDURE sp_deleteCommentByDomain (domainID IN VARCHAR2)
...
BEGIN
    ...
    sp_genStagPoAvDeleteByDomain('ISComment', 'ISComment_AV', domainID, 'domainid');

    commit;

END sp_deleteCommentByDomain;
/
