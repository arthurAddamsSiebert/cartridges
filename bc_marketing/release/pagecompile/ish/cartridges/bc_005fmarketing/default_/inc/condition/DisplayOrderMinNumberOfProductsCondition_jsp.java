...
public final class DisplayOrderMinNumberOfProductsCondition_jsp extends com.intershop.beehive.core.internal.template.AbstractTemplate
...
setEncodingType("text/html"); 
 ...
 {out.write(localizeISText("DisplayOrderMinNumberOfProductsCondition.IS.link","",null,null,null,null,null,null,null,null,null,null,null));} 
      out.write(" </span>");
 {String value = null;try{value=context.getFormattedValue(getObject("Condition:MinNumberOfProducts"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {8}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
 printFooter(out); 
