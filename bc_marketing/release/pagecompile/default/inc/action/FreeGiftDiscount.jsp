...
<tr>
<td class="button">
<input type="submit" class="button" value="<%=context.getFormattedValue(localizeText(context.getFormattedValue("FreeGiftDiscount.SelectGiftProductS.button",null)),null)%>" name="jumpActionIncExc" />
