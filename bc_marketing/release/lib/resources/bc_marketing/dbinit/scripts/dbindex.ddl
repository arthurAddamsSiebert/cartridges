...
PROMPT -- AffiliatePartner unique compound index on affiliatePartnerID and domainID
PROMPT -- One Partner is unique in the context of a domain
EXEC staging_ddl.create_index('AffiliatePartner_CI001', 'AffiliatePartner', '(id, domainID)', :table_space, 'UNIQUE', :recreate_indexes)
