...
EXEC staging_ddl.add_constraint('ABTESTEVENT','ABTESTEVENT_CO999','FOREIGN KEY (DOMAINID) REFERENCES DOMAIN (UUID) INITIALLY DEFERRED DEFERRABLE DISABLE NOVALIDATE');
