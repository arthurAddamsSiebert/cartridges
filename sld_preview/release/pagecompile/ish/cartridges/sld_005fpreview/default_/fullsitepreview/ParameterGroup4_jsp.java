...
setEncodingType("text/html"); 
 {out.flush();processLocalIncludeByServer((com.intershop.beehive.core.capi.request.ServletResponse)response,"fullsitepreview/Modules.isml", null, "2");} 
 ...
 {out.write(localizeISText("ParameterGroup4.CatalogSettings.label","",null,null,null,null,null,null,null,null,null,null,null));} 
      out.write(":</td>\n<td>");
 while (loop("groupParameters","previewAttribute",null)) { 
 processOpenTag(response, pageContext, "fullsitepreviewparameter", new TagParameter[] {
new TagParameter("previewAttribute",getObject("previewAttribute")),
new TagParameter("CurrentRequest",getObject("CurrentRequest"))}, 30); 
 } 
      out.write("</td>\n</tr>");
 } 
 printFooter(out); 
