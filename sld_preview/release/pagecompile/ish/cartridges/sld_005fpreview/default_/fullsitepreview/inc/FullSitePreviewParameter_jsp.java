...
public final class FullSitePreviewParameter_jsp extends com.intershop.beehive.core.internal.template.AbstractTemplate
...
setEncodingType("text/html"); 
 ...
 {out.flush();processLocalIncludeByServer((com.intershop.beehive.core.capi.request.ServletResponse)response,context.getFormattedValue(getObject("templateToLoad"),null), null, "28");} 
 } else { 
      out.write("<!-- \none of the mandatory input parameters is missing\npreviewAttribute: ");
 {String value = null;try{value=context.getFormattedValue(getObject("previewAttribute"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {32}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
      out.write("\n-->");
 } 
 printFooter(out); 
