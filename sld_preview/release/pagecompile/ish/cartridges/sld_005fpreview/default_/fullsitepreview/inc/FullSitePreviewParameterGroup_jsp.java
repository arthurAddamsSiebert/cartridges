 ...
 */
package ish.cartridges.sld_005fpreview.default_.fullsitepreview.inc;
...
public final class FullSitePreviewParameterGroup_jsp extends com.intershop.beehive.core.internal.template.AbstractTemplate
...
setEncodingType("text/html"); 
 ...
 _boolean_result=false;try {_boolean_result=((Boolean)((hasLoopElements("groupParameters") ? Boolean.TRUE : Boolean.FALSE))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",29,e);}if (_boolean_result) { 
 ...
 {out.flush();processLocalIncludeByServer((com.intershop.beehive.core.capi.request.ServletResponse)response,"fullsitepreview/SimpleFullSitePreviewParameterGroup.isml", null, "33");} 
 } 
 } 
 printFooter(out); 
