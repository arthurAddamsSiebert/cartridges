...
EXEC staging_ddl.create_index('BASKETCOSTOBJECTASSIGNME_AK001', 'BASKETCOSTOBJECTASSIGNMENT', '(TARGETID,COSTOBJECTNAME,COSTOBJECTTYPENAME)', :table_space, 'UNIQUE', :recreate_indexes)
...
PROMPT -- Alternate key indices
EXEC staging_ddl.create_index('ORDERCOSTOBJECTASSIGNMEN_AK001', 'ORDERCOSTOBJECTASSIGNMENT', '(TARGETID,COSTOBJECTNAME,COSTOBJECTTYPENAME)', :table_space, 'UNIQUE', :recreate_indexes)
