...
public final class SiteMapZip_jsp extends com.intershop.beehive.core.internal.template.AbstractTemplate
...
response.setHeader(TemplateConstants.PERSONALIZED_HEADER, "1");setEncodingType("application/x-gzip"); 
      out.write('\n');
      out.write('\n');
 ...
 {Object temp_obj = (getObject("SiteMapXMLFile:Name")); getPipelineDictionary().put("SiteMapXMLFileName", temp_obj);} 
      ...
      out.write('\n');
 {response.setHeader("Content-Disposition", "attachment; filename=\"" + context.getFormattedValue(getObject("SiteMapXMLFileName"),null) + "\"");processBinaryOutputFile((com.intershop.beehive.core.capi.request.ServletResponse)response,new File(context.getFormattedValue(getObject("SiteMapXMLFile"),null)));} 
 printFooter(out); 
