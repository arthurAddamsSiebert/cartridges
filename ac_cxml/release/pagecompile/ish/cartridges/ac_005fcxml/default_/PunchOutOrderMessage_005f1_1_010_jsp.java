...
public final class PunchOutOrderMessage_005f1_1_010_jsp extends com.intershop.beehive.core.internal.template.AbstractTemplate
...
setEncodingType("text/xml"); 
 ...
 {String value = null;try{value=context.getFormattedValue(getObject("PLI:Quantity:Unit"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {61}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
      out.write("</UnitOfMeasure>\n<Classification domain=''></Classification>\n<Extrinsic name='TaxClass'>");
 {String value = null;try{value=context.getFormattedValue(getObject("PLI:TaxClassCode"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {63}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
      out.write("</Extrinsic>\n<Extrinsic name='TaxRate'>");
 {String value = null;try{value=context.getFormattedValue(getObject("PLI:TaxRate"),"0.00",null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {64}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
      out.write("</Extrinsic>\n</ItemDetail>\n<Tax>\n<Money currency='");
 {String value = null;try{value=context.getFormattedValue(getObject("PLI:TaxPC:CurrencyMnemonic"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {67}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
      out.write('\'');
      out.write('>');
 {String value = null;try{value=context.getFormattedValue(getObject("PLI:TaxPC:Value"),"0.00#",null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {67}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
      out.write("</Money>\n<Description xml:lang='en'>Value-added tax</Description>\n</Tax>\n<ShipTo>\n<Address addressID='");
 {String value = null;try{value=context.getFormattedValue(getObject("PLI:ShipToAddressID"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {71}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
      out.write("'>\n<Name xml:lang='en'>");
 {String value = null;try{value=context.getFormattedValue(getObject("PLI:ShipToAddress:AddressName"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {72}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
      out.write("</Name>\n<PostalAddress>\n<DeliverTo>");
 {String value = null;try{value=context.getFormattedValue(getObject("PLI:ShipToAddress:FirstName"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {74}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
      out.write(' ');
 {String value = null;try{value=context.getFormattedValue(getObject("PLI:ShipToAddress:LastName"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {74}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
      out.write("</DeliverTo>\n<Street>");
 {String value = null;try{value=context.getFormattedValue(getObject("PLI:ShipToAddress:Street"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {75}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
      out.write("</Street>\n<City>");
 {String value = null;try{value=context.getFormattedValue(getObject("PLI:ShipToAddress:City"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {76}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
      out.write("</City>\n<State>");
 {String value = null;try{value=context.getFormattedValue(getObject("PLI:ShipToAddress:State"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {77}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
      out.write("</State>\n<PostalCode>");
 {String value = null;try{value=context.getFormattedValue(getObject("PLI:ShipToAddress:PostalCode"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {78}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
      out.write("</PostalCode>\n<Country isoCountryCode='");
 {String value = null;try{value=context.getFormattedValue(getObject("PLI:ShipToAddress:CountryCode"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {79}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
      out.write('\'');
      out.write('>');
 {String value = null;try{value=context.getFormattedValue(getObject("PLI:ShipToAddress:Country"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {79}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
      out.write("</Country>\n</PostalAddress>\n</Address>\n</ShipTo>\n</ItemIn>");
 } 
 } 
      out.write("</PunchOutOrderMessage>\n</Message>\n</cXML>");
