...
public final class ConfirmRequestPersonalData_jsp extends com.intershop.beehive.core.internal.template.AbstractTemplate
...
setEncodingType("text/html"); 
 {out.flush();processLocalIncludeByServer((com.intershop.beehive.core.capi.request.ServletResponse)response,"email/mailTemplate/MailConfig", null, "2");} 
      out.write("<SUBJECT>");
 {out.write(localizeISText("email.gdpr.confirm.request.personal.data.subject",null,null,encodeString(context.getFormattedValue(getObject("ChannelName"),null)),null,null,null,null,null,null,null,null,null));} 
      out.write("</SUBJECT>");
...
new TagParameter("ChannelName",getObject("ChannelName"))}, 12); 
 ...
 {out.write(localizeISText("email.gdpr.confirm.request.personal.data.header","",null,getObject("ChannelName"),null,null,null,null,null,null,null,null,null));} 
      out.write("</p>\n<div class=\"emailBody\">\n<p>");
 {out.write(localizeISText("email.gdpr.common.user.greeting","",null,getObject("PersonalDataRequestBO:RequesterName"),null,null,null,null,null,null,null,null,null));} 
      out.write("</p>\n<p>");
 {out.write(localizeISText("email.gdpr.confirm.request.personal.data.statement","",null,null,null,null,null,null,null,null,null,null,null));} 
      out.write("</p>\n<p>\n<a href=\"");
