...
public final class StaticPage_jsp extends com.intershop.beehive.core.internal.template.AbstractTemplate
...
response.setHeader(TemplateConstants.PERSONALIZED_HEADER, "1");setEncodingType("text/html"); 
 ...
 {out.flush();processLocalIncludeByServer((com.intershop.beehive.core.capi.request.ServletResponse)response,"modules/navigation/Modules", null, "3");} 
      out.write("<div class=\"breadcrumbs row\">");
 processOpenTag(response, pageContext, "contentbreadcrumb", new TagParameter[] {
new TagParameter("currentPageletEntryPointID",getObject("PageletEntryPointID")),
new TagParameter("navigationRoot",getObject("PageletConfigurationParameters:NavigationRoot")),
new TagParameter("locale",getObject("CurrentRequest:Locale"))}, 6); 
...
new TagParameter("slot","app_sf_responsive_cm:slot.marketing.base.pagelet2-Slot")}, 14); 
      out.write("</div>\n<div class=\"row\">");
 _boolean_result=false;try {_boolean_result=((Boolean)(((((Boolean) ((((context.getFormattedValue(getObject("PageletConfigurationParameters:ShowSidePanel"),null).equals(context.getFormattedValue("true",null)))) ? Boolean.TRUE : Boolean.FALSE))).booleanValue() || ((Boolean) ((((context.getFormattedValue(getObject("PageletConfigurationParameters:ShowNavigation"),null).equals(context.getFormattedValue("true",null)))) ? Boolean.TRUE : Boolean.FALSE))).booleanValue()) ? Boolean.TRUE : Boolean.FALSE))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",18,e);}if (_boolean_result) { 
      out.write("<div class=\"page-navigation col-md-3\">\n<div class=\"page-navigation-contents\">");
 _boolean_result=false;try {_boolean_result=((Boolean)(((((context.getFormattedValue(getObject("PageletConfigurationParameters:ShowNavigation"),null).equals(context.getFormattedValue("true",null)))) ? Boolean.TRUE : Boolean.FALSE)))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",21,e);}if (_boolean_result) { 
 processOpenTag(response, pageContext, "contentnavigation", new TagParameter[] {
new TagParameter("navigationDepth",getObject("PageletConfigurationParameters:NavigationDepth")),
new TagParameter("currentPageletEntryPointID",getObject("PageletEntryPointID")),
new TagParameter("navigationRoot",getObject("PageletConfigurationParameters:NavigationRoot")),
new TagParameter("locale",getObject("CurrentRequest:Locale"))}, 22); 
 } 
      out.write("<div class=\"marketing-area\">");
 processOpenTag(response, pageContext, "slot", new TagParameter[] {
new TagParameter("slot","app_sf_responsive_cm:slot.marketing.sidePanel.pagelet2-Slot")}, 30); 
      out.write("</div>\n</div>\n</div>\n<div class=\"col-md-9\">");
 } else { 
      out.write("<div class=\"col-md-12\">");
 } 
 processOpenTag(response, pageContext, "slot", new TagParameter[] {
new TagParameter("slot","app_sf_responsive_cm:slot.staticPage.content.pagelet2-Slot")}, 38); 
      out.write("</div>\n</div>");
 printFooter(out); 
