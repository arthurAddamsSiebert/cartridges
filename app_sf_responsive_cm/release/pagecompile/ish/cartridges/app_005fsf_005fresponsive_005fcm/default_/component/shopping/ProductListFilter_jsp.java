...
new TagParameter("trailtext0",getObject("Title")),
new TagParameter("showhomelink","true")}, 7); 
 } else { 
 processOpenTag(response, pageContext, "breadcrumb", new TagParameter[] {
new TagParameter("trailtext0",localizeText(context.getFormattedValue("application.productListFilter.breadcrumb.label",null))),
new TagParameter("showhomelink","true")}, 9); 
 } 
...
new TagParameter("slot","app_sf_responsive_cm:slot.marketing.base.pagelet2-Slot")}, 14); 
 ...
 _boolean_result=false;try {_boolean_result=((Boolean)(((((Boolean) (disableErrorMessages().isDefined(getObject("Title")))).booleanValue() && ((Boolean) (((!(context.getFormattedValue(getObject("Title"),null).equals(context.getFormattedValue("",null)))) ? Boolean.TRUE : Boolean.FALSE))).booleanValue()) ? Boolean.TRUE : Boolean.FALSE))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",18,e);}if (_boolean_result) { 
      out.write("<h1>");
 {String value = null;try{value=context.getFormattedValue(getObject("Title"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {19}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
      out.write("</h1>");
 } 
 processOpenTag(response, pageContext, "productlistfilters", new TagParameter[] {
new TagParameter("showViewType","false"),
new TagParameter("sortings",getObject("PageletConfigurationParameters:Sortings")),
new TagParameter("ViewType",getObject("ViewType")),
new TagParameter("ListNavigationVO",getObject("ListNavigationVO"))}, 22); 
 {Object temp_obj = ("col-xs-6 col-md-3 grid-view"); getPipelineDictionary().put("ListItemCSSClass", temp_obj);} 
...
new TagParameter("viewContext",getObject("PageletConfigurationParameters:ProductView"))}, 33); 
 processOpenTag(response, pageContext, "productlistfilters", new TagParameter[] {
new TagParameter("showViewType","false"),
new TagParameter("sortings",getObject("PageletConfigurationParameters:Sortings")),
new TagParameter("ViewType",getObject("ViewType")),
