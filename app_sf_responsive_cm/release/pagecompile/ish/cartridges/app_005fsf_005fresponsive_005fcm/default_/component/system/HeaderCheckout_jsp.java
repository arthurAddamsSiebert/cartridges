...
public final class HeaderCheckout_jsp extends com.intershop.beehive.core.internal.template.AbstractTemplate
...
new TagParameter("slot","app_sf_responsive_cm:slot.header.utility.pagelet2-Slot")}, 15); 
      out.write("</div>\n</div>\n</div>\n</nav>\n</div>\n<div class=\"mid-header mid-header-checkout\">\n<div class=\"container\">\n<div class=\"row\">\n<div class=\"col-sm-12 logo-wrapper visible-xs\">");
 {out.flush();processLocalIncludeByServer((com.intershop.beehive.core.capi.request.ServletResponse)response,"component/system/HeaderMobileLogo", null, "25");} 
      out.write("</div>\n<div class=\"col-sm-3 logo-wrapper hidden-xs\">");
 {out.flush();processLocalIncludeByServer((com.intershop.beehive.core.capi.request.ServletResponse)response,"component/system/HeaderPageLogo", null, "28");} 
      out.write("</div>\n<div class=\"col-sm-5 header-info-wrapper hidden-xs\">");
 processOpenTag(response, pageContext, "slot", new TagParameter[] {
new TagParameter("slot","app_sf_responsive_cm:slot.header.promotion.pagelet2-Slot")}, 31); 
      out.write("</div>\n</div>\n</div>\n</div>");
 printFooter(out); 
