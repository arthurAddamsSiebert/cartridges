...
response.setHeader(TemplateConstants.PERSONALIZED_HEADER, "1");setEncodingType("text/html"); 
 ...
 {out.flush();processLocalIncludeByServer((com.intershop.beehive.core.capi.request.ServletResponse)response,"component/system/HeaderMobileLogo", null, "9");} 
...
finally
{
    getTemplateExecutionConfig().setURLRewriteHandler(handler);
      ...
      out.write("</li>\n<li>");
 {out.flush();processLocalIncludeByServer((com.intershop.beehive.core.capi.request.ServletResponse)response,"inc/header/ProductCompareStatus", null, "26");} 
      out.write("</li>\n<li>");
 {out.flush();
URLRewriteHandler handler = getTemplateExecutionConfig().getURLRewriteHandler();
try
...
new TagParameter("slot","app_sf_responsive_cm:slot.header.utility.pagelet2-Slot")}, 38); 
      out.write("</div>\n</div>\n</div>\n</nav>\n</div>\n<div class=\"mid-header\">\n<div class=\"container\">\n<div class=\"row\">\n<div class=\"col-sm-3 logo-wrapper hidden-xs\">");
 {out.flush();processLocalIncludeByServer((com.intershop.beehive.core.capi.request.ServletResponse)response,"component/system/HeaderPageLogo", null, "48");} 
      out.write("</div>\n<div class=\"col-sm-5 header-info-wrapper hidden-xs\">");
 processOpenTag(response, pageContext, "slot", new TagParameter[] {
new TagParameter("slot","app_sf_responsive_cm:slot.header.promotion.pagelet2-Slot")}, 51); 
...
new TagParameter("id","Header")}, 54); 
 ...
 processOpenTag(response, pageContext, "slot", new TagParameter[] {
new TagParameter("slot","app_sf_responsive_cm:slot.header.navigation.pagelet2-Slot")}, 73); 
