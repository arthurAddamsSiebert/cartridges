...
public final class CategoryPage_jsp extends com.intershop.beehive.core.internal.template.AbstractTemplate
...
new TagParameter("currentuserbo","UserBO")}, 8); 
...
new TagParameter("slot","app_sf_responsive_cm:slot.marketing.base.pagelet2-Slot")}, 26); 
      out.write("</div>\n<div class=\"category-page\" data-testing-id=\"");
 ...
 {String value = null;try{value=context.getFormattedValue(getObject("CategoryBO:DisplayName"),null,null);}catch(Exception e){value=null;Logger.error(this,"ISPRINT has an invalid expression. Returning empty string. Line: {34}",e);}if (value==null) value="";value = encodeString(value);out.write(value);} 
      out.write("</h1>");
 _boolean_result=false;try {_boolean_result=((Boolean)(getObject("hasParametricNavigation"))).booleanValue();} catch (Exception e) {Logger.debug(this,"Boolean expression in line {} could not be evaluated. False returned. Consider using the 'isDefined' ISML function.",38,e);}if (_boolean_result) { 
...
new TagParameter("recursive","true")}, 46); 
 } 
 ...
 processOpenTag(response, pageContext, "slot", new TagParameter[] {
new TagParameter("slot","app_sf_responsive_cm:slot.marketing.sidePanel.pagelet2-Slot")}, 55); 
 } 
      out.write("</div>\n</div>\n<div class=\"col-sm-9\">\n<div class=\"marketing-area\">");
 processOpenTag(response, pageContext, "slot", new TagParameter[] {
new TagParameter("slot","app_sf_responsive_cm:slot.marketing.content.pagelet2-Slot")}, 62); 
      out.write("</div>");
 processOpenTag(response, pageContext, "categorylist", new TagParameter[] {
new TagParameter("CategoryBOs",getObject("CategoryBO:SortedAccessibleSubCatalogCategoryBOs(UserBO)")),
new TagParameter("listItemCssClass","col-md-4 col-xs-6"),
new TagParameter("viewContext",getObject("PageletConfigurationParameters:SubCategoryView"))}, 65); 
 processOpenTag(response, pageContext, "slot", new TagParameter[] {
new TagParameter("slot","app_sf_responsive_cm:slot.marketing.category.pagelet2-Slot")}, 71); 
      out.write("<div data-testing-id=\"category-rich-content\">");
 processOpenTag(response, pageContext, "htmlprint", new TagParameter[] {
new TagParameter("value",getObject("CategoryBO:RichContent"))}, 74); 
      out.write("</div>\n</div>\n</div>\n</div>");
 printFooter(out); 
